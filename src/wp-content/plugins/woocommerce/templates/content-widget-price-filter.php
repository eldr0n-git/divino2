...
<form method="get" action="<?php echo esc_url( $form_action ); ?>">
	<div class="price_slider_wrapper">
        ...
        <div class="divino__price-slider-values-holder"><span class="from divino__price-from"></span><span class="to"></span></div>
			...
			<div class="price_label divino__hidethispricelabel" style="display:none;">
				<?php echo esc_html__( '', 'woocommerce' ); ?> <span class="from"></span> &mdash; <span class="to"></span>
			</div>
