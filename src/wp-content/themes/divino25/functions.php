...
// Настройки валюты WooCommerce - раскоментировать для однократного запуска
// update_option( 'woocommerce_currency', 'KZT' ); // Валюта
// update_option( 'woocommerce_currency_pos', 'right_space' ); // Позиция валюты
