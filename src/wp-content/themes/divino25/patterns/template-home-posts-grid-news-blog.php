<!-- template-home-posts-grid-news-blog.php from divino25 theme  patterns-->
<?php
/**
 * Title: News blog with featured posts grid
 * Slug: divino/template-home-posts-grid-news-blog
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;">
	...
	<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-query alignwide">
			...
			<!-- /wp:post-template -->
			<!-- wp:query-no-results -->
				<!-- wp:paragraph {"align":"center","placeholder":"<?php esc_attr_e( 'Add text or blocks that will display when a query returns no results.', 'divino' ); ?>"} -->
				<p class="has-text-align-center"><?php echo esc_html_x( 'Sorry, but nothing was found. Please try a search with different keywords.', 'Message explaining that there are no results returned from a search.', 'divino' ); ?></p>
				<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:query -->
	...
	<div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
		...
		<h2 class="wp-block-heading alignwide"><?php esc_html_e( 'Architecture', 'divino' ); ?></h2>
		<!-- /wp:heading -->
...
<!-- wp:pattern {"slug":"divino/cta-newsletter"} /-->
