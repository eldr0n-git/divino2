...
<div class="quantity">
    ...
    <div class="divino-number-input__wrapper">
        <input
            type="<?php echo esc_attr( $type ); ?>"
            <?php echo $readonly ? 'readonly="readonly"' : ''; ?>
            id="<?php echo esc_attr( $input_id ); ?>"
            class="divino-number-input__input <?php echo esc_attr( join( ' ', (array) $classes ) ); ?>"
            ...
            <?php endif; ?>
        />
        <div class="divino-number-input__buttonWrapper">
            <a class="divino-number-input__increment" href="#">+</a>
            <a class="divino-number-input__decrement" href="#">-</a>
        </div>
    </div>
	<?php
	/**
