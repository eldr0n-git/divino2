...
<div <?php divino_blog_layout_class( 'single-layout-1' ); ?>>

	<?php divino_single_header_before(); ?>

	<?php if ( apply_filters( 'divino_single_layout_one_banner_visibility', true ) ) { ?>

		<header class="entry-header <?php divino_entry_header_class(); ?>">

			<?php divino_single_header_top(); ?>

			<?php divino_banner_elements_order(); ?>

			<?php divino_single_header_bottom(); ?>

		</header><!-- .entry-header -->

	<?php } ?>

	<?php divino_single_header_after(); ?>
