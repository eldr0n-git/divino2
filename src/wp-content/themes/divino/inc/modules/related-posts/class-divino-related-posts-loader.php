 ...
 * @since 3.5.0
 */
class divino_Related_Posts_Loader {
	/**
	 *  Constructor
	 *
	 * @since 3.5.0
	...
	public function add_fonts() {
		if ( divino_target_rules_for_related_posts() ) {
			...
			$section_title_font_family = divino_get_option( 'related-posts-section-title-font-family' );
			$section_title_font_weight = divino_get_option( 'related-posts-section-title-font-weight' );
			divino_Fonts::add_font( $section_title_font_family, $section_title_font_weight );

			// Related Posts - Posts title.
			$post_title_font_family = divino_get_option( 'related-posts-title-font-family' );
			$post_title_font_weight = divino_get_option( 'related-posts-title-font-weight' );
			divino_Fonts::add_font( $post_title_font_family, $post_title_font_weight );

			// Related Posts - Meta Font.
			$meta_font_family = divino_get_option( 'related-posts-meta-font-family' );
			$meta_font_weight = divino_get_option( 'related-posts-meta-font-weight' );
			divino_Fonts::add_font( $meta_font_family, $meta_font_weight );

			// Related Posts - Content Font.
			$content_font_family = divino_get_option( 'related-posts-content-font-family' );
			$content_font_weight = divino_get_option( 'related-posts-content-font-weight' );
			divino_Fonts::add_font( $content_font_family, $content_font_weight );
		}
	}
	...
	public function theme_defaults( $defaults ) {
		...
		$divino_blog_update = divino_Dynamic_CSS::divino_4_6_0_compatibility();
		...
		$defaults['related-posts-container-width']           = $divino_blog_update ? '' : 'fallback';
		...
		$defaults['related-posts-author-prefix-label']       = divino_default_strings( 'string-blog-meta-author-by', false );
		...
		$defaults['related-posts-section-title-font-extras']    = array(
			'line-height'         => ! isset( $divino_options['related-posts-section-title-font-extras'] ) && isset( $divino_options['related-posts-section-title-line-height'] ) ? $divino_options['related-posts-section-title-line-height'] : '1.6',
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $divino_options['related-posts-section-title-font-extras'] ) && isset( $divino_options['related-posts-section-title-text-transform'] ) ? $divino_options['related-posts-section-title-text-transform'] : '',
			'text-decoration'     => '',
		);
		...
		$defaults['related-posts-title-font-extras']    = array(
			'line-height'         => ! isset( $divino_options['related-posts-title-font-extras'] ) && isset( $divino_options['related-posts-title-line-height'] ) ? $divino_options['related-posts-title-line-height'] : ( $divino_blog_update ? '1.5' : '1' ),
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $divino_options['related-posts-title-font-extras'] ) && isset( $divino_options['related-posts-title-text-transform'] ) ? $divino_options['related-posts-title-text-transform'] : '',
			'text-decoration'     => '',
		);
		...
		$defaults['related-posts-meta-font-extras']    = array(
			'line-height'         => ! isset( $divino_options['related-posts-meta-font-extras'] ) && isset( $divino_options['related-posts-meta-line-height'] ) ? $divino_options['related-posts-meta-line-height'] : '1.6',
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $divino_options['related-posts-meta-font-extras'] ) && isset( $divino_options['related-posts-meta-text-transform'] ) ? $divino_options['related-posts-meta-text-transform'] : '',
			'text-decoration'     => '',
		);
		...
		$defaults['related-posts-content-font-extras']     = array(
			'line-height'         => ! isset( $divino_options['related-posts-content-font-extras'] ) && isset( $divino_options['related-posts-content-line-height'] ) ? $divino_options['related-posts-content-line-height'] : '',
			'line-height-unit'    => 'em',
			'letter-spacing'      => '',
			'letter-spacing-unit' => 'px',
			'text-transform'      => ! isset( $divino_options['related-posts-content-font-extras'] ) && isset( $divino_options['related-posts-content-text-transform'] ) ? $divino_options['related-posts-content-text-transform'] : '',
			'text-decoration'     => '',
		);
	...
	public function render_related_posts_title() {
		return divino_get_option( 'related-posts-title' );
	}
}
 ...
 */
new divino_Related_Posts_Loader();
