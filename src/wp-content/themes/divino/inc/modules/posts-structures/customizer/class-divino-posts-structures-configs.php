 ...
 * @since 4.0.0
 */
class divino_Posts_Structures_Configs extends divino_Customizer_Config_Base {
	/**
	...
	public static function get_narrow_width_exculde_cpts() {
		if ( ! divino_Dynamic_CSS::divino_fullwidth_sidebar_support() ) {
			return apply_filters( 'divino_exculde_narrow_width_support_posttypes', array( 'product', 'download', 'course', 'lesson', 'tutor_quiz', 'tutor_assignments', 'sfwd-assignment', 'sfwd-essays', 'sfwd-transactions', 'sfwd-certificates', 'sfwd-quiz' ) );
		}

		// Excluded some more cpts for narrow.
		return apply_filters( 'divino_exculde_narrow_width_support_posttypes', array( 'product', 'download', 'course', 'lesson', 'tutor_quiz', 'tutor_assignments', 'sfwd-assignment', 'sfwd-essays', 'sfwd-transactions', 'sfwd-certificates', 'sfwd-quiz', 'sfwd-courses', 'sfwd-lessons', 'sfwd-topic', 'groups' ) );
	}
	 ...
	 */
	public static function divino_get_dynamic_section_title( $post_type_obj, $label ) {
	...
	public function register_configuration( $configurations, $wp_customize ) {
		...
		if ( ! empty( $post_types ) ) {
			...
			foreach ( $post_types as $label ) {
				...
				$section_title = self::divino_get_dynamic_section_title( $post_type_object, $label );
 ...
 */
new divino_Posts_Structures_Configs();
