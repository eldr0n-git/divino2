...
if ( ! class_exists( 'divino_BB_Ultimate_Addon' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class divino_BB_Ultimate_Addon {
		/**
		 * Member Variable
		 *
		 * @var object instance
		...
		public function theme_color() {
			return divino_get_option( 'theme-color' );
		}
		...
		public function text_color() {
			return divino_get_option( 'text-color' );
		}
		...
		public function link_color() {
			return divino_get_option( 'link-color' );
		}
		...
		public function link_hover_color() {
			return divino_get_option( 'link-h-color' );
		}
		...
		public function button_font_family() {
			$font_family = str_replace( "'", '', divino_get_option( 'font-family-button' ) );
			$font_family = explode( ',', $font_family );
			return array(
				'family' => $font_family[0],
				'weight' => divino_get_option( 'font-weight-button' ),
			);
		}
		...
		public function default_type_button_font_size() {
			...
			$font_size_arr['desktop'] = divino_responsive_font( $theme_btn_font_size, 'desktop' );
			$font_size_arr['tablet']  = divino_responsive_font( $theme_btn_font_size, 'tablet' );
			$font_size_arr['mobile']  = divino_responsive_font( $theme_btn_font_size, 'mobile' );

			if ( empty( $font_size_arr['desktop'] ) ) {
				$font_size_arr['desktop'] = divino_responsive_font( $body_font_size, 'desktop' );
			}
			if ( empty( $font_size_arr['tablet'] ) ) {
				$font_size_arr['tablet'] = divino_responsive_font( $body_font_size, 'tablet' );
			}
			if ( empty( $font_size_arr['mobile'] ) ) {
				$font_size_arr['mobile'] = divino_responsive_font( $body_font_size, 'mobile' );
			}
		...
		public function default_type_button_line_height() {
			$theme_btn_body_line_height = divino_get_option( 'body-line-height', 1.85714285714286 );
			return divino_get_option( 'theme-btn-line-height', $theme_btn_body_line_height );
		}
		...
		public function default_type_button_letter_spacing() {
			return divino_get_option( 'theme-btn-letter-spacing' );
		}
		...
		public function default_type_button_text_transform() {
			return divino_get_font_extras( divino_get_option( 'font-extras-button' ), 'text-transform' );
		}
		...
		public function button_text_color() {
			...
			$color       = divino_get_option( 'button-color' );
			if ( empty( $color ) ) {
		...
		public function button_bg_color() {
			return divino_get_option( 'button-bg-color' );
		}
		...
		public function default_type_button_bg_color() {
			$theme_color = divino_get_option( 'theme-color' );
			return divino_get_option( 'button-bg-color', $theme_color );
		}
		...
		public function button_bg_hover_color() {
			return divino_get_option( 'button-bg-h-color' );
		}
		...
		public function default_type_button_bg_hover_color() {
			$link_hover_color = divino_get_option( 'link-h-color' );
			return divino_get_option( 'button-bg-h-color', $link_hover_color );
		}
		...
		public function button_border_radius() {
			return divino_get_option( 'button-radius' );
		}
		...
		public function button_padding() {
			$padding   = '';
			$v_padding = divino_get_option( 'button-v-padding' );
			$h_padding = divino_get_option( 'button-h-padding' );
		...
		public function default_type_button_padding() {
			...
			return divino_get_option( 'theme-button-padding' );
		}
		...
		public function button_border_width() {
			...
			$btn_width     = array();
			$get_btn_width = divino_get_option( 'theme-button-border-group-border-size' );
		...
		public function button_border_color() {
			...
			return divino_get_option( 'theme-button-border-group-border-color', $btn_bg_color );
		}
		...
		public function button_border_hover_color() {
			...
			return divino_get_option( 'theme-button-border-group-border-h-color', $btn_bg_hover_color );
		}
 ...
 */
divino_BB_Ultimate_Addon::get_instance();
