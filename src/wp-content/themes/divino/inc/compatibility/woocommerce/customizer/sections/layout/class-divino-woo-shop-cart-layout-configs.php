...
if ( ! class_exists( 'divino_Woo_Shop_Cart_Layout_Configs' ) ) {
	...
	class divino_Woo_Shop_Cart_Layout_Configs extends divino_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'        => divino_THEME_SETTINGS . '[woo-enable-cart-button-text]',
				 ...
				 */
				array(
					'name'     => divino_THEME_SETTINGS . '[woo-cart-button-text]',
					...
					'context'  => array(
						...
						array(
							'setting'  => divino_THEME_SETTINGS . '[woo-enable-cart-button-text]',
							'operator' => '==',
							'value'    => true,
						),
					),
				 ...
				 */
				array(
					'name'     => divino_THEME_SETTINGS . '[enable-cart-upsells]',
					'section'  => 'section-woo-shop-cart',
					'type'     => 'control',
					'control'  => 'ast-toggle-control',
			...
			if ( defined( 'WC_VERSION' ) && version_compare( WC_VERSION, '8.3', '>=' ) ) {
				$_configs[] = array(
					'name'     => divino_THEME_SETTINGS . '[woo-block-incompatible-cart-notice]',
					'type'     => 'control',
				...
				$_configs[] = array(
					'name'     => divino_THEME_SETTINGS . '[woo-block-incompatible-checkout-notice]',
					'type'     => 'control',
					'control'  => 'ast-description',
			...
			if ( divino_showcase_upgrade_notices() ) {
				...
				$_configs[] = array(
					'name'     => divino_THEME_SETTINGS . '[ast-woo-checkout-pro-items]',
					'type'     => 'control',
					'control'  => 'ast-upgrade',
					'campaign' => 'woocommerce',
					'choices'  => array(
...
new divino_Woo_Shop_Cart_Layout_Configs();
