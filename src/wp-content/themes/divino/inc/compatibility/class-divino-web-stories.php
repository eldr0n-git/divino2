...
class divino_Web_Stories {
	...
	public function __construct() {
		...
		add_action( apply_filters( 'divino_web_stories_position', 'divino_body_top' ), array( $this, 'web_stories_embed' ) );
		add_filter( 'divino_dynamic_theme_css', array( $this, 'web_stories_css' ) );
	}
	...
	public function web_stories_css( $dynamic_css, $dynamic_css_filtered = '' ) {
		...
		$dynamic_css .= divino_parse_css( $stories_css_array );
