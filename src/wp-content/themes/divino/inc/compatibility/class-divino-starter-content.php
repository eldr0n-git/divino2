...
class divino_Starter_Content {
	...
	public function __construct() {
		...
		add_filter( 'divino_global_color_palette', array( $this, 'theme_color_palettes_defaults' ) );
	}
	 ...
	 * @since 4.0.0
	 */
	public function save_divino_settings() {
	...
	public function get() {
		...
		$content = array(
			...
			'posts'       => array(
				self::HOME_SLUG => require divino_THEME_DIR . 'inc/compatibility/starter-content/home.php', // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			),
		);

		return apply_filters( 'divino_starter_content', $content );
	}
}
