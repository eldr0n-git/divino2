...
if ( ! class_exists( 'divino_Beaver_Builder' ) ) {
	...
	class divino_Beaver_Builder {
		...
		public function __construct() {
			...
			add_filter( 'divino_disable_block_content_attr', array( $this, 'remove_divino_block_editor_attr' ), 10, 2 );
		}
		 ...
		 */
		public function remove_divino_block_editor_attr( $flag, $post_id ) {
 ...
 */
divino_Beaver_Builder::get_instance();
