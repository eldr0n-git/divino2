...
if ( ! class_exists( 'divino_Lifter_General_Configs' ) ) {
	...
	class divino_Lifter_General_Configs extends divino_Customizer_Config_Base {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'              => divino_THEME_SETTINGS . '[llms-course-grid]',
					'type'              => 'control',
				 ...
				 */
				array(
					'name'              => divino_THEME_SETTINGS . '[llms-membership-grid]',
					'type'              => 'control',
					'control'           => 'ast-responsive-slider',
					'sanitize_callback' => array( 'divino_Customizer_Sanitizes', 'sanitize_responsive_slider' ),
					'section'           => $section,
			...
			if ( divino_showcase_upgrade_notices() ) {
				...
				$_configs[] =
					 ...
					 */
					array(
						'name'     => divino_THEME_SETTINGS . '[llms-button-link]',
						'type'     => 'control',
...
new divino_Lifter_General_Configs();
