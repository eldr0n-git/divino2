 ...
 * Dynamic CSS
 */
if ( ! class_exists( 'divino_Dynamic_CSS' ) ) {

	/**
	 * Dynamic CSS
	 */
	class divino_Dynamic_CSS {
		/**
		 * Return CSS Output
		 *
		...
		public static function return_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			...
			$narrow_container_max_width = divino_get_option( 'narrow-container-max-width', apply_filters( 'divino_narrow_container_width', 750 ) );
			$header_logo_width          = divino_get_option( 'ast-header-responsive-logo-width' );
			$container_layout           = divino_toggle_layout( 'ast-site-content-layout', 'global', false );

			// Get the Global Container Layout based on Global Boxed and Global Sidebar Style.
			if ( 'plain-container' === $container_layout ) {
				$is_boxed         = ( 'boxed' === divino_get_option( 'site-content-style' ) );
				$is_sidebar_boxed = ( 'boxed' === divino_get_option( 'site-sidebar-style' ) );
				$sidebar_layout   = divino_get_option( 'site-sidebar-layout' );
				...
				if ( 'no-sidebar' === $sidebar_layout ) {
					...
					if ( $is_boxed ) {
						 ...
						 * Container unboxed css is applied through divino_apply_unboxed_container()
						 */
						$container_layout = 'boxed-container';
					}
				}
			...
			$title_color                = divino_get_option( 'header-color-site-title' );
			$title_hover_color          = divino_get_option( 'header-color-h-site-title' );
			$tagline_color              = divino_get_option( 'header-color-site-tagline' );
			$site_title_setting         = divino_get_option( 'display-site-title-responsive' );
			...
			$site_tagline_setting       = divino_get_option( 'display-site-tagline-responsive' );
			...
			$box_bg_obj = divino_get_option( 'site-layout-outside-bg-obj-responsive' );
			...
			if ( '' === $meta_background_enabled && divino_with_third_party() ) {
				...
				if ( isset( $meta_background_enabled ) && 'enabled' === $meta_background_enabled ) {
					$box_bg_obj = divino_third_party_archive_meta( 'ast-page-background-meta' );
				}
			} elseif ( isset( $meta_background_enabled ) && 'enabled' === $meta_background_enabled ) {
				$box_bg_obj = divino_get_option_meta( 'ast-page-background-meta' );
			}

			// Color Options.
			$text_color         = divino_get_option( 'text-color' );
			$theme_color        = divino_get_option( 'theme-color' );
			$link_color         = divino_get_option( 'link-color', $theme_color );
			$link_hover_color   = divino_get_option( 'link-h-color' );
			$heading_base_color = divino_get_option( 'heading-base-color' );

			// Typography.
			$body_font_size       = divino_get_option( 'font-size-body' );
			$body_line_height     = divino_get_font_extras( divino_get_option( 'body-font-extras' ), 'line-height', 'line-height-unit' );
			$para_margin_bottom   = divino_get_option( 'para-margin-bottom' );
			$body_text_transform  = divino_get_font_extras( divino_get_option( 'body-font-extras' ), 'text-transform' );
			$body_letter_spacing  = divino_get_font_extras( divino_get_option( 'body-font-extras' ), 'letter-spacing', 'letter-spacing-unit' );
			$body_text_decoration = divino_get_font_extras( divino_get_option( 'body-font-extras' ), 'text-decoration' );

			$site_title_font_size   = divino_get_option( 'font-size-site-title' );
			$site_tagline_font_size = divino_get_option( 'font-size-site-tagline' );

			$archive_post_title_font_size = divino_get_option( 'font-size-page-title' );
			$archive_post_meta_font_size  = divino_get_option( 'font-size-post-meta' );
			$archive_post_tax_font_size   = divino_get_option( 'font-size-post-tax' );
			$archive_cards_radius         = divino_get_option( 'post-card-border-radius' );
			$archive_cards_overlay        = divino_get_option( 'post-card-featured-overlay' );

			$heading_h1_font_size = divino_get_option( 'font-size-h1' );
			$heading_h2_font_size = divino_get_option( 'font-size-h2' );
			$heading_h3_font_size = divino_get_option( 'font-size-h3' );
			$heading_h4_font_size = divino_get_option( 'font-size-h4' );
			$heading_h5_font_size = divino_get_option( 'font-size-h5' );
			$heading_h6_font_size = divino_get_option( 'font-size-h6' );

			/**
			 * Heading Typography - h1 - h3.
			 */
			$headings_font_family    = divino_get_option( 'headings-font-family' );
			$headings_font_weight    = divino_get_option( 'headings-font-weight' );
			$headings_line_height    = divino_get_font_extras( divino_get_option( 'headings-font-extras' ), 'line-height', 'line-height-unit' );
			$headings_font_transform = divino_get_font_extras( divino_get_option( 'headings-font-extras' ), 'text-transform' );

			$h1_font_family     = divino_get_option( 'font-family-h1' );
			$h1_font_weight     = divino_get_option( 'font-weight-h1' );
			$h1_line_height     = divino_get_font_extras( divino_get_option( 'font-extras-h1' ), 'line-height', 'line-height-unit' );
			$h1_text_transform  = divino_get_font_extras( divino_get_option( 'font-extras-h1' ), 'text-transform' );
			$h1_letter_spacing  = divino_get_font_extras( divino_get_option( 'font-extras-h1' ), 'letter-spacing', 'letter-spacing-unit' );
			$h1_text_decoration = divino_get_font_extras( divino_get_option( 'font-extras-h1' ), 'text-decoration' );

			$h2_font_family     = divino_get_option( 'font-family-h2' );
			$h2_font_weight     = divino_get_option( 'font-weight-h2' );
			$h2_line_height     = divino_get_font_extras( divino_get_option( 'font-extras-h2' ), 'line-height', 'line-height-unit' );
			$h2_text_transform  = divino_get_font_extras( divino_get_option( 'font-extras-h2' ), 'text-transform' );
			$h2_letter_spacing  = divino_get_font_extras( divino_get_option( 'font-extras-h2' ), 'letter-spacing', 'letter-spacing-unit' );
			$h2_text_decoration = divino_get_font_extras( divino_get_option( 'font-extras-h2' ), 'text-decoration' );

			$h3_font_family     = divino_get_option( 'font-family-h3' );
			$h3_font_weight     = divino_get_option( 'font-weight-h3' );
			$h3_line_height     = divino_get_font_extras( divino_get_option( 'font-extras-h3' ), 'line-height', 'line-height-unit' );
			$h3_text_transform  = divino_get_font_extras( divino_get_option( 'font-extras-h3' ), 'text-transform' );
			$h3_letter_spacing  = divino_get_font_extras( divino_get_option( 'font-extras-h3' ), 'letter-spacing', 'letter-spacing-unit' );
			$h3_text_decoration = divino_get_font_extras( divino_get_option( 'font-extras-h3' ), 'text-decoration' );
			...
			$update_customizer_strctural_defaults = divino_check_is_structural_setup();
			...
			if ( divino_has_gcp_typo_preset_compatibility() ) {
				...
				$h4_font_family     = divino_get_option( 'font-family-h4' );
				$h4_font_weight     = divino_get_option( 'font-weight-h4' );
				$h4_line_height     = divino_get_font_extras( divino_get_option( 'font-extras-h4' ), 'line-height', 'line-height-unit' );
				$h4_text_transform  = divino_get_font_extras( divino_get_option( 'font-extras-h4' ), 'text-transform' );
				$h4_letter_spacing  = divino_get_font_extras( divino_get_option( 'font-extras-h4' ), 'letter-spacing', 'letter-spacing-unit' );
				$h4_text_decoration = divino_get_font_extras( divino_get_option( 'font-extras-h4' ), 'text-decoration' );

				$h5_font_family     = divino_get_option( 'font-family-h5' );
				$h5_font_weight     = divino_get_option( 'font-weight-h5' );
				$h5_line_height     = divino_get_font_extras( divino_get_option( 'font-extras-h5' ), 'line-height', 'line-height-unit' );
				$h5_text_transform  = divino_get_font_extras( divino_get_option( 'font-extras-h5' ), 'text-transform' );
				$h5_letter_spacing  = divino_get_font_extras( divino_get_option( 'font-extras-h5' ), 'letter-spacing', 'letter-spacing-unit' );
				$h5_text_decoration = divino_get_font_extras( divino_get_option( 'font-extras-h5' ), 'text-decoration' );

				$h6_font_family     = divino_get_option( 'font-family-h6' );
				$h6_font_weight     = divino_get_option( 'font-weight-h6' );
				$h6_line_height     = divino_get_font_extras( divino_get_option( 'font-extras-h6' ), 'line-height', 'line-height-unit' );
				$h6_text_transform  = divino_get_font_extras( divino_get_option( 'font-extras-h6' ), 'text-transform' );
				$h6_letter_spacing  = divino_get_font_extras( divino_get_option( 'font-extras-h6' ), 'letter-spacing', 'letter-spacing-unit' );
				$h6_text_decoration = divino_get_font_extras( divino_get_option( 'font-extras-h6' ), 'text-decoration' );
			...
			// Button Styling.
			$btn_border_radius_fields = divino_get_option( 'button-radius-fields' );
			$theme_btn_padding        = divino_get_option( 'theme-button-padding' );
			$highlight_theme_color    = divino_get_foreground_color( $theme_color );
			$button_styling_improved  = self::divino_4_6_4_compatibility();

			// Submenu Border color.
			$submenu_border               = divino_get_option( 'primary-submenu-border' );
			$primary_submenu_item_border  = divino_get_option( 'primary-submenu-item-border' );
			...
			$improve_gb_ui = divino_get_option( 'improve-gb-editor-ui', true );
			/** @psalm-suppress InvalidScalarArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

			$block_editor_legacy_setup = divino_block_based_legacy_setup();

			if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
				// Footer Bar Colors.
				$footer_bg_obj       = divino_get_option( 'footer-bg-obj' );
				$footer_color        = divino_get_option( 'footer-color' );
				$footer_link_color   = divino_get_option( 'footer-link-color' );
				$footer_link_h_color = divino_get_option( 'footer-link-h-color' );

				// Color.
				$footer_adv_bg_obj             = divino_get_option( 'footer-adv-bg-obj' );
				$footer_adv_text_color         = divino_get_option( 'footer-adv-text-color' );
				$footer_adv_widget_title_color = divino_get_option( 'footer-adv-wgt-title-color' );
				$footer_adv_link_color         = divino_get_option( 'footer-adv-link-color' );
				$footer_adv_link_h_color       = divino_get_option( 'footer-adv-link-h-color' );

				// Header Break Point.
				$header_break_point = divino_header_break_point();

				// Custom Buttom menu item.
				$header_custom_button_style          = divino_get_option( 'header-main-rt-section-button-style' );
				$header_custom_button_text_color     = divino_get_option( 'header-main-rt-section-button-text-color' );
				$header_custom_button_text_h_color   = divino_get_option( 'header-main-rt-section-button-text-h-color' );
				$header_custom_button_back_color     = divino_get_option( 'header-main-rt-section-button-back-color' );
				$header_custom_button_back_h_color   = divino_get_option( 'header-main-rt-section-button-back-h-color' );
				$header_custom_button_spacing        = divino_get_option( 'header-main-rt-section-button-padding' );
				$header_custom_button_border_color   = divino_get_option( 'header-main-rt-section-button-border-color' );
				$header_custom_button_border_h_color = divino_get_option( 'header-main-rt-section-button-border-h-color' );
				$header_custom_button_border_size    = divino_get_option( 'header-main-rt-section-button-border-size' );

				$header_custom_trans_button_text_color     = divino_get_option( 'header-main-rt-trans-section-button-text-color' );
				$header_custom_trans_button_text_h_color   = divino_get_option( 'header-main-rt-trans-section-button-text-h-color' );
				$header_custom_trans_button_back_color     = divino_get_option( 'header-main-rt-trans-section-button-back-color' );
				$header_custom_trans_button_back_h_color   = divino_get_option( 'header-main-rt-trans-section-button-back-h-color' );
				$header_custom_trans_button_spacing        = divino_get_option( 'header-main-rt-trans-section-button-padding' );
				$header_custom_trans_button_radius         = divino_get_option( 'header-main-rt-trans-section-button-border-radius' );
				$header_custom_trans_button_border_color   = divino_get_option( 'header-main-rt-trans-section-button-border-color' );
				$header_custom_trans_button_border_h_color = divino_get_option( 'header-main-rt-trans-section-button-border-h-color' );
				$header_custom_trans_button_border_size    = divino_get_option( 'header-main-rt-trans-section-button-border-size' );

			}

			$global_custom_button_border_size = divino_get_option( 'theme-button-border-group-border-size' );
			$btn_border_color                 = divino_get_option( 'theme-button-border-group-border-color' );
			$btn_border_h_color               = divino_get_option( 'theme-button-border-group-border-h-color' );

			/**
			 * Theme Button Typography
			 */
			$theme_btn_font_family     = divino_get_option( 'font-family-button' );
			$theme_btn_font_size       = divino_get_option( 'font-size-button' );
			$theme_btn_font_weight     = divino_get_option( 'font-weight-button' );
			$theme_btn_text_transform  = divino_get_font_extras( divino_get_option( 'font-extras-button' ), 'text-transform' );
			$theme_btn_line_height     = divino_get_font_extras( divino_get_option( 'font-extras-button' ), 'line-height', 'line-height-unit' );
			$theme_btn_letter_spacing  = divino_get_font_extras( divino_get_option( 'font-extras-button' ), 'letter-spacing', 'letter-spacing-unit' );
			$theme_btn_text_decoration = divino_get_font_extras( divino_get_option( 'font-extras-button' ), 'text-decoration' );

			if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
				/**
				 * Custom Header Button Typography
				 */
				$header_custom_btn_font_family    = divino_get_option( 'primary-header-button-font-family' );
				$header_custom_btn_font_weight    = divino_get_option( 'primary-header-button-font-weight' );
				$header_custom_btn_font_size      = divino_get_option( 'primary-header-button-font-size' );
				$header_custom_btn_text_transform = divino_get_option( 'primary-header-button-text-transform' );
				$header_custom_btn_line_height    = divino_get_option( 'primary-header-button-line-height' );
				$header_custom_btn_letter_spacing = divino_get_option( 'primary-header-button-letter-spacing' );

				$footer_adv_border_width = divino_get_option( 'footer-adv-border-width' );
				$footer_adv_border_color = divino_get_option( 'footer-adv-border-color' );
			}

			/**
			 * Apply text color depends on link color
			 */
			$btn_text_color = divino_get_option( 'button-color' );
			if ( empty( $btn_text_color ) ) {
				$btn_text_color = divino_get_foreground_color( $theme_color );
			}

			/**
			 * Apply text hover color depends on link hover color
			 */
			$btn_text_hover_color = divino_get_option( 'button-h-color' );
			if ( empty( $btn_text_hover_color ) ) {
				$btn_text_hover_color = divino_get_foreground_color( $link_hover_color );
			}
			$btn_bg_color     = divino_get_option( 'button-bg-color', $theme_color );
			$btn_preset_style = divino_get_option( 'button-preset-style' );
			...
			if ( 'button_04' === $btn_preset_style || 'button_05' === $btn_preset_style || 'button_06' === $btn_preset_style ) {
				...
				if ( '' === divino_get_option( 'button-bg-color' ) && '' === divino_get_option( 'button-color' ) ) {
					$btn_text_color = $theme_color;
				} elseif ( '' === divino_get_option( 'button-color' ) ) {
			...
			$btn_bg_hover_color = divino_get_option( 'button-bg-h-color', $link_hover_color );

			if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
				// Spacing of Big Footer.
				$small_footer_divider_color = divino_get_option( 'footer-sml-divider-color' );
				$small_footer_divider       = divino_get_option( 'footer-sml-divider' );

				/**
				 * Small Footer Styling
				 */
				$small_footer_layout = divino_get_option( 'footer-sml-layout', 'footer-sml-layout-1' );
				$divino_footer_width  = divino_get_option( 'footer-layout-width' );
			}

			// Blog Post Title Typography Options.
			$single_post_max                        = divino_get_option( 'blog-single-width' );
			$single_post_max_width                  = divino_get_option( 'blog-single-max-width' );
			$single_page_max                        = divino_get_option( 'page-single-width' );
			$single_page_max_width                  = divino_get_option( 'page-single-max-width' );
			$blog_width                             = divino_get_option( 'blog-width' );
			$blog_max_width                         = divino_get_option( 'blog-max-width' );
			$mobile_header_toggle_btn_style_color   = divino_get_option( 'mobile-header-toggle-btn-style-color', $btn_bg_color );
			$mobile_header_toggle_btn_border_radius = divino_get_option( 'mobile-header-toggle-btn-border-radius' );
			$aspect_ratio_type                      = divino_get_option( 'blog-image-ratio-type' );
			$predefined_scale                       = divino_get_option( 'blog-image-ratio-pre-scale' );
			$custom_scale_width                     = divino_get_option( 'blog-image-custom-scale-width', 16 );
			$custom_scale_height                    = divino_get_option( 'blog-image-custom-scale-height', 9 );
			...
			$btn_style_color = divino_get_option( 'mobile-header-toggle-btn-style-color', false );

			if ( ! $btn_style_color ) {
				// button text color.
				$menu_btn_color = esc_attr( divino_get_option( 'button-color' ) );
			} else {
				// toggle button color.
				$menu_btn_color = divino_get_foreground_color( $btn_style_color );
			}

			$css_output = array();
			// Body Font Family.
			$body_font_family = divino_body_font_family();
			$body_font_weight = divino_get_option( 'body-font-weight' );
			...
			$h4_properties = array(
				'font-size'   => divino_responsive_font( $heading_h4_font_size, 'desktop' ),
				'line-height' => esc_attr( $headings_line_height ),
			);

			$h5_properties = array(
				'font-size'   => divino_responsive_font( $heading_h5_font_size, 'desktop' ),
				'line-height' => esc_attr( $headings_line_height ),
			);

			$h6_properties = array(
				'font-size'   => divino_responsive_font( $heading_h6_font_size, 'desktop' ),
				'line-height' => esc_attr( $headings_line_height ),
			);

			if ( divino_has_gcp_typo_preset_compatibility() ) {
				$h4_font_properties = array(
					'font-weight'     => divino_get_css_value( $h4_font_weight, 'font' ),
					'font-family'     => divino_get_css_value( $h4_font_family, 'font' ),
				...
				$h5_font_properties = array(
					'font-weight'     => divino_get_css_value( $h5_font_weight, 'font' ),
					'font-family'     => divino_get_css_value( $h5_font_family, 'font' ),
				...
				$h6_font_properties = array(
					'font-weight'     => divino_get_css_value( $h6_font_weight, 'font' ),
					'font-family'     => divino_get_css_value( $h6_font_family, 'font' ),
			...
			$article_space            = self::divino_4_6_0_compatibility() ? '2.5em' : '3em';
			$color_palette_reorganize = self::divino_4_8_9_compatibility();
			...
			$css_output = array(
				':root'                                  => array(
					...
					'--ast-code-block-background'          => true === self::divino_check_default_color_typo() ? $is_dark_palette ? 'var(--ast-global-color-5)' : '#ECEFF3' : '#EEEEEE',
					'--ast-comment-inputs-background'      => true === self::divino_check_default_color_typo() ? '#F9FAFB' : '#FAFAFA',
					'--ast-normal-container-width'         => $site_content_width . 'px',
					'--ast-narrow-container-width'         => $narrow_container_max_width . 'px',
					'--ast-blog-title-font-weight'         => self::divino_4_6_0_compatibility() ? '600' : 'normal',
					'--ast-blog-meta-weight'               => self::divino_4_6_0_compatibility() ? '600' : 'inherit',
				...
				// HTML.
				'html'                                   => array(
					'font-size' => divino_get_font_css_value( (int) $body_font_size_desktop * 6.25, '%' ),
				),
				$link_selector                           => array(
				...
				'body, button, input, select, textarea, .ast-button, .ast-custom-button' => array(
					'font-family'     => divino_get_font_family( $body_font_family ),
					'font-weight'     => esc_attr( $body_font_weight ),
					'font-size'       => divino_responsive_font( $body_font_size, 'desktop' ),
				...
				'blockquote'                             => array(
					'border-color' => divino_hex_to_rgba( $link_color, 0.15 ),
				),
				'p, .entry-content p'                    => array(
					'margin-bottom' => divino_get_css_value( $para_margin_bottom, 'em' ),
				),
				...
				)                                        => divino_get_font_array_css( divino_get_option( 'headings-font-family' ), divino_get_option( 'headings-font-weight' ), array(), 'headings-font-extras' ),
				...
				'.site-title'                            => array(
					'font-size' => divino_responsive_font( $site_title_font_size, 'desktop' ),
				...
				'.site-header .site-description'         => array(
					'font-size' => divino_responsive_font( $site_tagline_font_size, 'desktop' ),
					'display'   => esc_attr( $desktop_tagline_visibility ),
				),
				'.entry-title'                           => array(
					'font-size' => divino_responsive_font( $archive_post_title_font_size, 'desktop' ),
				),
				'.ast-blog-single-element.ast-taxonomy-container a' => array(
					'font-size' => divino_responsive_font( $archive_post_tax_font_size, 'desktop' ),
				),
				'.ast-blog-meta-container'               => array(
					'font-size' => divino_responsive_font( $archive_post_meta_font_size, 'desktop' ),
				),
				'blog-layout-5' === $blog_layout ? '.archive .ast-article-post, .blog .ast-article-post, .archive .ast-article-post:hover, .blog .ast-article-post:hover' : '.archive .ast-article-post .ast-article-inner, .blog .ast-article-post .ast-article-inner, .archive .ast-article-post .ast-article-inner:hover, .blog .ast-article-post .ast-article-inner:hover' => array(
					'border-top-left-radius'     => divino_responsive_spacing( $archive_cards_radius, 'top', 'desktop' ),
					'border-top-right-radius'    => divino_responsive_spacing( $archive_cards_radius, 'right', 'desktop' ),
					'border-bottom-right-radius' => divino_responsive_spacing( $archive_cards_radius, 'bottom', 'desktop' ),
					'border-bottom-left-radius'  => divino_responsive_spacing( $archive_cards_radius, 'left', 'desktop' ),
					'overflow'                   => 'hidden',
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size'       => divino_responsive_font( $heading_h1_font_size, 'desktop' ),
					'font-weight'     => divino_get_css_value( $h1_font_weight, 'font' ),
					'font-family'     => divino_get_css_value( $h1_font_family, 'font' ),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size'       => divino_responsive_font( $heading_h2_font_size, 'desktop' ),
					'font-weight'     => divino_get_css_value( $h2_font_weight, 'font' ),
					'font-family'     => divino_get_css_value( $h2_font_family, 'font' ),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size'       => divino_responsive_font( $heading_h3_font_size, 'desktop' ),
					'font-weight'     => divino_get_css_value( $h3_font_weight, 'font' ),
					'font-family'     => divino_get_css_value( $h3_font_family, 'font' ),
				...
				'.tagcloud a:hover, .tagcloud a:focus, .tagcloud a.current-item' => array(
					'color'            => divino_get_foreground_color( $link_color ),
				...
				'.entry-meta, .entry-meta *'             => array(
					'line-height' => '1.45',
					'color'       => esc_attr( $link_color ),
					'font-weight' => self::divino_4_6_0_compatibility() && ! defined( 'divino_EXT_VER' ) ? '600' : '',
				),
				...
				'blockquote'                             => array(
					'color' => divino_adjust_brightness( $text_color, 75, 'darken' ),
				),
				...
				'.page-links .page-link, .single .post-navigation a' => array(
					'color' => esc_attr( self::divino_4_6_0_compatibility() ? $text_color : $link_color ),
				),
				...
				'.ast-search-menu-icon.slide-search input.search-field' => array(
					'width' => divino_Builder_Helper::$is_header_footer_builder_active ? '0' : '',
				),
				'.ast-header-search .ast-search-menu-icon.ast-dropdown-active .search-form, .ast-header-search .ast-search-menu-icon.ast-dropdown-active .search-field:focus' => array(
					'transition'   => 'all 0.2s',
					'border-color' => divino_get_option( 'site-accessibility-highlight-input-color' ),
				),
			...
			if ( self::divino_4_4_0_compatibility() ) {
			...
			if ( divino_has_global_color_format_support() ) {
			...
			if ( ! self::divino_heading_inside_widget_font_size_comp() ) {
				$selectors .= ', .widget .wp-block-heading';
			}

			// Default widget title color.
			$css_output[ $selectors ] = array(
				'font-size' => divino_get_font_css_value( (int) $body_font_size_desktop * 1.428571429 ),
				'color'     => divino_has_global_color_format_support() ? esc_attr( $heading_base_color ) : esc_attr( $text_color ),
			);

			// Remove this condition after 2-3 updates of add-on.
			if ( defined( 'divino_EXT_VER' ) && version_compare( divino_EXT_VER, '3.0.1', '>=' ) ) {
				$css_output['.single .ast-author-details .author-title'] = array(
					'color' => esc_attr( $link_hover_color ),
				);
			}

			if ( 'no-sidebar' !== divino_page_layout() ) {
			...
			$content_links_underline = divino_get_option( 'underline-content-links' );
			...
			if ( $content_links_underline ) {
				...
				$excluding_anchor_selectors = apply_filters( 'divino_remove_underline_anchor_links', $excluding_anchor_selectors );
			...
			if ( $enable_site_accessibility ) {
				$outline_style = divino_get_option( 'site-accessibility-highlight-type' );
				$outline_color = divino_get_option( 'site-accessibility-highlight-color' );

				$outline_input_style = divino_get_option( 'site-accessibility-highlight-input-type' );
				...
				$outline_input_color = divino_get_option( 'site-accessibility-highlight-input-color' );
				...
				if ( 'unset' !== $outline_input_style ) {
					$css_output[ $html_selectors_focus_only_inputs ] = array(
						...
						'border-width'  => 'thin',
						'outline-color' => divino_get_option( 'site-accessibility-highlight-input-color' ),
					);
				} else {
					$css_output[ $html_selectors_focus_only_inputs ] = array(
			...
			$page_header_logo = defined( 'divino_EXT_VER' ) && divino_Ext_Extension::is_active( 'advanced-headers' ) && divino_Ext_Advanced_Headers_Loader::divino_advanced_headers_design_option( 'logo-url' ) ? true : false;

			if ( divino_get_option( 'logo-title-inline' ) || is_customize_preview() ) {
			...
			if ( get_theme_mod( 'custom_logo' )
				|| divino_get_option( 'transparent-header-logo' )
				|| divino_get_option( 'sticky-header-logo' )
				|| $page_header_logo
				...
				if ( divino_get_option( 'header-logo-color' ) ) {
					$css_output['.site-logo-img img'] = array(
				...
				if ( divino_get_option( 'transparent-header-logo-color' ) ) {
			...
			$parse_css .= divino_parse_css( $css_output );
			...
			$parse_css .= divino_parse_css( $oembed_wrapper );
			...
			if ( ! divino_Builder_Helper::$is_header_footer_builder_active ) {
				...
				$parse_css .= divino_parse_css( $old_header_mobile_toggle );
			}

			$parse_css .= divino_container_layout_css();

			if ( 'no-sidebar' !== divino_page_layout() ) {
				$parse_css .= divino_Enqueue_Scripts::trim_css( self::load_sidebar_static_css() );
				$parse_css .= self::divino_sticky_sidebar_css();
			}

			if ( self::divino_4_6_0_compatibility() ) {

				// Forms default styling improvements.
				$parse_css .= self::divino_default_forms_styling_dynamic_css();
			}
			...
			if ( true === divino_Builder_Helper::$is_header_footer_builder_active ) {
				...
				$parse_css .= divino_parse_css(
					...
					'',
					number_format( absint( divino_get_tablet_breakpoint() ) + 0.9, 1, '.', '' )
				);
				...
				$parse_css .= divino_parse_css(
					...
					divino_get_tablet_breakpoint( '', 1 )
				);
			}

			// Comments CSS.
			if ( ! divino_Builder_Helper::apply_flex_based_css() ) {
				require_once divino_THEME_DIR . 'inc/dynamic-css/comments.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			} else {
				require_once divino_THEME_DIR . 'inc/dynamic-css/comments-flex.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			}

			// Single post improvement.
			require_once divino_THEME_DIR . 'inc/dynamic-css/single-post.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			$live_search_enabled = divino_get_option( 'live-search', false );
			if ( ( true === divino_Builder_Helper::$is_header_footer_builder_active && divino_Builder_Helper::is_component_loaded( 'search', 'header' ) && $live_search_enabled ) || ( is_search() && true === divino_get_option( 'ast-search-live-search' ) ) ) {
				// Live search CSS.
				require_once divino_THEME_DIR . 'inc/dynamic-css/live-search.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			}

			if ( divino_Builder_Helper::is_component_loaded( 'woo-cart', 'header' ) || divino_Builder_Helper::is_component_loaded( 'edd-cart', 'header' ) ) {
				$parse_css .= divino_Enqueue_Scripts::trim_css( self::load_cart_static_css() );
			...
			if ( ! divino_Builder_Helper::$is_header_footer_builder_active ) {
				$footer_css_output = array(
					...
					'.ast-small-footer > .ast-footer-overlay' => divino_get_background_obj( $footer_bg_obj ),
					...
					'.footer-adv .footer-adv-overlay' => array(
						...
						'border-top-width' => divino_get_css_value( $footer_adv_border_width, 'px' ),
					...
					'.footer-adv-overlay'             => divino_get_background_obj( $footer_adv_bg_obj ),

				);

				$parse_css .= divino_parse_css( $footer_css_output );
			}

			// Paginaiton CSS.
			require_once divino_THEME_DIR . 'inc/dynamic-css/pagination.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			// Related Posts Dynamic CSS.

			// Navigation CSS.
			if ( ! self::divino_4_6_0_compatibility() && is_single() ) {
				/**
				 * CSS for post navigation design break for the old users.
				 */
				$parse_css .= divino_Enqueue_Scripts::trim_css(
					'
			...
			// Navigation CSS.
			if ( is_single() && self::divino_4_6_0_compatibility() ) {
				require_once divino_THEME_DIR . 'inc/dynamic-css/navigation.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			}
			 ...
			 * @since 4.7.0
			 */
			require_once divino_THEME_DIR . 'inc/dynamic-css/logo-svg-icons.php'; // PHPCS:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			...
			$parse_css                         .= divino_parse_css( $gtn_plugin_button_center_alignment );

			$ast_container_layout = divino_get_content_layout();
			$is_boxed             = divino_is_content_style_boxed();
			$is_sidebar_boxed     = divino_is_sidebar_style_boxed();
			$ast_container_layout = divino_apply_boxed_layouts( $ast_container_layout, $is_boxed, $is_sidebar_boxed );
			...
			if ( self::gutenberg_core_blocks_css_comp() && is_singular() ) {
				...
				$parse_css .= divino_parse_css( $trans_header_responsive_top_space_css_fix, '', divino_get_tablet_breakpoint() );
			}
			...
			if ( self::gutenberg_media_text_block_css_compat() && is_singular() ) {
				...
				/* Parse CSS from array() -> max-width: (tablet-breakpoint)px CSS */
				$parse_css .= divino_parse_css( $remove_primary_padding_on_mobile_css, '', divino_get_tablet_breakpoint() );
			}
			...
			if ( self::gtn_group_cover_css_comp() && is_singular() ) {
				...
				if ( 'disabled' === $display_header && apply_filters( 'divino_content_margin_full_width_contained', true ) || ( divino_Ext_Transparent_Header_Markup::is_transparent_header() ) || ( self::gutenberg_core_blocks_css_comp() ) ) {
					...
					$parse_css     .= divino_parse_css( $gtn_margin_top );
				}
				/**
				...
				if ( true === $update_customizer_strctural_defaults ) {
					...
					if ( 'disabled' !== $display_title && ! divino_Ext_Transparent_Header_Markup::is_transparent_header() && apply_filters( 'divino_contained_layout_primary_spacing', true ) ) {
						$gtn_margin_top = array(
							'.ast-plain-container.ast-no-sidebar #primary' => array(
								'margin-top'    => '60px',
								'margin-bottom' => '60px',
						...
						$parse_css .= divino_parse_css( $gtn_margin_top, '1200' );
					}
				}
			}

			$single_post_outside_spacing = divino_get_option( 'single-post-outside-spacing' );
			...
			if ( ! self::divino_4_6_0_compatibility() ) {
				$single_post_outside_spacing_css_desktop = array(
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'margin-top'    => divino_responsive_spacing( $single_post_outside_spacing, 'top', 'desktop' ),
						'margin-bottom' => divino_responsive_spacing( $single_post_outside_spacing, 'bottom', 'desktop' ),
					),
					'.ast-left-sidebar.ast-single-post #primary, .ast-right-sidebar.ast-single-post #primary, .ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'padding-left'  => divino_responsive_spacing( $single_post_outside_spacing, 'left', 'desktop' ),
						'padding-right' => divino_responsive_spacing( $single_post_outside_spacing, 'right', 'desktop' ),
					),
				);

				$parse_css .= divino_parse_css( $single_post_outside_spacing_css_desktop );
				...
				$single_post_outside_spacing_css_tablet = array(
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container #primary, .ast-narrow-container #primary' => array(
						'margin-top'    => divino_responsive_spacing( $single_post_outside_spacing, 'top', 'tablet' ),
						'margin-bottom' => divino_responsive_spacing( $single_post_outside_spacing, 'bottom', 'tablet' ),
					),
					'.ast-left-sidebar #primary, .ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container #primary, .ast-narrow-container #primary' => array(
						'padding-left'  => divino_responsive_spacing( $single_post_outside_spacing, 'left', 'tablet' ),
						'padding-right' => divino_responsive_spacing( $single_post_outside_spacing, 'right', 'tablet' ),
					),
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'margin-top'    => divino_responsive_spacing( $single_post_outside_spacing, 'top', 'tablet' ),
						'margin-bottom' => divino_responsive_spacing( $single_post_outside_spacing, 'bottom', 'tablet' ),
				...
				$parse_css .= divino_parse_css( $single_post_outside_spacing_css_tablet, '', divino_get_tablet_breakpoint() );

				$single_post_outside_spacing_css_mobile = array(
					'.ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-plain-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'margin-top'    => divino_responsive_spacing( $single_post_outside_spacing, 'top', 'mobile' ),
						'margin-bottom' => divino_responsive_spacing( $single_post_outside_spacing, 'bottom', 'mobile' ),
					),
					'.ast-left-sidebar.ast-single-post #primary, .ast-right-sidebar.ast-single-post #primary, .ast-separate-container.ast-single-post.ast-right-sidebar #primary, .ast-separate-container.ast-single-post.ast-left-sidebar #primary, .ast-separate-container.ast-single-post #primary, .ast-narrow-container.ast-single-post #primary' => array(
						'padding-left'  => divino_responsive_spacing( $single_post_outside_spacing, 'left', 'mobile' ),
						'padding-right' => divino_responsive_spacing( $single_post_outside_spacing, 'right', 'mobile' ),
					),
				);

				$parse_css .= divino_parse_css( $single_post_outside_spacing_css_mobile, '', divino_get_mobile_breakpoint() );
			}

			if ( self::divino_4_8_2_compatibility() ) {
				...
				$parse_css .= divino_parse_css( $single_post_outside_padding_css_tablet, '', divino_get_tablet_breakpoint() );
				...
				$parse_css .= divino_parse_css( $single_post_outside_padding_css_mobile, '', divino_get_mobile_breakpoint() );
			}
			...
			$remove_single_post_top_padding_container = array(
				'.ast-separate-container #primary, .ast-narrow-container #primary' => array(
					'padding-top' => divino_get_css_value( 0, 'px' ),
				),
			);
			...
			$remove_single_post_bottom_padding_container = array(
				'.ast-separate-container #primary, .ast-narrow-container #primary' => array(
					'padding-bottom' => divino_get_css_value( 0, 'px' ),
				),
			);

			if ( isset( $single_post_outside_spacing['desktop']['top'] ) && '' != $single_post_outside_spacing['desktop']['top'] ) {
				$parse_css .= divino_parse_css( $remove_single_post_top_padding_container );
			}
			if ( isset( $single_post_outside_spacing['tablet']['top'] ) && '' != $single_post_outside_spacing['tablet']['top'] ) {
				$parse_css .= divino_parse_css( $remove_single_post_top_padding_container, '', divino_get_tablet_breakpoint() );
			}
			if ( isset( $single_post_outside_spacing['mobile']['top'] ) && '' != $single_post_outside_spacing['mobile']['top'] ) {
				$parse_css .= divino_parse_css( $remove_single_post_top_padding_container, '', divino_get_mobile_breakpoint() );
			}

			if ( isset( $single_post_outside_spacing['desktop']['top'] ) && '' != $single_post_outside_spacing['desktop']['top'] ) {
				$parse_css .= divino_parse_css( $remove_single_post_bottom_padding_container );
			}
			if ( isset( $single_post_outside_spacing['tablet']['top'] ) && '' != $single_post_outside_spacing['tablet']['top'] ) {
				$parse_css .= divino_parse_css( $remove_single_post_bottom_padding_container, '', divino_get_tablet_breakpoint() );
			}
			if ( isset( $single_post_outside_spacing['mobile']['top'] ) && '' != $single_post_outside_spacing['mobile']['top'] ) {
				$parse_css .= divino_parse_css( $remove_single_post_bottom_padding_container, '', divino_get_mobile_breakpoint() );
			}
			...
			if ( $block_editor_legacy_setup ) {
				...
				*/
				if ( self::gtn_image_group_css_comp() ) {
					...
					$parse_css              .= divino_parse_css( $gtn_full_wide_image_css, '1200' );
					...
					$parse_css .= divino_parse_css( $gtn_tablet_column_css, '', '782' );
				}
								...
								$parse_css .= divino_parse_css(
									array(
										...
										'.ast-plain-container.ast-no-sidebar .entry-content .alignwide .wp-block-cover__inner-container, .ast-plain-container.ast-no-sidebar .entry-content .alignfull .wp-block-cover__inner-container' => array(
											'width' => divino_get_css_value( $site_content_width + 40, 'px' ),
										),
									),
									'1200'
								);
				...
				if ( self::gutenberg_core_blocks_css_comp() ) {
					...
					$parse_css .= divino_parse_css( $desktop_screen_gb_css );
					...
					if ( false === $improve_gb_ui ) {
						...
						/* Parse CSS from array() -> min-width: (1200)px CSS */
						$parse_css .= divino_parse_css( $middle_screen_min_gb_css, '1200' );
					}
					...
					$parse_css .= divino_parse_css( $middle_screen_max_gb_css, '', '1200' );
					...
					$parse_css .= divino_parse_css( $tablet_screen_min_gb_css, divino_get_tablet_breakpoint() );
					...
					$parse_css .= divino_parse_css( $mobile_screen_max_gb_css, '', divino_get_mobile_breakpoint() );
				}

				$is_legacy_setup = 'legacy' === divino_get_option( 'wp-blocks-ui' ) ? true : false;

				if ( $is_legacy_setup && divino_wp_version_compare( '6.0', '>=' ) ) {
					...
					$parse_css               .= divino_parse_css( $image_block_center_align );
				}
				...
				if ( $is_legacy_setup ) {
					...
					$parse_css               .= divino_parse_css( $table_block_center_align );
				}
				...
				if ( self::gutenberg_media_text_block_css_compat() ) {
					...
					$parse_css .= divino_parse_css( $media_text_block_padding_css, divino_get_mobile_breakpoint() );
					...
					/* Parse CSS from array() -> max-width: (mobile-breakpoint)px CSS */
					$parse_css .= divino_parse_css( $mobile_screen_media_text_block_css, '', divino_get_mobile_breakpoint() );
				}
			}
			...
			if ( divino_button_default_padding_updated() ) {
				$default_border_size = '';
			}

			// Outline Gutenberg button compatibility CSS.
			$theme_btn_top_border    = isset( $global_custom_button_border_size['top'] ) && ( '' !== $global_custom_button_border_size['top'] && '0' !== $global_custom_button_border_size['top'] ) ? divino_get_css_value( $global_custom_button_border_size['top'], 'px' ) : $default_border_size;
			$theme_btn_right_border  = isset( $global_custom_button_border_size['right'] ) && ( '' !== $global_custom_button_border_size['right'] && '0' !== $global_custom_button_border_size['right'] ) ? divino_get_css_value( $global_custom_button_border_size['right'], 'px' ) : $default_border_size;
			$theme_btn_left_border   = isset( $global_custom_button_border_size['left'] ) && ( '' !== $global_custom_button_border_size['left'] && '0' !== $global_custom_button_border_size['left'] ) ? divino_get_css_value( $global_custom_button_border_size['left'], 'px' ) : $default_border_size;
			$theme_btn_bottom_border = isset( $global_custom_button_border_size['bottom'] ) && ( '' !== $global_custom_button_border_size['bottom'] && '0' !== $global_custom_button_border_size['bottom'] ) ? divino_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
			...
			if ( self::gutenberg_core_patterns_compat() ) {
				...
				$outline_button_css = array(
					...
					'.post-page-numbers.current .page-link, .ast-pagination .page-numbers.current'                    => array(
						'color'            => divino_get_foreground_color( $theme_color ),
				...
				$parse_css .= divino_parse_css( $outline_button_css );
				...
				if ( $block_editor_legacy_setup ) {
					...
					if ( ! divino_button_default_padding_updated() ) {
						...
						$parse_css .= divino_parse_css( $outline_button_tablet_css, '', divino_get_tablet_breakpoint() );
						...
						$parse_css .= divino_parse_css( $outline_button_mobile_css, '', divino_get_mobile_breakpoint() );
					}
					...
					/* Parse CSS from array() -> min-width: (mobile-breakpoint) px CSS  */
					$parse_css .= divino_parse_css( $gb_patterns_min_mobile_css, divino_get_mobile_breakpoint() );
				}
			}
			 ...
			 */
			$scndry_btn_text_color                   = divino_get_option( 'secondary-button-color' );
			$scndry_btn_border_color                 = divino_get_option( 'secondary-theme-button-border-group-border-color' );
			$scndry_btn_border_h_color               = divino_get_option( 'secondary-theme-button-border-group-border-h-color' );
			$global_scndry_custom_button_border_size = divino_get_option( 'secondary-theme-button-border-group-border-size' );
			$scndry_theme_btn_top_border             = isset( $global_scndry_custom_button_border_size['top'] ) && ( '' !== $global_scndry_custom_button_border_size['top'] && '0' !== $global_scndry_custom_button_border_size['top'] ) ? divino_get_css_value( $global_scndry_custom_button_border_size['top'], 'px' ) : $default_border_size;
			$scndry_theme_btn_right_border           = isset( $global_scndry_custom_button_border_size['right'] ) && ( '' !== $global_scndry_custom_button_border_size['right'] && '0' !== $global_scndry_custom_button_border_size['right'] ) ? divino_get_css_value( $global_scndry_custom_button_border_size['right'], 'px' ) : $default_border_size;
			$scndry_theme_btn_left_border            = isset( $global_scndry_custom_button_border_size['left'] ) && ( '' !== $global_scndry_custom_button_border_size['left'] && '0' !== $global_scndry_custom_button_border_size['left'] ) ? divino_get_css_value( $global_scndry_custom_button_border_size['left'], 'px' ) : $default_border_size;
			$scndry_theme_btn_bottom_border          = isset( $global_scndry_custom_button_border_size['bottom'] ) && ( '' !== $global_scndry_custom_button_border_size['bottom'] && '0' !== $global_scndry_custom_button_border_size['bottom'] ) ? divino_get_css_value( $global_scndry_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
			$scndry_theme_btn_font_family            = divino_get_option( 'secondary-font-family-button' );
			$scndry_theme_btn_font_size              = divino_get_option( 'secondary-font-size-button' );
			$scndry_theme_btn_font_weight            = divino_get_option( 'secondary-font-weight-button' );
			$scndry_theme_btn_text_transform         = divino_get_font_extras( divino_get_option( 'secondary-font-extras-button' ), 'text-transform' );
			$scndry_theme_btn_line_height            = divino_get_font_extras( divino_get_option( 'secondary-font-extras-button' ), 'line-height', 'line-height-unit' );
			$scndry_theme_btn_letter_spacing         = divino_get_font_extras( divino_get_option( 'secondary-font-extras-button' ), 'letter-spacing', 'letter-spacing-unit' );
			$scndry_theme_btn_text_decoration        = divino_get_font_extras( divino_get_option( 'secondary-font-extras-button' ), 'text-decoration' );
			$scndry_theme_btn_padding                = divino_get_option( 'secondary-theme-button-padding' );
			$scndry_btn_border_radius_fields         = divino_get_option( 'secondary-button-radius-fields' );
			$scndry_btn_bg_color                     = divino_get_option( 'secondary-button-bg-color' );
			$scndry_btn_bg_hover_color               = divino_get_option( 'secondary-button-bg-h-color' );
			$scndry_btn_text_hover_color             = divino_get_option( 'secondary-button-h-color' );
			$outline_button_selector                 = '.wp-block-button.is-style-outline .wp-block-button__link.wp-element-button, .ast-outline-button';
			$padding_top                             = divino_responsive_spacing( $scndry_theme_btn_padding, 'top', 'desktop' );
			$padding_right                           = divino_responsive_spacing( $scndry_theme_btn_padding, 'right', 'desktop' );
			$padding_bottom                          = divino_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'desktop' );
			$padding_left                            = divino_responsive_spacing( $scndry_theme_btn_padding, 'left', 'desktop' );
			$border_top_val                          = '';
			$border_right_val                        = '';
			$border_bottom_val                       = '';
			$border_left_val                         = '';
			...
			$secondary_btn_preset_style = divino_get_option( 'secondary-button-preset-style' );
			...
			if ( 'button_04' === $secondary_btn_preset_style || 'button_05' === $secondary_btn_preset_style || 'button_06' === $secondary_btn_preset_style ) {
				...
				if ( '' === divino_get_option( 'secondary-button-bg-color' ) && '' === divino_get_option( 'secondary-button-color' ) ) {
					$btn_color_val = $theme_color;
				} elseif ( '' === divino_get_option( 'secondary-button-color' ) ) {
			...
			$outline_button_css_desktop = array(
				$outline_button_selector => array(
					...
					'font-family'                => divino_get_font_family( $scndry_theme_btn_font_family ),
					'font-weight'                => esc_attr( $scndry_theme_btn_font_weight ),
					'font-size'                  => isset( $scndry_theme_btn_font_size['desktop'] ) && isset( $scndry_theme_btn_font_size['desktop-unit'] ) && is_array( $scndry_theme_btn_font_size ) ? divino_get_font_css_value( $scndry_theme_btn_font_size['desktop'], $scndry_theme_btn_font_size['desktop-unit'] ) : '',
					...
					'border-top-left-radius'     => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'desktop' ),
					'border-top-right-radius'    => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'desktop' ),
					'border-bottom-right-radius' => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'desktop' ),
					'border-bottom-left-radius'  => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'desktop' ),
				),
			...
			$outline_button_css_tablet = array(
				$outline_button_selector => array(
					'font-size'                  => divino_responsive_font( $scndry_theme_btn_font_size, 'tablet' ),
					'padding-top'                => divino_responsive_spacing( $scndry_theme_btn_padding, 'top', 'tablet' ),
					'padding-right'              => divino_responsive_spacing( $scndry_theme_btn_padding, 'right', 'tablet' ),
					'padding-bottom'             => divino_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'tablet' ),
					'padding-left'               => divino_responsive_spacing( $scndry_theme_btn_padding, 'left', 'tablet' ),
					'border-top-left-radius'     => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'tablet' ),
					'border-top-right-radius'    => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'tablet' ),
					'border-bottom-right-radius' => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'tablet' ),
					'border-bottom-left-radius'  => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'tablet' ),
				),
			);

			$outline_button_css_mobile = array(
				$outline_button_selector => array(
					'font-size'                  => divino_responsive_font( $scndry_theme_btn_font_size, 'mobile' ),
					'padding-top'                => divino_responsive_spacing( $scndry_theme_btn_padding, 'top', 'mobile' ),
					'padding-right'              => divino_responsive_spacing( $scndry_theme_btn_padding, 'right', 'mobile' ),
					'padding-bottom'             => divino_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'mobile' ),
					'padding-left'               => divino_responsive_spacing( $scndry_theme_btn_padding, 'left', 'mobile' ),
					'border-top-left-radius'     => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'mobile' ),
					'border-top-right-radius'    => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'mobile' ),
					'border-bottom-right-radius' => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'mobile' ),
					'border-bottom-left-radius'  => divino_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'mobile' ),
				),
			);
			...
			if ( 'button_01' === $secondary_btn_preset_style || 'button_02' === $secondary_btn_preset_style || 'button_03' === $secondary_btn_preset_style ) {
				if ( empty( $scndry_btn_text_color ) ) {
					$scndry_btn_text_color = divino_get_foreground_color( $theme_color );
				}
			...
			$parse_css .= divino_parse_css( $outline_button_css_desktop );

			/* Parse CSS from array() -> Tablet */
			$parse_css .= divino_parse_css( $outline_button_css_tablet, '', divino_get_tablet_breakpoint() );

			/* Parse CSS from array() -> Mobile */
			$parse_css .= divino_parse_css( $outline_button_css_mobile, '', divino_get_mobile_breakpoint() );
			 ...
			 * @since 4.4.0
			 */
			if ( divino_wp_version_compare( '6.3', '>=' ) ) {
				...
				/* Parse CSS from array() -> All media CSS */
				$parse_css .= divino_parse_css( $figure_margin_bottom );
			}
			...
			if ( $is_widget_title_support_font_weight ) {
				...
				/* Parse CSS from array() -> All media CSS */
				$parse_css .= divino_parse_css( $widget_title_font_weight_support );
			}
			...
			if ( defined( 'ELEMENTOR_PRO_VERSION' ) ) {
				...
				$parse_css              .= divino_parse_css( $elementor_shop_page_css );
			}
			...
			if ( defined( 'ELEMENTOR_PRO_VERSION' ) && $elementor_heading_margin_style_comp ) {
				...
				$parse_css .= divino_parse_css( $elementor_base_css );
			}

			// Getting the responsive alignment option.
			$shop_product_alignment = divino_get_option( 'shop-product-align-responsive' );

			// Added Check if the tablet alignment is 'align-center'
			if ( ( isset( $shop_product_alignment['desktop'] ) && 'align-center' === $shop_product_alignment['desktop'] ) && 'shop-page-list-style' !== divino_get_option( 'shop-style' ) ) {
				...
				/* Parse CSS from array() -> Desktop CSS */
				$parse_css .= divino_parse_css( $desktop_review_wrapper );
			}
			...
			if ( class_exists( 'WooCommerce' ) && ! is_product() ) {
				...
				/* Parse CSS from array() -> Desktop CSS */
				$parse_css .= divino_parse_css( $review_rating_style );
			}
			...
			if ( has_block( 'core/cover' ) ) {
				...
				$parse_css .= divino_parse_css( $cover_block_style );
			}
			...
			if ( true === $update_customizer_strctural_defaults ) {
				...
				$default_layout_update_css = array(
					...
					'.ast-separate-container .ast-article-post, .ast-separate-container .ast-article-single, .ast-separate-container .comment-respond' => array(
						'padding' => self::divino_4_6_0_compatibility() && is_single() ? '2.5em' : '3em',
					),
					...
					'.entry-title'                    => array(
						'margin-bottom' => self::divino_4_6_0_compatibility() ? '0.6em' : '0.5em',
					),
				...
				if ( ! self::divino_4_6_0_compatibility() ) {
					...
					if ( is_single() && divino_get_option( 'single-content-images-shadow', false ) ) {
				...
				/* Parse CSS from array() -> Desktop CSS */
				$parse_css .= divino_parse_css( $default_layout_update_css );
				...
				$parse_css .= divino_parse_css( $default_tablet_layout_css, divino_get_tablet_breakpoint() );
				...
				$parse_css .= divino_parse_css( $default_mobile_layout_css, '', divino_get_mobile_breakpoint() );
				...
				if ( is_user_logged_in() ) {
					...
					$parse_css                  .= divino_parse_css( $admin_bar_specific_page_css );
					...
					$parse_css                    .= divino_parse_css( $admin_bar_responsive_page_css, '', '782' );
				}
				...
				$parse_css .= divino_parse_css( $default_medium_layout_css, '1201' );
				...
				if ( is_author() ) {
					...
					/* Parse CSS from array() -> Desktop CSS */
					$parse_css                    .= divino_parse_css( $default_author_css );
					...
					/* Parse CSS from array() -> min-width: (tablet-breakpoint) CSS */
					$parse_css                    .= divino_parse_css( $default_tablet_min_author_css, divino_get_tablet_breakpoint() );
					...
					$parse_css                             .= divino_parse_css( $default_max_tablet_author_css, '', divino_get_tablet_breakpoint() );
					...
					$parse_css .= divino_parse_css( $default_tablet_min_extra_px_author_css, divino_get_tablet_breakpoint( '', 1 ) );
				}
			} else {
			...
			/* Parse CSS from array() -> max-width: (tablet-breakpoint)px CSS */
			$parse_css .= divino_parse_css( $static_layout_css, '', divino_get_tablet_breakpoint() );
			...
			if ( 'no-sidebar' !== divino_page_layout() ) {
				...
				$parse_css                  .= divino_parse_css( $static_secondary_layout_css, '', divino_get_tablet_breakpoint() );
			}
			...
			if ( 'no-sidebar' !== divino_page_layout() ) {
				...
				/* Parse CSS from array() -> max-width: (tablet-breakpoint)px CSS */
				$parse_css .= divino_parse_css( $static_layout_lang_direction_css, '', divino_get_tablet_breakpoint() );
			}
			...
			$parse_css .= divino_parse_css( $static_layout_css_min, divino_get_tablet_breakpoint( '', '1' ) );
			...
			if ( is_404() ) {
				...
				$page_404   = array(
					'.ast-404-layout-1 .ast-404-text' => array(
						'font-size' => divino_get_font_css_value( '200' ),
					),
				);
				$parse_css .= divino_parse_css( $page_404 );
				...
				$parse_css .= divino_parse_css(
					array(
						'.ast-404-layout-1 .ast-404-text' => array(
							'font-size' => divino_get_font_css_value( 100 ),
						),
					),
					'',
					'920'
			...
			if ( 'no-sidebar' !== divino_page_layout() ) {
				...
				/* Parse CSS from array() -> min-width: (tablet-breakpoint + 1)px CSS */
				$parse_css .= divino_parse_css( $static_layout_min_lang_direction_css, divino_get_tablet_breakpoint( '', '1' ) );
			}
			...
			if ( self::page_builder_button_style_css() ) {
				...
				$global_button_desktop = array(
					'.menu-toggle, button, .ast-button, .ast-custom-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' . $v4_2_2_core_form_btns_styling_selector . $search_button_selector . $file_block_button_selector . $search_page_btn_selector . $woo_btns_selector => array(
						'border-style'               => 'solid',
						'border-top-width'           => isset( $global_custom_button_border_size['top'] ) && '' !== $global_custom_button_border_size['top'] ? divino_get_css_value( $global_custom_button_border_size['top'], 'px' ) : '0',
						'border-right-width'         => isset( $global_custom_button_border_size['right'] ) && '' !== $global_custom_button_border_size['right'] ? divino_get_css_value( $global_custom_button_border_size['right'], 'px' ) : '0',
						'border-left-width'          => isset( $global_custom_button_border_size['left'] ) && '' !== $global_custom_button_border_size['left'] ? divino_get_css_value( $global_custom_button_border_size['left'], 'px' ) : '0',
						'border-bottom-width'        => isset( $global_custom_button_border_size['bottom'] ) && '' !== $global_custom_button_border_size['bottom'] ? divino_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : '0',
						'color'                      => esc_attr( $btn_text_color ),
						'border-color'               => empty( $btn_border_color ) ? esc_attr( $btn_bg_color ) : esc_attr( $btn_border_color ),
						'background-color'           => esc_attr( $btn_bg_color ),
						'padding-top'                => divino_responsive_spacing( $theme_btn_padding, 'top', 'desktop' ),
						'padding-right'              => divino_responsive_spacing( $theme_btn_padding, 'right', 'desktop' ),
						'padding-bottom'             => divino_responsive_spacing( $theme_btn_padding, 'bottom', 'desktop' ),
						'padding-left'               => divino_responsive_spacing( $theme_btn_padding, 'left', 'desktop' ),
						'font-family'                => divino_get_font_family( $theme_btn_font_family ),
						'font-weight'                => esc_attr( $theme_btn_font_weight ),
						'font-size'                  => divino_get_font_css_value( $theme_btn_font_size['desktop'], $theme_btn_font_size['desktop-unit'] ),
						...
						'border-top-left-radius'     => divino_responsive_spacing( $btn_border_radius_fields, 'top', 'desktop' ),
						'border-top-right-radius'    => divino_responsive_spacing( $btn_border_radius_fields, 'right', 'desktop' ),
						'border-bottom-right-radius' => divino_responsive_spacing( $btn_border_radius_fields, 'bottom', 'desktop' ),
						'border-bottom-left-radius'  => divino_responsive_spacing( $btn_border_radius_fields, 'left', 'desktop' ),
					),
				...
				$global_button_tablet = array(
					'.menu-toggle, button, .ast-button, .ast-custom-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' . $v4_2_2_core_form_btns_styling_selector . $search_button_selector . $file_block_button_selector . $search_page_btn_selector . $woo_btns_selector => array(
						'padding-top'                => divino_responsive_spacing( $theme_btn_padding, 'top', 'tablet' ),
						'padding-right'              => divino_responsive_spacing( $theme_btn_padding, 'right', 'tablet' ),
						'padding-bottom'             => divino_responsive_spacing( $theme_btn_padding, 'bottom', 'tablet' ),
						'padding-left'               => divino_responsive_spacing( $theme_btn_padding, 'left', 'tablet' ),
						'font-size'                  => divino_responsive_font( $theme_btn_font_size, 'tablet' ),
						'border-top-left-radius'     => divino_responsive_spacing( $btn_border_radius_fields, 'top', 'tablet' ),
						'border-top-right-radius'    => divino_responsive_spacing( $btn_border_radius_fields, 'right', 'tablet' ),
						'border-bottom-right-radius' => divino_responsive_spacing( $btn_border_radius_fields, 'bottom', 'tablet' ),
						'border-bottom-left-radius'  => divino_responsive_spacing( $btn_border_radius_fields, 'left', 'tablet' ),
					),
				);
				...
				$global_button_mobile = array(
					'.menu-toggle, button, .ast-button, .ast-custom-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' . $v4_2_2_core_form_btns_styling_selector . $search_button_selector . $file_block_button_selector . $search_page_btn_selector . $woo_btns_selector => array(
						'padding-top'                => divino_responsive_spacing( $theme_btn_padding, 'top', 'mobile' ),
						'padding-right'              => divino_responsive_spacing( $theme_btn_padding, 'right', 'mobile' ),
						'padding-bottom'             => divino_responsive_spacing( $theme_btn_padding, 'bottom', 'mobile' ),
						'padding-left'               => divino_responsive_spacing( $theme_btn_padding, 'left', 'mobile' ),
						'font-size'                  => divino_responsive_font( $theme_btn_font_size, 'mobile' ),
						'border-top-left-radius'     => divino_responsive_spacing( $btn_border_radius_fields, 'top', 'mobile' ),
						'border-top-right-radius'    => divino_responsive_spacing( $btn_border_radius_fields, 'right', 'mobile' ),
						'border-bottom-right-radius' => divino_responsive_spacing( $btn_border_radius_fields, 'bottom', 'mobile' ),
						'border-bottom-left-radius'  => divino_responsive_spacing( $btn_border_radius_fields, 'left', 'mobile' ),
					),
				);
				...
				if ( 'color-typo' === self::elementor_default_color_font_setting() || 'color' === self::elementor_default_color_font_setting() || 'typo' === self::elementor_default_color_font_setting() ) {
					...
					/* Parse CSS from array() */
					$parse_css .= divino_parse_css( $ele_btn_default_desktop );
					...
					/* Parse CSS from array() */
					$parse_css .= divino_parse_css( $ele_btn_default_tablet, '', divino_get_tablet_breakpoint() );
					...
					/* Parse CSS from array() */
					$parse_css .= divino_parse_css( $ele_btn_default_mobile, '', divino_get_mobile_breakpoint() );
				}
				...
				if ( 'color-typo' === self::elementor_default_color_font_setting() || 'color' === self::elementor_default_color_font_setting() ) {
					...
					/* Parse CSS from array() */
					$parse_css .= divino_parse_css( $ele_btn_color_builder_desktop );
				}
				...
				/* Parse CSS from array() */
				$parse_css .= divino_parse_css( $global_button_page_builder_text_color_desktop );
				...
				if ( 'color-typo' === self::elementor_default_color_font_setting() || 'typo' === self::elementor_default_color_font_setting() ) {
					$ele_btn_typo_builder_desktop = array(
						'.elementor-widget-button .elementor-button' => divino_get_font_array_css( divino_get_option( 'font-family-button' ), divino_get_option( 'font-weight-button' ), $theme_btn_font_size, 'font-extras-button' ),
						'body .elementor-button.elementor-size-sm, body .elementor-button.elementor-size-xs, body .elementor-button.elementor-size-md, body .elementor-button.elementor-size-lg, body .elementor-button.elementor-size-xl, body .elementor-button' => array(
							'font-size' => divino_responsive_font( $theme_btn_font_size, 'desktop' ),
						),
					);

					/* Parse CSS from array() */
					$parse_css .= divino_parse_css( $ele_btn_typo_builder_desktop );
				}
				...
				if ( $block_editor_legacy_setup && self::gutenberg_core_patterns_compat() && ! divino_button_default_padding_updated() ) {
					$theme_outline_gb_btn_top_border    = isset( $global_custom_button_border_size['top'] ) && ( '' !== $global_custom_button_border_size['top'] && '0' !== $global_custom_button_border_size['top'] ) ? divino_get_css_value( $global_custom_button_border_size['top'], 'px' ) : '2px';
					$theme_outline_gb_btn_right_border  = isset( $global_custom_button_border_size['right'] ) && ( '' !== $global_custom_button_border_size['right'] && '0' !== $global_custom_button_border_size['right'] ) ? divino_get_css_value( $global_custom_button_border_size['right'], 'px' ) : '2px';
					$theme_outline_gb_btn_bottom_border = isset( $global_custom_button_border_size['bottom'] ) && ( '' !== $global_custom_button_border_size['bottom'] && '0' !== $global_custom_button_border_size['bottom'] ) ? divino_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : '2px';
					$theme_outline_gb_btn_left_border   = isset( $global_custom_button_border_size['left'] ) && ( '' !== $global_custom_button_border_size['left'] && '0' !== $global_custom_button_border_size['left'] ) ? divino_get_css_value( $global_custom_button_border_size['left'], 'px' ) : '2px';
					...
					if ( divino_button_default_padding_updated() || ! $block_editor_legacy_setup ) {
						$default_border_size = '';
					}
					...
					$btn_top_border_size    = isset( $global_custom_button_border_size['top'] ) && '' !== $global_custom_button_border_size['top'] ? divino_get_css_value( $global_custom_button_border_size['top'], 'px' ) : $default_border_size;
					$btn_bottom_border_size = isset( $global_custom_button_border_size['bottom'] ) && '' !== $global_custom_button_border_size['bottom'] ? divino_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : $default_border_size;
					$btn_right_border_size  = isset( $global_custom_button_border_size['right'] ) && '' !== $global_custom_button_border_size['right'] ? divino_get_css_value( $global_custom_button_border_size['right'], 'px' ) : $default_border_size;
					$btn_left_border_size   = isset( $global_custom_button_border_size['left'] ) && '' !== $global_custom_button_border_size['left'] ? divino_get_css_value( $global_custom_button_border_size['left'], 'px' ) : $default_border_size;
				...
				/* Parse CSS from array() */
				$parse_css .= divino_parse_css( $global_button_page_builder_desktop );

				/* Parse CSS from array() */
				$parse_css .= divino_parse_css( $global_button_page_builder_tablet, '', divino_get_tablet_breakpoint() );
				/* Parse CSS from array() */
				$parse_css .= divino_parse_css( $global_button_page_builder_mobile, '', divino_get_mobile_breakpoint() );
			...
			if ( true === $update_customizer_strctural_defaults ) {
				$global_button_desktop['form[CLASS*="wp-block-search__"].wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button.has-icon'] = array(
					'padding-top'    => 'calc(' . divino_responsive_spacing( $theme_btn_padding, 'top', 'desktop' ) . ' - 3px)',
					'padding-right'  => 'calc(' . divino_responsive_spacing( $theme_btn_padding, 'right', 'desktop' ) . ' - 3px)',
					'padding-bottom' => 'calc(' . divino_responsive_spacing( $theme_btn_padding, 'bottom', 'desktop' ) . ' - 3px)',
					'padding-left'   => 'calc(' . divino_responsive_spacing( $theme_btn_padding, 'left', 'desktop' ) . ' - 3px)',
				);
			}

			/* Parse CSS from array() */
			$parse_css .= divino_parse_css( $global_button_desktop );

			$parse_css .= divino_parse_css( $global_button_tablet, '', divino_get_tablet_breakpoint() );

			$parse_css .= divino_parse_css( $global_button_mobile, '', divino_get_mobile_breakpoint() );
			...
			if ( empty( $site_content_width ) ) {
				...
				$parse_css               .= divino_parse_css( $container_min_tablet_css, divino_get_tablet_breakpoint() );
			}
			...
			$global_button_tablet = array(
				'.menu-toggle, button, .ast-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' => array(
					'font-size' => divino_get_font_css_value( $theme_btn_font_size['tablet'], $theme_btn_font_size['tablet-unit'] ),
				),
			...
			/* Parse CSS from array() -> min-width: (mobile-breakpoint) px CSS  */
			$parse_css .= divino_parse_css( $container_min_mobile_css, divino_get_mobile_breakpoint() );
			...
			$global_button_mobile = array(
				...
				'.menu-toggle, button, .ast-button, .button, input#submit, input[type="button"], input[type="submit"], input[type="reset"]' => array(
					'font-size' => divino_get_font_css_value( $theme_btn_font_size['mobile'], $theme_btn_font_size['mobile-unit'] ),
				),
			);
			...
			if ( false === divino_Builder_Helper::$is_header_footer_builder_active && false === self::remove_logo_max_width_mobile_static_css() ) {
			...
			if ( divino_Builder_Helper::is_component_loaded( 'search', 'header', 'mobile' ) ) {
				...
				$parse_css .= divino_parse_css( $global_button_tablet_lang_direction_css, '', divino_get_tablet_breakpoint() );
			}

			if ( false === divino_Builder_Helper::$is_header_footer_builder_active && 'custom-button' === $header_custom_button_style ) {
				$css_output = array(
					...
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button, .ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-family'    => divino_get_font_family( $header_custom_btn_font_family ),
						'font-weight'    => esc_attr( $header_custom_btn_font_weight ),
						'font-size'      => divino_responsive_font( $header_custom_btn_font_size, 'desktop' ),
						'line-height'    => esc_attr( $header_custom_btn_line_height ),
						'text-transform' => esc_attr( $header_custom_btn_text_transform ),
						'letter-spacing' => divino_get_css_value( $header_custom_btn_letter_spacing, 'px' ),
					),
					...
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						...
						'padding-top'                => divino_responsive_spacing( $header_custom_button_spacing, 'top', 'desktop' ),
						'padding-bottom'             => divino_responsive_spacing( $header_custom_button_spacing, 'bottom', 'desktop' ),
						'padding-left'               => divino_responsive_spacing( $header_custom_button_spacing, 'left', 'desktop' ),
						'padding-right'              => divino_responsive_spacing( $header_custom_button_spacing, 'right', 'desktop' ),
						'border-top-left-radius'     => divino_responsive_spacing( $btn_border_radius_fields, 'top', 'desktop' ),
						'border-top-right-radius'    => divino_responsive_spacing( $btn_border_radius_fields, 'right', 'desktop' ),
						'border-bottom-right-radius' => divino_responsive_spacing( $btn_border_radius_fields, 'bottom', 'desktop' ),
						'border-bottom-left-radius'  => divino_responsive_spacing( $btn_border_radius_fields, 'left', 'desktop' ),
						...
						'border-top-width'           => isset( $header_custom_button_border_size['top'] ) && '' !== $header_custom_button_border_size['top'] ? divino_get_css_value( $header_custom_button_border_size['top'], 'px' ) : '0px',
						'border-right-width'         => isset( $header_custom_button_border_size['right'] ) && '' !== $header_custom_button_border_size['right'] ? divino_get_css_value( $header_custom_button_border_size['right'], 'px' ) : '0px',
						'border-left-width'          => isset( $header_custom_button_border_size['left'] ) && '' !== $header_custom_button_border_size['left'] ? divino_get_css_value( $header_custom_button_border_size['left'], 'px' ) : '0px',
						'border-bottom-width'        => isset( $header_custom_button_border_size['bottom'] ) && '' !== $header_custom_button_border_size['bottom'] ? divino_get_css_value( $header_custom_button_border_size['bottom'], 'px' ) : '0px',
					),
					...
					'.ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						...
						'padding-top'         => divino_responsive_spacing( $header_custom_trans_button_spacing, 'top', 'desktop' ),
						'padding-bottom'      => divino_responsive_spacing( $header_custom_trans_button_spacing, 'bottom', 'desktop' ),
						'padding-left'        => divino_responsive_spacing( $header_custom_trans_button_spacing, 'left', 'desktop' ),
						'padding-right'       => divino_responsive_spacing( $header_custom_trans_button_spacing, 'right', 'desktop' ),
						'border-radius'       => divino_get_css_value( $header_custom_trans_button_radius, 'px' ),
						'border-style'        => 'solid',
						'border-color'        => esc_attr( $header_custom_trans_button_border_color ),
						'border-top-width'    => isset( $header_custom_trans_button_border_size['top'] ) && '' !== $header_custom_trans_button_border_size['top'] ? divino_get_css_value( $header_custom_trans_button_border_size['top'], 'px' ) : '',
						'border-right-width'  => isset( $header_custom_trans_button_border_size['right'] ) && '' !== $header_custom_trans_button_border_size['right'] ? divino_get_css_value( $header_custom_trans_button_border_size['right'], 'px' ) : '',
						'border-left-width'   => isset( $header_custom_trans_button_border_size['left'] ) && '' !== $header_custom_trans_button_border_size['left'] ? divino_get_css_value( $header_custom_trans_button_border_size['left'], 'px' ) : '',
						'border-bottom-width' => isset( $header_custom_trans_button_border_size['bottom'] ) && '' !== $header_custom_trans_button_border_size['bottom'] ? divino_get_css_value( $header_custom_trans_button_border_size['bottom'], 'px' ) : '',
					),
				...
				$custom_button_css = array(
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => divino_responsive_font( $header_custom_btn_font_size, 'tablet' ),
						'padding-top'    => divino_responsive_spacing( $header_custom_button_spacing, 'top', 'tablet' ),
						'padding-bottom' => divino_responsive_spacing( $header_custom_button_spacing, 'bottom', 'tablet' ),
						'padding-left'   => divino_responsive_spacing( $header_custom_button_spacing, 'left', 'tablet' ),
						'padding-right'  => divino_responsive_spacing( $header_custom_button_spacing, 'right', 'tablet' ),
					),
				);
				...
				$custom_trans_button_css = array(
					'.ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => divino_responsive_font( $header_custom_btn_font_size, 'tablet' ),
						'padding-top'    => divino_responsive_spacing( $header_custom_trans_button_spacing, 'top', 'tablet' ),
						'padding-bottom' => divino_responsive_spacing( $header_custom_trans_button_spacing, 'bottom', 'tablet' ),
						'padding-left'   => divino_responsive_spacing( $header_custom_trans_button_spacing, 'left', 'tablet' ),
						'padding-right'  => divino_responsive_spacing( $header_custom_trans_button_spacing, 'right', 'tablet' ),
					),
				);

				/* Parse CSS from array()*/
				$parse_css .= divino_parse_css( array_merge( $custom_button_css, $custom_trans_button_css ), '', divino_get_tablet_breakpoint() );

				/* Custom Menu Item Button */
				$custom_button = array(
					'.main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => divino_responsive_font( $header_custom_btn_font_size, 'mobile' ),
						'padding-top'    => divino_responsive_spacing( $header_custom_button_spacing, 'top', 'mobile' ),
						'padding-bottom' => divino_responsive_spacing( $header_custom_button_spacing, 'bottom', 'mobile' ),
						'padding-left'   => divino_responsive_spacing( $header_custom_button_spacing, 'left', 'mobile' ),
						'padding-right'  => divino_responsive_spacing( $header_custom_button_spacing, 'right', 'mobile' ),
					),
				);
				...
				$custom_trans_button = array(
					'.ast-theme-transparent-header .main-header-bar .button-custom-menu-item .ast-custom-button-link .ast-custom-button' => array(
						'font-size'      => divino_responsive_font( $header_custom_btn_font_size, 'mobile' ),
						'padding-top'    => divino_responsive_spacing( $header_custom_trans_button_spacing, 'top', 'mobile' ),
						'padding-bottom' => divino_responsive_spacing( $header_custom_trans_button_spacing, 'bottom', 'mobile' ),
						'padding-left'   => divino_responsive_spacing( $header_custom_trans_button_spacing, 'left', 'mobile' ),
						'padding-right'  => divino_responsive_spacing( $header_custom_trans_button_spacing, 'right', 'mobile' ),
					),
				);

				/* Parse CSS from array()*/
				$parse_css .= divino_parse_css( array_merge( $custom_button, $custom_trans_button ), '', divino_get_mobile_breakpoint() );
			}
			...
			if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
				...
				if ( ! empty( $footer_adv_link_color ) ) {
					$footer_adv_tagcloud = array(
						'.footer-adv .tagcloud a:hover, .footer-adv .tagcloud a.current-item' => array(
							'color' => divino_get_foreground_color( $footer_adv_link_color ),
						),
						'.footer-adv .calendar_wrap #today' => array(
							'color' => divino_get_foreground_color( $footer_adv_link_color ),
						),
					);
					$parse_css          .= divino_parse_css( $footer_adv_tagcloud );
				}
			}

			/* Width for Footer */
			if ( false === divino_Builder_Helper::$is_header_footer_builder_active && 'content' !== $divino_footer_width ) {
				...
				/* Parse CSS from array()*/
				$parse_css .= divino_parse_css( $genral_global_responsive, divino_get_tablet_breakpoint( '', 1 ) );
			}

			/* Preventing link redirection when the cart is clicked */
			if ( 'redirect' !== divino_get_option( 'responsive-cart-click-action' ) ) {
				...
				/* Parse CSS from array()*/
				$parse_css .= divino_parse_css( $desktop_cart_link_event );
			}

			/* Preventing link redirection when the cart is clicked */
			if ( is_customize_preview() && 'redirect' !== divino_get_option( 'woo-header-cart-click-action' ) ) {
				...
				/* Parse CSS from array()*/
				$parse_css .= divino_parse_css( $responsive_cart_link_event );
			}
			...
			if ( 'page-builder' === $container_layout ) {
				$page_builder_comment = array(
					'.ast-page-builder-template .comments-area, .single.ast-page-builder-template .entry-header, .single.ast-page-builder-template .post-navigation, .single.ast-page-builder-template .ast-single-related-posts-container' => array(
						'max-width'    => divino_get_css_value( $site_content_width + 40, 'px' ),
						'margin-left'  => 'auto',
						'margin-right' => 'auto',
					),
				);
				/* Parse CSS from array()*/
				$parse_css .= divino_parse_css( $page_builder_comment, divino_get_mobile_breakpoint( '', 1 ) );

			}

			$divino_spearate_container_selector = 'body, .ast-separate-container';
			if ( divino_has_gcp_typo_preset_compatibility() && true === divino_apply_content_background_fullwidth_layouts() ) {
				$divino_spearate_container_selector = '.ast-separate-container';
			}

			$separate_container_css = array(
				$divino_spearate_container_selector => divino_get_responsive_background_obj( $box_bg_obj, 'desktop' ),
			);
			$parse_css             .= divino_parse_css( $separate_container_css );
			...
			if ( $block_editor_legacy_setup ) {
				...
				if ( true === $improve_gb_ui ) {
					...
					/* Parse CSS from array -> Desktop CSS. */
					$parse_css .= divino_parse_css( $core_blocks_width_desktop_ui_css );
					...
					$parse_css .= divino_parse_css( $core_blocks_min_width_tablet_ui_css, divino_get_tablet_breakpoint() );
					...
					$parse_css .= divino_parse_css( $core_blocks_min_width_1200_ui_css, '1200' );
					...
					$parse_css .= divino_parse_css( $core_blocks_min_width_mobile_ui_css, divino_get_mobile_breakpoint( '', 1 ) );
				} else {
					$divino_no_sidebar_layout_css =
					...
					$parse_css .= divino_Enqueue_Scripts::trim_css( $divino_no_sidebar_layout_css );
				}
			}
			...
			if ( isset( $body_font_size['tablet'] ) && '' != $body_font_size['tablet'] ) {
					...
					$tablet_typo = array(
						// Widget Title.
						'.widget-title' => array(
							'font-size' => divino_get_font_css_value( (int) $body_font_size['tablet'] * 1.428571429, 'px', 'tablet' ),
						),
					);
			}
			...
			$tablet_typography = array(
				'body, button, input, select, textarea, .ast-button, .ast-custom-button' => array(
					'font-size' => divino_responsive_font( $body_font_size, 'tablet' ),
				),
				'#secondary, #secondary button, #secondary input, #secondary select, #secondary textarea' => array(
					'font-size' => divino_responsive_font( $body_font_size, 'tablet' ),
				),
				'.site-title'                    => array(
					'font-size' => divino_responsive_font( $site_title_font_size, 'tablet' ),
					'display'   => esc_attr( $tablet_title_visibility ),
				),
				'.site-header .site-description' => array(
					'font-size' => divino_responsive_font( $site_tagline_font_size, 'tablet' ),
					'display'   => esc_attr( $tablet_tagline_visibility ),
				),
				'.entry-title'                   => array(
					'font-size' => divino_responsive_font( $archive_post_title_font_size, 'tablet' ),
				),
				'.ast-blog-single-element.ast-taxonomy-container a' => array(
					'font-size' => divino_responsive_font( $archive_post_tax_font_size, 'tablet' ),
				),
				'.ast-blog-meta-container'       => array(
					'font-size' => divino_responsive_font( $archive_post_meta_font_size, 'tablet' ),
				),
				'blog-layout-4' === $blog_layout ? '.archive .ast-article-post .ast-article-inner, .blog .ast-article-post .ast-article-inner' : '.archive .ast-article-post, .ast-article-post .post-thumb-img-content, .ast-blog-layout-6-grid .ast-article-inner .post-thumb::after, .blog .ast-article-post' => array(
					'border-top-left-radius'     => divino_responsive_spacing( $archive_cards_radius, 'top', 'tablet' ),
					'border-top-right-radius'    => divino_responsive_spacing( $archive_cards_radius, 'right', 'tablet' ),
					'border-bottom-right-radius' => divino_responsive_spacing( $archive_cards_radius, 'bottom', 'tablet' ),
					'border-bottom-left-radius'  => divino_responsive_spacing( $archive_cards_radius, 'left', 'tablet' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h1_font_size, 'tablet', $heading_font_size_comp ? '' : 30 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h2_font_size, 'tablet', $heading_font_size_comp ? '' : 25 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h3_font_size, 'tablet', $heading_font_size_comp ? '' : 20 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h4_font_size, 'tablet' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h5_font_size, 'tablet' ),
				),
				...
				is_customize_preview() ? '.ast-sg-logo-section .custom-logo-link img, header .custom-logo-link img, .ast-header-break-point .site-logo-img .custom-mobile-logo-link img' : 'header .custom-logo-link img, .ast-header-break-point .site-logo-img .custom-mobile-logo-link img' => array(
					'max-width' => divino_get_css_value( $header_logo_width['tablet'], 'px' ),
					'width'     => divino_get_css_value( $header_logo_width['tablet'], 'px' ),
				),
				'body, .ast-separate-container'  => divino_get_responsive_background_obj( $box_bg_obj, 'tablet' ),
			);

			/* Parse CSS from array()*/
			$parse_css .= divino_parse_css( array_merge( $tablet_typo, $tablet_typography ), '', divino_get_tablet_breakpoint() );
			...
			if ( isset( $body_font_size['mobile'] ) && '' !== $body_font_size['mobile'] ) {
				$mobile_typo = array(
					// Widget Title.
					'.widget-title' => array(
						'font-size' => divino_get_font_css_value( (int) $body_font_size['mobile'] * 1.428571429, 'px', 'mobile' ),
					),
				);
			}
			...
			$mobile_typography = array(
				'body, button, input, select, textarea, .ast-button, .ast-custom-button' => array(
					'font-size' => divino_responsive_font( $body_font_size, 'mobile' ),
				),
				'#secondary, #secondary button, #secondary input, #secondary select, #secondary textarea' => array(
					'font-size' => divino_responsive_font( $body_font_size, 'mobile' ),
				),
				'.site-title'                    => array(
					'font-size' => divino_responsive_font( $site_title_font_size, 'mobile' ),
					'display'   => esc_attr( $mobile_title_visibility ),
				),
				'.site-header .site-description' => array(
					'font-size' => divino_responsive_font( $site_tagline_font_size, 'mobile' ),
					'display'   => esc_attr( $mobile_tagline_visibility ),
				),
				'.entry-title'                   => array(
					'font-size' => divino_responsive_font( $archive_post_title_font_size, 'mobile' ),
				),
				'.ast-blog-single-element.ast-taxonomy-container a' => array(
					'font-size' => divino_responsive_font( $archive_post_tax_font_size, 'mobile' ),
				),
				'.ast-blog-meta-container'       => array(
					'font-size' => divino_responsive_font( $archive_post_meta_font_size, 'mobile' ),
				),
				'blog-layout-4' === $blog_layout ? '.archive .ast-article-post .ast-article-inner, .blog .ast-article-post .ast-article-inner' : '.archive .ast-article-post, .ast-article-post .post-thumb-img-content, .ast-blog-layout-6-grid .ast-article-inner .post-thumb::after, .blog .ast-article-post' => array(
					'border-top-left-radius'     => divino_responsive_spacing( $archive_cards_radius, 'top', 'mobile' ),
					'border-top-right-radius'    => divino_responsive_spacing( $archive_cards_radius, 'right', 'mobile' ),
					'border-bottom-right-radius' => divino_responsive_spacing( $archive_cards_radius, 'bottom', 'mobile' ),
					'border-bottom-left-radius'  => divino_responsive_spacing( $archive_cards_radius, 'left', 'mobile' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h1_font_size, 'mobile', $heading_font_size_comp ? '' : 30 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h2_font_size, 'mobile', $heading_font_size_comp ? '' : 25 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h3_font_size, 'mobile', $heading_font_size_comp ? '' : 20 ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h4_font_size, 'mobile' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h5_font_size, 'mobile' ),
				),
				...
				self::conditional_headings_css_selectors(
					...
					'font-size' => divino_responsive_font( $heading_h6_font_size, 'mobile' ),
				),
				...
				'body, .ast-separate-container'  => divino_get_responsive_background_obj( $box_bg_obj, 'mobile' ),
			);

			/* Parse CSS from array()*/
			$parse_css .= divino_parse_css( array_merge( $mobile_typo, $mobile_typography ), '', divino_get_mobile_breakpoint() );
			...
			if ( '' == $body_font_size['tablet'] ) {
				$html_tablet_typography = array(
					'html' => array(
						'font-size' => divino_get_font_css_value( (int) $body_font_size_desktop * 5.7, '%' ),
					),
				);
				$parse_css             .= divino_parse_css( $html_tablet_typography, '', divino_get_tablet_breakpoint() );
			}
			...
			/* Parse CSS from array()*/
			$parse_css .= divino_parse_css( $html_mobile_typography, '', divino_get_mobile_breakpoint() );
			...
			/* Parse CSS from array()*/
			$parse_css .= divino_parse_css( $site_width, divino_get_tablet_breakpoint( '', 1 ) );

			/* Narrow width container layout dynamic css */
			$parse_css .= divino_narrow_container_width( divino_get_content_layout(), $narrow_container_max_width );
			...
			if ( divino_Builder_Helper::apply_flex_based_css() ) {
				...
				$parse_css             .= divino_parse_css( $max_site_container_css, divino_get_tablet_breakpoint( '', 1 ) );
				...
				$parse_css             .= divino_parse_css( $min_site_container_css, '', divino_get_tablet_breakpoint() );
			}
			...
			if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
				 ...
				 */
				$divino_navigation  = '@media (max-width:' . $header_break_point . 'px) {';
				$divino_navigation .= '.main-header-bar .main-header-bar-navigation{';
				$divino_navigation .= 'display:none;';
				$divino_navigation .= '}';
				$divino_navigation .= '}';
				$parse_css        .= $divino_navigation;
			}
			...
			if ( 'custom' === $blog_width ) {
				...
				$blog_css   = array(
					'.blog .site-content > .ast-container, .archive .site-content > .ast-container, .search .site-content > .ast-container' => array(
						'max-width' => divino_get_css_value( $blog_max_width, 'px' ),
					),
				);
				$parse_css .= divino_parse_css( $blog_css, divino_get_tablet_breakpoint( '', 1 ) );
			}
			...
			if ( 'custom' === $single_post_max ) {
				...
				$single_blog_css = array(
					'.single-post .site-content > .ast-container' => array(
						'max-width' => divino_get_css_value( $single_post_max_width, 'px' ),
					),
				);
				$parse_css      .= divino_parse_css( $single_blog_css, divino_get_tablet_breakpoint( '', 1 ) );
			}
			...
			if ( 'custom' === $single_page_max ) {
				...
				$single_page_css = array(
					' .page .site-content > .ast-container' => array(
						'max-width' => divino_get_css_value( $single_page_max_width, 'px' ),
					),
				);
				$parse_css      .= divino_parse_css( $single_page_css, divino_get_tablet_breakpoint( '', 1 ) );
			}

			if ( self::divino_headings_clear_compatibility() && is_singular() ) {
				/**
			...
			$blog_addon_condition = defined( 'divino_EXT_VER' ) && divino_Ext_Extension::is_active( 'blog-pro' );
			/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			...
			if ( is_search() || is_archive() || is_home() ) {
				...
				if ( 'blog-layout-4' === $blog_layout || 'blog-layout-6' === $blog_layout ) {
					...
					/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
					if ( ! ( defined( 'divino_EXT_VER' ) && divino_Ext_Extension::is_active( 'blog-pro' ) ) || ( $blog_addon_condition && 1 !== $blog_grid ) ) {
						/** @psalm-suppress UndefinedClass */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
				...
				$parse_css .= divino_parse_css( $blog_layout_css );
				...
				if ( 'blog-layout-4' === $blog_layout ) {
					...
					$parse_css .= divino_parse_css( $blog_layout_grid_css );
				}
				...
				if ( 'blog-layout-5' === $blog_layout ) {
					...
					$parse_css .= divino_parse_css( $blog_layout_list_css );
					...
					$parse_css .= divino_parse_css( $blog_layout_list_css_responsive, '', divino_get_tablet_breakpoint() );
				}
				...
				if ( 'blog-layout-6' === $blog_layout ) {
					...
					if ( ( defined( 'divino_EXT_VER' ) && divino_Ext_Extension::is_active( 'blog-pro' ) ) && ( 1 === divino_get_option( 'blog-grid' ) ) ) {
					...
					$parse_css .= divino_parse_css( $blog_layout_cover_css );
				}
				...
				$parse_css .= divino_parse_css( $blog_layout_css_responsive, '', divino_get_tablet_breakpoint() );

				$parse_css .= divino_Enqueue_Scripts::trim_css( self::blog_layout_static_css() );
				...
				if ( $aspect_ratio && $with_aspect_img_width ) {
						...
						$parse_css          .= divino_parse_css( $blog_featured_image );
				}
				...
				if ( 'custom' === $aspect_ratio_type ) {
					...
					$parse_css        .= divino_parse_css( $cover_style_image );
				}
				...
				if ( $author_avatar ) {
					...
					$parse_css      .= divino_parse_css( $blog_author_css );
				}

				$blog_archive_hover_effect = divino_get_option( 'blog-hover-effect' );
				...
				if ( 'none' !== $blog_archive_hover_effect ) {
					...
					$parse_css .= divino_parse_css( $blog_archive_hover_effect_css );
				}

				// Post elements.
				$categories_styles      = divino_get_option( 'blog-category-style' );
				$tag_styles             = divino_get_option( 'blog-tag-style' );
				$categories_meta_styles = divino_get_option( 'blog-meta-category-style' );
				$tag_meta_styles        = divino_get_option( 'blog-meta-tag-style' );
				...
				if ( $categories_styles || $tag_styles || $categories_meta_styles || $tag_meta_styles ) {
					...
					';
					$parse_css      .= divino_Enqueue_Scripts::trim_css( $post_tax_style );
				}
			}
			...
			$submenu_border_style = array(
				...
				'.ast-desktop .main-header-menu.submenu-with-border .sub-menu' => array(
					'border-top-width'    => ! empty( $submenu_border['top'] ) ? divino_get_css_value( $submenu_border['top'], 'px' ) : '',
					'border-right-width'  => ! empty( $submenu_border['right'] ) ? divino_get_css_value( $submenu_border['right'], 'px' ) : '',
					'border-left-width'   => ! empty( $submenu_border['left'] ) ? divino_get_css_value( $submenu_border['left'], 'px' ) : '',
					'border-bottom-width' => ! empty( $submenu_border['bottom'] ) ? divino_get_css_value( $submenu_border['bottom'], 'px' ) : '',
					'border-style'        => 'solid',
				),
				'.ast-desktop .main-header-menu.submenu-with-border .sub-menu .sub-menu' => array(
					'top' => isset( $submenu_border['top'] ) && '' != $submenu_border['top'] ? divino_get_css_value( '-' . $submenu_border['top'], 'px' ) : '',
				),
			...
			$submenu_border_for_left_align_menu = array(
				'.main-header-menu .sub-menu .menu-item.ast-left-align-sub-menu:hover > .sub-menu, .main-header-menu .sub-menu .menu-item.ast-left-align-sub-menu.focus > .sub-menu' => array(
					'margin-left' => ( isset( $submenu_border['left'] ) && '' != $submenu_border['left'] ) || isset( $submenu_border['right'] ) && '' != $submenu_border['right'] ? divino_get_css_value( '-' . ( (int) $submenu_border['left'] + (int) $submenu_border['right'] ), 'px' ) : '',
				),
			);

			if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
				$parse_css .= divino_parse_css( $submenu_border_style );
			}

			// Submenu items goes outside?
			$parse_css .= divino_parse_css( $submenu_border_for_left_align_menu, divino_get_tablet_breakpoint( '', 1 ) );

			/* Small Footer CSS */
			if ( false === divino_Builder_Helper::$is_header_footer_builder_active && 'disabled' !== $small_footer_layout ) {
				$sml_footer_css = array(
					'.ast-small-footer' => array(
						'border-top-style' => 'solid',
						'border-top-width' => divino_get_css_value( $small_footer_divider, 'px' ),
						'border-top-color' => esc_attr( $small_footer_divider_color ),
					),
				);
				$parse_css     .= divino_parse_css( $sml_footer_css );
			...
			if ( true === divino_Builder_Helper::$is_header_footer_builder_active && divino_Ext_Transparent_Header_Markup::is_transparent_header() ) {

				$html_text_color   = divino_get_option( 'transparent-header-html-text-color' );
				$html_link_color   = divino_get_option( 'transparent-header-html-link-color' );
				$html_link_h_color = divino_get_option( 'transparent-header-html-link-h-color' );

				$search_icon_color = divino_get_option( 'transparent-header-search-icon-color' );
				$search_text_color = divino_get_option( 'transparent-header-search-box-placeholder-color' );

				$search_box_bg_color = divino_get_option( 'transparent-header-search-box-background-color' );

				$social_color          = divino_get_option( 'transparent-header-social-icons-color' );
				$social_hover_color    = divino_get_option( 'transparent-header-social-icons-h-color' );
				$social_bg_color       = divino_get_option( 'transparent-header-social-icons-bg-color' );
				$social_bg_hover_color = divino_get_option( 'transparent-header-social-icons-bg-h-color' );

				$button_color          = divino_get_option( 'transparent-header-button-text-color' );
				$button_h_color        = divino_get_option( 'transparent-header-button-text-h-color' );
				$button_bg_color       = divino_get_option( 'transparent-header-button-bg-color' );
				$button_bg_h_color     = divino_get_option( 'transparent-header-button-bg-h-color' );
				$button_border_color   = divino_get_option( 'transparent-header-button-border-color' );
				$button_h_border_color = divino_get_option( 'transparent-header-button-border-h-color' );

				$divider_color                = divino_get_option( 'transparent-header-divider-color' );
				$account_icon_color           = divino_get_option( 'transparent-account-icon-color' );
				$account_loggedout_text_color = divino_get_option( 'transparent-account-type-text-color' );

				// Menu colors.
				$account_menu_color           = divino_get_option( 'transparent-account-menu-color' );
				$account_menu_bg_color        = divino_get_option( 'transparent-account-menu-bg-obj' );
				$account_menu_color_hover     = divino_get_option( 'transparent-account-menu-h-color' );
				$account_menu_bg_color_hover  = divino_get_option( 'transparent-account-menu-h-bg-color' );
				$account_menu_color_active    = divino_get_option( 'transparent-account-menu-a-color' );
				$account_menu_bg_color_active = divino_get_option( 'transparent-account-menu-a-bg-color' );
				...
				$transparent_header_builder_desktop_css = array(
					...
					$widget_title_color      = divino_get_option( 'transparent-header-widget-title-color' );
					$widget_content_color    = divino_get_option( 'transparent-header-widget-content-color' );
					$widget_link_color       = divino_get_option( 'transparent-header-widget-link-color' );
					$widget_link_hover_color = divino_get_option( 'transparent-header-widget-link-h-color' );
					...
					if ( divino_Builder_Helper::is_component_loaded( 'mobile-trigger', 'header', 'mobile' ) ) {

						$transparent_toggle_selector = '.ast-theme-transparent-header [data-section="section-header-mobile-trigger"]';

						$trigger_bg           = divino_get_option( 'transparent-header-toggle-btn-bg-color' );
						$trigger_border_color = divino_get_option( 'transparent-header-toggle-border-color', $trigger_bg );
						$style                = divino_get_option( 'mobile-header-toggle-btn-style' );

						$icon_color = divino_get_option( 'transparent-header-toggle-btn-color' );
					...
					$parse_css .= divino_parse_css( $transparent_header_builder_desktop_css );
					...
					$parse_css .= divino_parse_css( $transparent_header_builder_tablet_css, '', divino_get_tablet_breakpoint() );
					...
					$parse_css .= divino_parse_css( $transparent_header_builder_mobile_css, '', divino_get_mobile_breakpoint() );
			}

			if ( self::divino_list_block_vertical_spacing() ) {
				$list_spacing_css = array(
					'.entry-content li > p' => array(
						'margin-bottom' => 0,
					),
				);
				$parse_css       .= divino_parse_css( $list_spacing_css );
			}

			if ( self::divino_fullwidth_sidebar_support() ) {
			...
			if ( divino_get_option( 'enable-comments-area', true ) ) {
				$parse_css .= divino_Extended_Base_Dynamic_CSS::prepare_inner_section_advanced_css( 'ast-sub-section-comments', '.site .comments-area' );

				$comments_radius = divino_get_option(
				...
				$list_spacing_css = array(
					'.comments-area .comments-title, .comments-area .comment-respond' => array(
						'border-top-left-radius'     => ! empty( divino_get_css_value( $comments_radius['top'] ) ) ? divino_get_css_value( $comments_radius['top'], 'px' ) : '',
						'border-bottom-right-radius' => ! empty( divino_get_css_value( $comments_radius['bottom'] ) ) ? divino_get_css_value( $comments_radius['bottom'], 'px' ) : '',
						'border-bottom-left-radius'  => ! empty( divino_get_css_value( $comments_radius['left'] ) ) ? divino_get_css_value( $comments_radius['left'], 'px' ) : '',
						'border-top-right-radius'    => ! empty( divino_get_css_value( $comments_radius['right'] ) ) ? divino_get_css_value( $comments_radius['right'], 'px' ) : '',
					),
				);
				$parse_css       .= divino_parse_css( $list_spacing_css );
			}
			...
			$custom_css = divino_get_option( 'custom-css' );
			...
			$parse_css = divino_Enqueue_Scripts::trim_css( $parse_css );

			return apply_filters( 'divino_theme_dynamic_css', $parse_css );
		}
		...
		public static function elementor_heading_margin_style_comp() {
			...
			return apply_filters( 'elementor_heading_margin', isset( $divino_settings['elementor-headings-style'] ) ? false : true );
		}
		 ...
		 * @return bool
		 */
		public static function divino_heading_inside_widget_font_size_comp() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_heading_inside_widget_font_size', isset( $divino_settings['heading-widget-font-size'] ) ? false : true );
		}
		...
		public static function elementor_container_padding_style_comp() {
			$divino_settings = divino_get_options();
			return apply_filters( 'elementor_container_padding', isset( $divino_settings['elementor-container-padding-style'] ) ? false : true );
		}
		...
		public static function elementor_btn_styling_comp() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_elementor_button_body_selector_compatibility', isset( $divino_settings['elementor-btn-styling'] ) && $divino_settings['elementor-btn-styling'] ? true : false );
		}
		...
		public static function return_meta_output( $dynamic_css, $dynamic_css_filtered = '' ) {
			 ...
			 *   - Sidebar Positions CSS
			 */
			$secondary_width = absint( divino_get_option( 'site-sidebar-width' ) );
			$primary_width   = absint( 100 - $secondary_width );
			$meta_style      = '';

			// Header Separator.
			$header_separator       = divino_get_option( 'header-main-sep' );
			$header_separator_color = divino_get_option( 'header-main-sep-color' );

			$meta_style = array(
				'.ast-header-break-point .main-header-bar' => array(
					'border-bottom-width' => divino_get_css_value( $header_separator, 'px' ),
					'border-bottom-color' => esc_attr( $header_separator_color ),
				),
			);

			$parse_css = divino_parse_css( $meta_style );
			...
			$parse_css .= divino_parse_css( $meta_style, divino_get_tablet_breakpoint( '', 1 ) );

			if ( 'no-sidebar' !== divino_page_layout() ) {

				$meta_style = array(
					'#primary'   => array(
						'width' => divino_get_css_value( $primary_width, '%' ),
					),
					'#secondary' => array(
						'width' => divino_get_css_value( strval( $secondary_width ), '%' ),
					),
				);
			...
			if ( false === self::divino_submenu_below_header_fix() ) {
				...
				$parse_css .= divino_parse_css( $submenu_below_header );
			...
			if ( false === self::divino_submenu_open_below_header_fix() ) {
				// If submenu below header fix is not to be loaded then add removed flex properties from class `ast-flex`.
				// Also restore the padding to class `main-header-bar`.
				$submenu_below_header = array(
					// CSS to open submenu just below menu.
			...
			$parse_css .= divino_parse_css( $submenu_toggle );

			$dynamic_css .= $parse_css;

			$ltr_right    = is_rtl() ? esc_attr( 'left' ) : esc_attr( 'right' );
			$dynamic_css .= divino_parse_css(
				array(
		...
		public static function anchors_in_css_selectors_heading() {
			...
			if ( true === divino_get_option( 'include-headings-in-typography' ) &&
				true === apply_filters(
					'divino_include_achors_in_headings_typography',
					true
				) ) {
		 ...
		 */
		public static function divino_submenu_below_header_fix() {

			if ( false === divino_get_option( 'submenu-below-header', true ) &&
				false === apply_filters(
					'divino_submenu_below_header_fix',
					false
				) ) {
		 ...
		 */
		public static function divino_submenu_open_below_header_fix() {

			if ( false === divino_get_option( 'submenu-open-below-header', true ) &&
				false === apply_filters(
					'divino_submenu_open_below_header_fix',
					false
				) ) {
		...
		public static function page_builder_button_style_css() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_page_builder_button_style_css', isset( $divino_settings['pb-button-color-compatibility'] ) && false === $divino_settings['pb-button-color-compatibility'] ? false : true );
		}
		...
		public static function is_block_editor_support_enabled() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_has_block_editor_support', isset( $divino_settings['support-block-editor'] ) && false === $divino_settings['support-block-editor'] ? false : true );
		}
		...
		public static function is_elementor_default_color_font_comp() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_elementor_default_color_font_comp', isset( $divino_settings['ele-default-color-typo-setting-comp'] ) && false === $divino_settings['ele-default-color-typo-setting-comp'] ? false : true );
		}
		 ...
		 */
		public static function divino_list_block_vertical_spacing() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_list_block_vertical_spacing', isset( $divino_settings['list-block-vertical-spacing'] ) ? false : true );
		}
		...
		public static function gtn_image_group_css_comp() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_gutenberg_image_group_style_support', isset( $divino_settings['gtn-full-wide-image-grp-css'] ) ? false : true );
		}
		...
		public static function gtn_group_cover_css_comp() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_gtn_group_cover_css_comp', isset( $divino_settings['gtn-full-wide-grp-cover-css'] ) ? false : true );
		}
		...
		public static function gutenberg_core_blocks_css_comp() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_gutenberg_core_blocks_design_compatibility', isset( $divino_settings['guntenberg-core-blocks-comp-css'] ) ? false : true );
		}
		...
		public static function gutenberg_media_text_block_css_compat() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_gutenberg_media_text_block_spacing_compatibility', isset( $divino_settings['guntenberg-media-text-block-padding-css'] ) ? false : true );
		}
		...
		public static function gutenberg_core_patterns_compat() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_gutenberg_patterns_compatibility', isset( $divino_settings['guntenberg-button-pattern-compat-css'] ) ? false : true );
		}
		...
		public static function support_font_css_to_widget_and_in_editor() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_heading_fonts_typo_support', isset( $divino_settings['can-support-widget-and-editor-fonts'] ) ? false : true );
		}
		...
		public static function remove_logo_max_width_mobile_static_css() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_remove_logo_max_width_css', isset( $divino_settings['can-remove-logo-max-width-css'] ) ? false : true );
		}
		...
		public static function unset_builder_elements_underline() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_unset_builder_elements_underline', isset( $divino_settings['unset-builder-elements-underline'] ) ? false : true );
		}
		...
		public static function v4_block_editor_compat() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_v4_block_editor_compat', isset( $divino_settings['v4-block-editor-compat'] ) ? false : true );
		}
		...
		public static function spectra_gutenberg_compat_css() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_spectra_gutenberg_compat_css', isset( $divino_settings['spectra-gutenberg-compat-css'] ) ? false : true );
		}
		...
		public static function load_cart_static_css() {
			...
			$btn_bg_color       = divino_get_option( 'button-bg-color', $theme_color );
			$btn_border_h_color = divino_get_option( 'theme-button-border-group-border-h-color' );
			$link_h_color       = divino_get_option( 'link-h-color' );
			$btn_bg_h_color     = divino_get_option( 'button-bg-h-color', '', $link_h_color );
		 ...
		 * @since 4.0.0
		 */
		public static function divino_check_default_color_typo() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_update_default_color_typo', isset( $divino_settings['update-default-color-typo'] ) ? false : true );
		}
		 ...
		 * @since 4.1.0
		 */
		public static function divino_woo_support_global_settings() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_woo_support_global_settings', isset( $divino_settings['woo_support_global_settings'] ) ? false : true );
		}
		 ...
		 * @since 4.4.0
		 */
		public static function divino_sticky_sidebar_css() {
			$css = '';
		 ...
		 * @since 4.6.0
		 */
		public static function divino_default_forms_styling_dynamic_css() {
			$css                       = '';
			$enable_site_accessibility = divino_get_option( 'site-accessibility-toggle', false );
			$is_dark_palette           = divino_Global_Palette::is_dark_palette();
			...
			return $css . divino_parse_css( $forms_default_styling_css );
		}
		 ...
		 * @since 4.2.0
		 */
		public static function divino_fullwidth_sidebar_support() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_fullwidth_sidebar_support', isset( $divino_settings['fullwidth_sidebar_support'] ) ? false : true );
		}
		 ...
		 * @since 4.2.2
		 */
		public static function divino_core_form_btns_styling() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_core_form_btns_styling', isset( $divino_settings['v4-2-2-core-form-btns-styling'] ) ? false : true );
		}
		 ...
		 * @return bool false if it is an existing user, true if not.
		 */
		public static function divino_4_4_0_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_addon_upgrade_fullscreen_search_submit_style', isset( $divino_settings['v4-4-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @return bool false if it is an existing user, true if not.
		 */
		public static function divino_4_5_0_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_upgrade_color_styles', isset( $divino_settings['v4-5-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @return bool false if it is an existing user, true if not.
		 */
		public static function divino_4_9_0_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_dark_palette_backward', isset( $divino_settings['v4-9-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @since 4.6.0
		 */
		public static function divino_4_6_0_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_v4-6-0-backward-option', isset( $divino_settings['v4-6-0-backward-option'] ) ? false : true );
		}
		 ...
		 * @since 4.6.2
		 */
		public static function divino_4_6_2_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_v4-6-2-backward-option', isset( $divino_settings['v4-6-2-backward-option'] ) ? false : true );
		}
		 ...
		 * @since 4.6.4
		 */
		public static function divino_4_6_4_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_btn-stylings-upgrade', isset( $divino_settings['btn-stylings-upgrade'] ) ? false : true );
		}
		 ...
		 * @since 4.6.12
		 */
		public static function divino_headings_clear_compatibility() {
			$divino_settings = divino_get_options();
			/**
			 ...
			 */
			return apply_filters( 'divino_get_option_single_posts_pages_heading_clear_none', isset( $divino_settings['single_posts_pages_heading_clear_none'] ) ? false : true );
		}
		 ...
		 * @since 4.8.2
		 */
		public static function divino_4_8_2_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_v4-8-2-backward-option', isset( $divino_settings['v4-8-2-backward-option'] ) ? false : true );
		}
		 ...
		 * @return bool true|false.
		 */
		public static function divino_4_6_14_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_enable-4-6-14-compatibility', isset( $divino_settings['enable-4-6-14-compatibility'] ) ? false : true );
		}
		 ...
		 * @since 4.8.0
		 */
		public static function divino_4_8_0_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_enable-4-8-0-compatibility', isset( $divino_settings['enable-4-8-0-compatibility'] ) ? false : true );
		}
		 ...
		 * @since 4.8.4
		 */
		public static function divino_4_8_4_compatibility() {
			$divino_settings = divino_get_options();
			return apply_filters( 'divino_get_option_enable-4-8-4-compatibility', isset( $divino_settings['enable-4-8-4-compatibility'] ) ? false : true );
		}
		 ...
		 * @since 4.8.9
		 */
		public static function divino_4_8_9_compatibility() {
			$divino_settings = get_option( divino_THEME_SETTINGS );
			return apply_filters( 'divino_get_option_enable-4-8-9-compatibility', isset( $divino_settings['enable-4-8-9-compatibility'] ) ? false : true );
		}
	}
}
