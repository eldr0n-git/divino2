 ...
 */
if ( ! class_exists( 'divino_Font_Families' ) ) {

	/**
	 * Font info class for System and Google fonts.
	 */
	final class divino_Font_Families {
		/**
		 * System Fonts
		 *
		 * @since 1.0.19
		...
		public static function get_system_fonts() {
			...
			return apply_filters( 'divino_system_fonts', self::$system_fonts );
		}
		...
		public static function get_custom_fonts() {
			...
			return apply_filters( 'divino_custom_fonts', $custom_fonts );
		}
		...
		public static function get_google_fonts() {
			...
			if ( empty( self::$google_fonts ) ) {
				 ...
				 * @return array
				 */
				$google_fonts_file = apply_filters( 'divino_google_fonts_php_file', divino_THEME_DIR . 'inc/google-fonts.php' );
			...
			return apply_filters( 'divino_google_fonts', self::$google_fonts );
		}
