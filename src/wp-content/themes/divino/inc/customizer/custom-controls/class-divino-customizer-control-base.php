...
if ( ! class_exists( 'divino_Customizer_Control_Base' ) ) {
	...
	class divino_Customizer_Control_Base {
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_style( 'astra-custom-control-style' . $file_rtl, $css_uri . 'custom-controls' . $file_prefix . $file_rtl . '.css', null, divino_THEME_VERSION );
			...
			wp_enqueue_script( 'astra-custom-control-plain-script', $js_uri . 'custom-controls-plain.js', $custom_controls_plain_deps, divino_THEME_VERSION, true );
			...
			wp_enqueue_script( 'astra-custom-control-script', divino_THEME_URI . 'inc/customizer/extend-custom-controls/build/index.js', $custom_controls_react_deps, divino_THEME_VERSION, true );
			...
			wp_localize_script( 'astra-custom-control-script', 'astraTypo', $divino_typo_localize );

			$css_uri = divino_THEME_URI . 'inc/customizer/custom-controls/typography/';

			wp_enqueue_style( 'astra-select-woo-style', $css_uri . 'selectWoo.css', null, divino_THEME_VERSION );
		}
