 ...
 */
class divino_Headings_Typo_Configs extends divino_Customizer_Config_Base {
	/**
	...
	public function register_configuration( $configurations, $wp_customize ) {
		...
		$_configs = array(
			...
			array(
				...
				'section'  => $section,
				'priority' => 28,
				'default'  => divino_get_option( 'font-extras-h1' ),
			),
			...
			array(
				...
				'section'   => $section,
				'priority'  => 28,
				'connect'   => divino_THEME_SETTINGS . '[font-weight-h2]',
				'transport' => 'postMessage',
				'divider'   => array( 'ast_class' => 'ast-sub-bottom-divider' ),
			),
			...
			array(
				...
				'section'  => $section,
				'priority' => 28,
				'default'  => divino_get_option( 'font-extras-h2' ),
			),
			...
			array(
				'name'      => 'font-family-h3',
				'parent'    => divino_THEME_SETTINGS . '[ast-heading-h3-typo]',
				'type'      => 'sub-control',
				'control'   => 'ast-font',
				'font_type' => 'ast-font-family',
			...
			array(
				...
				'section'  => $section,
				'priority' => 28,
				'default'  => divino_get_option( 'font-extras-h3' ),
			),
			...
			array(
				'name'      => 'font-family-h4',
				'parent'    => divino_THEME_SETTINGS . '[ast-heading-h4-typo]',
				'type'      => 'sub-control',
				'control'   => 'ast-font',
				'font_type' => 'ast-font-family',
				'title'     => __( 'Font Family', 'astra' ),
				...
				'section'   => $section,
				'priority'  => 28,
				'connect'   => divino_THEME_SETTINGS . '[font-weight-h4]',
				'transport' => 'postMessage',
				'divider'   => array( 'ast_class' => 'ast-sub-bottom-divider' ),
			),
			...
			array(
				...
				'section'  => $section,
				'priority' => 28,
				'default'  => divino_get_option( 'font-extras-h4' ),
			),
			...
			array(
				'name'      => 'font-family-h5',
				'parent'    => divino_THEME_SETTINGS . '[ast-heading-h5-typo]',
				'type'      => 'sub-control',
				'control'   => 'ast-font',
				'font_type' => 'ast-font-family',
			...
			array(
				...
				'section'  => $section,
				'priority' => 28,
				'default'  => divino_get_option( 'font-extras-h5' ),
			),
			...
			array(
				'name'      => 'font-family-h6',
				'parent'    => divino_THEME_SETTINGS . '[ast-heading-h6-typo]',
				'type'      => 'sub-control',
				'control'   => 'ast-font',
				'font_type' => 'ast-font-family',
			...
			array(
				...
				'section'  => $section,
				'priority' => 28,
				'default'  => divino_get_option( 'font-extras-h6' ),
			),
		);
...
new divino_Headings_Typo_Configs();
