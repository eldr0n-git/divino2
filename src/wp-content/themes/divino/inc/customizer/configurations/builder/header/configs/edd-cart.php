...
function divino_edd_cart_header_configuration( $configurations = array() ) {
	...
	$_cart_total_divider = array( 'ast_class' => defined( 'divino_EXT_VER' ) && divino_Ext_Extension::is_active( 'edd' ) ? 'ast-top-section-divider' : 'ast-section-spacing' );
	...
	$_configs = array(
		...
		array(
			'name'      => divino_THEME_SETTINGS . '[edd-header-cart-total-display]',
			...
			'partial'   => array(
				...
				'render_callback'     => array( 'divino_Builder_Header', 'header_edd_cart' ),
			),
		 ...
		 */
		array(
			'name'      => divino_THEME_SETTINGS . '[edd-header-cart-title-display]',
		 ...
		 */
		array(
			'name'       => divino_THEME_SETTINGS . '[edd-header-cart-icon-style]',
			'default'    => divino_get_option( 'edd-header-cart-icon-style' ),
			'type'       => 'control',
			'transport'  => 'postMessage',
			'section'    => $_section,
		 ...
		 */
		array(
			'name'              => divino_THEME_SETTINGS . '[edd-header-cart-icon-color]',
			'default'           => divino_get_option( 'edd-header-cart-icon-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			...
			'context'           => array(
				...
				array(
					'setting'  => divino_THEME_SETTINGS . '[edd-header-cart-icon-style]',
					'operator' => '!=',
					'value'    => 'none',
				),
			),
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[edd-header-cart-icon-radius]',
			'default'     => divino_get_option( 'edd-header-cart-icon-radius' ),
			'type'        => 'control',
			'transport'   => 'postMessage',
			'section'     => $_section,
			'context'     => array(
		 ...
		 */
		array(
			'name'              => divino_THEME_SETTINGS . '[transparent-header-edd-cart-icon-color]',
			'default'           => divino_get_option( 'transparent-header-edd-cart-icon-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			'sanitize_callback' => array( 'divino_Customizer_Sanitizes', 'sanitize_alpha_color' ),
			'transport'         => 'postMessage',
	...
	if ( true === divino_Builder_Helper::$is_header_footer_builder_active ) {
		$_edd_configs = array(
			 ...
			 */
			array(
				'name'     => divino_THEME_SETTINGS . '[section-edd-cart-tray-divider]',
				'type'     => 'control',
				'control'  => 'ast-heading',
				'section'  => $_section,
			...
			array(
				...
				'parent'     => divino_THEME_SETTINGS . '[header-edd-cart-colors]',
				'section'    => $_section,
				'transport'  => 'postMessage',
			...
			array(
				'name'       => divino_THEME_SETTINGS . '[header-edd-checkout-button-text-colors]',
			...
			array(
				'name'       => divino_THEME_SETTINGS . '[header-edd-checkout-button-background-colors]',
			...
			array(
				'type'       => 'sub-control',
				'control'    => 'ast-responsive-color',
				'parent'     => divino_THEME_SETTINGS . '[header-edd-checkout-button-text-colors]',
				'section'    => $_section,
				'transport'  => 'postMessage',
			...
			array(
				'type'       => 'sub-control',
				'parent'     => divino_THEME_SETTINGS . '[header-edd-checkout-button-background-colors]',
				'section'    => $_section,
				'control'    => 'ast-responsive-color',
				'transport'  => 'postMessage',
		...
		$configurations = array_merge( $configurations, divino_Builder_Base_Configuration::prepare_visibility_tab( $_section ) );
...
if ( divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
	add_action( 'init', 'divino_edd_cart_header_configuration', 10, 0 );
}
