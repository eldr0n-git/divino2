...
function divino_header_header_builder_configuration( $configurations = array() ) {
	...
	for ( $index = 1; $index <= divino_Builder_Helper::$num_of_header_button; $index++ ) {
		...
		$item = array(
			'name'    => 1 === divino_Builder_Helper::$num_of_header_button ? 'Button' : 'Button ' . $index,
			'icon'    => 'button',
		...
		divino_Builder_Helper::$header_desktop_items[ 'button-' . $index ] = $item;
		divino_Builder_Helper::$header_mobile_items[ 'button-' . $index ]  = $item;
	}

	for ( $index = 1; $index <= divino_Builder_Helper::$num_of_header_html; $index++ ) {
		...
		$item = array(
			'name'    => 1 === divino_Builder_Helper::$num_of_header_html ? 'HTML' : 'HTML ' . $index,
			'icon'    => 'editor-code',
		...
		divino_Builder_Helper::$header_desktop_items[ 'html-' . $index ] = $item;
		divino_Builder_Helper::$header_mobile_items[ 'html-' . $index ]  = $item;
	}

	for ( $index = 1; $index <= divino_Builder_Helper::$num_of_header_widgets; $index++ ) {
		...
		$item = array(
			'name'    => 1 === divino_Builder_Helper::$num_of_header_widgets ? 'Widget' : 'Widget ' . $index,
			'icon'    => 'screenoptions',
		...
		divino_Builder_Helper::$header_desktop_items[ 'widget-' . $index ] = $item;
		divino_Builder_Helper::$header_mobile_items[ 'widget-' . $index ]  = $item;
	}
	...
	for ( $index = 1; $index <= divino_Builder_Helper::$num_of_header_menu; $index++ ) {
		...
		divino_Builder_Helper::$header_desktop_items[ 'menu-' . $index ] = $item;

		divino_Builder_Helper::$header_mobile_items[ 'menu-' . $index ] = $item;
	}

	for ( $index = 1; $index <= divino_Builder_Helper::$num_of_header_social_icons; $index++ ) {
		...
		$item = array(
			'name'    => 1 === divino_Builder_Helper::$num_of_header_social_icons ? 'Social' : 'Social ' . $index,
			'icon'    => 'share',
		...
		divino_Builder_Helper::$header_desktop_items[ 'social-icons-' . $index ] = $item;
		divino_Builder_Helper::$header_mobile_items[ 'social-icons-' . $index ]  = $item;
	}
	...
	$_configs = array(
		...
		*/
		 ...
		 */
		array(
			'name'      => divino_THEME_SETTINGS . '[cloned-component-track]',
			'section'   => 'section-header-builder-layout',
			'type'      => 'control',
			'control'   => 'ast-hidden',
			'priority'  => 43,
			...
			'partial'   => false,
			'default'   => divino_get_option( 'cloned-component-track' ),
		),
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[builder-header]',
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[header-desktop-items]',
			'section'     => 'section-header-builder',
			'type'        => 'control',
			'control'     => 'ast-builder',
			'title'       => __( 'Header Builder', 'astra' ),
			...
			'transport'   => 'refresh',
			'input_attrs' => array(
				'group'  => divino_THEME_SETTINGS . '[header-desktop-items]',
		...
		array(
			'name'      => divino_THEME_SETTINGS . '[header-preset-style]',
			'default'   => divino_get_option( 'header-preset-style' ),
			'type'      => 'control',
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[header-desktop-draggable-items]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[header-mobile-items]',
			'section'     => 'section-header-builder',
			'type'        => 'control',
			'control'     => 'ast-builder',
			'title'       => __( 'Header Builder', 'astra' ),
			...
			'transport'   => 'refresh',
			'input_attrs' => array(
				'group'  => divino_THEME_SETTINGS . '[header-mobile-items]',
				'rows'   => array( 'popup', 'above', 'primary', 'below' ),
				'zones'  => array(
					'popup'   => array(
						'popup_content' => 'Popup Content',
			...
			'context'     => divino_Builder_Helper::$responsive_devices,
		),
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[header-mobile-draggable-items]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
			'control'     => 'ast-draggable-items',
			'input_attrs' => array(
		 ...
		 */
		array(
			'name'      => divino_THEME_SETTINGS . '[header-mobile-popup-items]',
			'section'   => 'section-header-builder-layout',
			'type'      => 'control',
			'control'   => 'ast-hidden',
			'priority'  => 43,
			...
			'partial'   => array(
				...
				'render_callback'     => array( divino_Builder_Header::get_instance(), 'mobile_popup' ),
			),
			'default'   => false,
		),
		 ...
		 */
		array(
			'name'     => divino_THEME_SETTINGS . '[header-transparent-link-heading]',
			'type'     => 'control',
			'control'  => 'ast-heading',
			'section'  => 'section-header-builder-layout',
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[header-transparant-link]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
		...
		// Option: Header Width.
		array(
			'name'       => divino_THEME_SETTINGS . '[hb-header-main-layout-width]',
			'default'    => divino_get_option( 'hb-header-main-layout-width' ),
			'type'       => 'control',
		...
		array(
			'name'              => divino_THEME_SETTINGS . '[section-header-builder-layout-margin]',
			'default'           => divino_get_option( 'section-header-builder-layout-margin' ),
			'type'              => 'control',
			'transport'         => 'postMessage',
	...
	if ( divino_showcase_upgrade_notices() ) {
		 ...
		 */
		$_configs[] = array(
			'name'     => divino_THEME_SETTINGS . '[header-builder-pro-items]',
			'type'     => 'control',
			'control'  => 'ast-upgrade',
	...
	if ( defined( 'divino_EXT_VER' ) && divino_Ext_Extension::is_active( 'sticky-header' ) ) {
		 ...
		 */
		$_configs[] = array(
			'name'        => divino_THEME_SETTINGS . '[header-sticky-link]',
			'section'     => 'section-header-builder-layout',
			'type'        => 'control',
			'control'     => 'ast-header-type-button',
			'input_attrs' => array(
...
if ( divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
	add_action( 'init', 'divino_header_header_builder_configuration', 10, 0 );
}
