 ...
 */
function divino_menu_footer_configuration() {
	...
	$_configs = array(
		 ...
		 */
		array(
			'name'      => divino_THEME_SETTINGS . '[footer-create-menu-link]',
			'default'   => divino_get_option( 'footer-create-menu-link' ),
			'type'      => 'control',
		...
		array(
			'name'       => divino_THEME_SETTINGS . '[footer-menu-layout]',
			'default'    => divino_get_option( 'footer-menu-layout' ),
			'section'    => $_section,
			'priority'   => 20,
			...
			'partial'    => array(
				...
				'render_callback'     => array( divino_Builder_Footer::get_instance(), 'footer_menu' ),
			),
			'choices'    => array(
		 ...
		 */
		array(
			'name'      => divino_THEME_SETTINGS . '[footer-menu-alignment]',
			'default'   => divino_get_option( 'footer-menu-alignment' ),
			'type'      => 'control',
			'control'   => 'ast-selector',
			'section'   => $_section,
			'priority'  => 21,
		...
		array(
			'name'       => divino_THEME_SETTINGS . '[footer-menu-link-colors]',
			'type'       => 'control',
			'control'    => 'ast-color-group',
			'context'    => divino_Builder_Helper::$design_tab,
			'title'      => __( 'Link / Text', 'divino' ),
			'section'    => $_section,
			'transport'  => 'postMessage',
			'priority'   => 90,
			'responsive' => true,
		...
		array(
			'name'       => divino_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'control',
			'control'    => 'ast-color-group',
			'context'    => divino_Builder_Helper::$design_tab,
		...
		array(
			...
			'default'    => divino_get_option( 'footer-menu-color-responsive' ),
			'parent'     => divino_THEME_SETTINGS . '[footer-menu-link-colors]',
			'type'       => 'sub-control',
		...
		array(
			...
			'default'    => divino_get_option( 'footer-menu-bg-obj-responsive' ),
			'parent'     => divino_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'sub-control',
		...
		array(
			...
			'default'    => divino_get_option( 'footer-menu-h-color-responsive' ),
			'parent'     => divino_THEME_SETTINGS . '[footer-menu-link-colors]',
			'tab'        => __( 'Hover', 'divino' ),
			'type'       => 'sub-control',
			'control'    => 'ast-responsive-color',
		...
		array(
			...
			'default'    => divino_get_option( 'footer-menu-h-bg-color-responsive' ),
			'parent'     => divino_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'sub-control',
			'title'      => __( 'Hover', 'divino' ),
			'section'    => $_section,
		...
		array(
			...
			'default'    => divino_get_option( 'footer-menu-a-color-responsive' ),
			'parent'     => divino_THEME_SETTINGS . '[footer-menu-link-colors]',
			'type'       => 'sub-control',
			'section'    => $_section,
			'control'    => 'ast-responsive-color',
		...
		array(
			...
			'default'    => divino_get_option( 'footer-menu-a-bg-color-responsive' ),
			'parent'     => divino_THEME_SETTINGS . '[footer-menu-background-colors]',
			'type'       => 'sub-control',
			'control'    => 'ast-responsive-color',
			'transport'  => 'postMessage',
		 ...
		 */
		array(
			'name'     => divino_THEME_SETTINGS . '[footer-main-menu-divider]',
			'section'  => $_section,
		...
		// Option - Menu Space.
		array(
			'name'              => divino_THEME_SETTINGS . '[footer-main-menu-spacing]',
			'default'           => divino_get_option( 'footer-main-menu-spacing' ),
			'type'              => 'control',
	...
	if ( defined( 'divino_EXT_VER' ) && divino_Ext_Extension::is_active( 'typography' ) ) {
		...
		$new_configs = array(
			...
			array(
				'name'      => divino_THEME_SETTINGS . '[footer-menu-typography]',
				'default'   => divino_get_option( 'footer-menu-typography' ),
				'type'      => 'control',
			...
			array(
				...
				'default'           => divino_get_option( 'footer-menu-font-size' ),
				'parent'            => divino_THEME_SETTINGS . '[footer-menu-typography]',
				'section'           => $_section,
				'type'              => 'sub-control',
				'priority'          => 23,
		...
		$new_configs = array(
			...
			array(
				'name'              => divino_THEME_SETTINGS . '[footer-menu-font-size]',
				'default'           => divino_get_option( 'footer-menu-font-size' ),
				'section'           => $_section,
				'control'           => 'ast-responsive-slider',
				'context'           => divino_Builder_Helper::$design_tab,
				...
				'type'              => 'control',
				'transport'         => 'postMessage',
				'title'             => __( 'Menu Font Size', 'divino' ),
				'priority'          => 120,
				'suffix'            => array( 'px', 'em', 'vw', 'rem' ),
				'input_attrs'       => array(
					'px'  => array(
...
if ( divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
	add_action( 'init', 'divino_menu_footer_configuration' );
}
