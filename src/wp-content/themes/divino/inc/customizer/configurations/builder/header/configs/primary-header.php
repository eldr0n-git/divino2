...
function divino_primary_header_configuration() {
	...
	$_configs = array(
		...
		array(
			'name'              => divino_THEME_SETTINGS . '[hb-header-height]',
			'section'           => $_section,
		...
		array(
			'name'        => divino_THEME_SETTINGS . '[hb-header-bg-obj-responsive]',
			'section'     => $_section,
			'type'        => 'control',
		...
		array(
			'name'              => divino_THEME_SETTINGS . '[hb-header-main-sep-color]',
			'transport'         => 'postMessage',
			'default'           => divino_get_option( 'hb-header-main-sep-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			...
			'context'           => array(
				...
				array(
					'setting'  => divino_THEME_SETTINGS . '[hb-header-main-sep]',
					'operator' => '>=',
					'value'    => 1,
				),
			),
		...
		array(
			'name'        => divino_THEME_SETTINGS . '[hb-header-main-sep]',
			'transport'   => 'postMessage',
			'default'     => divino_get_option( 'hb-header-main-sep' ),
			'type'        => 'control',
			'control'     => 'ast-slider',
			'section'     => $_section,
			'priority'    => 5,
...
if ( divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
	add_action( 'init', 'divino_primary_header_configuration' );
}
