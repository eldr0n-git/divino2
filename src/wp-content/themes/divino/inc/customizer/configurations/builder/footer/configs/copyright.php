...
function divino_copyright_footer_configuration() {
	...
	$_configs = array(
		...
		*/
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[footer-copyright-editor]',
			'type'        => 'control',
			'control'     => 'ast-html-editor',
			'section'     => $_section,
			'transport'   => 'postMessage',
			'priority'    => 4,
			'default'     => divino_get_option( 'footer-copyright-editor', 'Copyright [copyright] [current_year] [site_title] | Powered by [theme_author]' ),
			'input_attrs' => array(
			...
			'partial'     => array(
				...
				'render_callback'     => array( divino_Builder_Footer::get_instance(), 'footer_copyright' ),
			),
		 ...
		 */
		array(
			'name'      => divino_THEME_SETTINGS . '[footer-copyright-alignment]',
			'default'   => divino_get_option( 'footer-copyright-alignment' ),
			'type'      => 'control',
		 ...
		 */
		array(
			'name'              => divino_THEME_SETTINGS . '[footer-copyright-color]',
			'default'           => divino_get_option( 'footer-copyright-color' ),
			'type'              => 'control',
			'section'           => $_section,
			'priority'          => 8,
			'transport'         => 'postMessage',
	...
	$_configs = array_merge( $_configs, divino_Builder_Base_Configuration::prepare_typography_options( $_section ) );
...
if ( divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
	add_action( 'init', 'divino_copyright_footer_configuration', 10, 0 );
}
