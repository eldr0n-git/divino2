...
function divino_primary_footer_configuration() {
	...
	$_configs = array(
		...
		array(
			'name'       => divino_THEME_SETTINGS . '[hb-footer-column]',
			'default'    => divino_get_option( 'hb-footer-column' ),
			'type'       => 'control',
			...
			'partial'    => array(
				...
				'render_callback'     => array( divino_Builder_Footer::get_instance(), 'primary_footer' ),
			),
			'renderAs'   => 'text',
			'responsive' => false,
		 ...
		 */
		array(
			'name'        => divino_THEME_SETTINGS . '[hb-footer-layout]',
			'section'     => $_section,
		 ...
		 */
		array(
			'name'       => divino_THEME_SETTINGS . '[hb-footer-layout-width]',
			'default'    => divino_get_option( 'hb-footer-layout-width' ),
			'type'       => 'control',
			'control'    => 'ast-selector',
			'section'    => $_section,
			'priority'   => 25,
		...
		array(
			'name'        => divino_THEME_SETTINGS . '[hb-primary-footer-height]',
			'section'     => $_section,
			'transport'   => 'refresh',
		 ...
		 */
		array(
			'name'       => divino_THEME_SETTINGS . '[hb-footer-vertical-alignment]',
			'default'    => divino_get_option( 'hb-footer-vertical-alignment' ),
			'type'       => 'control',
			'control'    => 'ast-selector',
			'section'    => $_section,
			'priority'   => 30,
		...
		array(
			'name'     => divino_THEME_SETTINGS . '[hb-stack]',
			'default'  => divino_get_option( 'hb-stack' ),
			'type'     => 'control',
			'control'  => 'ast-selector',
			'section'  => $_section,
			'priority' => 5,
		...
		array(
			'name'        => divino_THEME_SETTINGS . '[hb-footer-main-sep]',
			'transport'   => 'postMessage',
			'default'     => divino_get_option( 'hb-footer-main-sep' ),
			'type'        => 'control',
			'control'     => 'ast-slider',
			'section'     => $_section,
			'priority'    => 4,
		...
		array(
			'name'              => divino_THEME_SETTINGS . '[hb-footer-main-sep-color]',
			'transport'         => 'postMessage',
			'default'           => divino_get_option( 'hb-footer-main-sep-color' ),
			'type'              => 'control',
			'control'           => 'ast-color',
			...
			'context'           => array(
				...
				array(
					'setting'  => divino_THEME_SETTINGS . '[hb-footer-main-sep]',
					'operator' => '>=',
					'value'    => 1,
				),
			),
		...
		array(
			'name'       => divino_THEME_SETTINGS . '[hb-footer-bg-obj-responsive]',
			'section'    => $_section,
			'type'       => 'control',
		 ...
		 */
		array(
			'name'              => divino_THEME_SETTINGS . '[hb-inner-spacing]',
			'section'           => $_section,
			'priority'          => 205,
			'transport'         => 'postMessage',
...
if ( divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
	add_action( 'init', 'divino_primary_footer_configuration' );
}
