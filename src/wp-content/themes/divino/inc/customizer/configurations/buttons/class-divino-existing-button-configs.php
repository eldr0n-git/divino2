 ...
 * @since 2.6.0
 */
if ( ! class_exists( 'divino_Existing_Button_Configs' ) ) {

	/**
	 * Register Button Customizer Configurations.
	 */
	class divino_Existing_Button_Configs extends divino_Customizer_Config_Base {
		/**
		 * Register Button Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$_configs = array(
				 ...
				 */
				array(
					'name'     => divino_THEME_SETTINGS . '[primary-header-button-color-divider]',
					'type'     => 'control',
					'control'  => 'ast-heading',
				 ...
				 */
				array(
					'name'      => divino_THEME_SETTINGS . '[primary-header-button-color-group]',
					'default'   => divino_get_option( 'primary-header-button-color-group' ),
					'type'      => 'control',
				 ...
				 */
				array(
					'name'      => divino_THEME_SETTINGS . '[primary-header-button-border-group]',
					'default'   => divino_get_option( 'primary-header-button-border-group' ),
					'type'      => 'control',
					'control'   => 'ast-settings-group',
				...
				array(
					...
					'transport'         => 'postMessage',
					'default'           => divino_get_option( 'header-main-rt-section-button-text-color' ),
					'type'              => 'sub-control',
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-color-group]',
					'section'           => 'section-primary-menu',
				...
				array(
					...
					'default'           => divino_get_option( 'header-main-rt-section-button-text-h-color' ),
					'transport'         => 'postMessage',
					'type'              => 'sub-control',
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-color-group]',
					'section'           => 'section-primary-menu',
				...
				array(
					...
					'default'           => divino_get_option( 'header-main-rt-section-button-back-color' ),
					'transport'         => 'postMessage',
					'type'              => 'sub-control',
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-color-group]',
					'section'           => 'section-primary-menu',
				...
				array(
					...
					'default'           => divino_get_option( 'header-main-rt-section-button-back-h-color' ),
					'transport'         => 'postMessage',
					'type'              => 'sub-control',
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-color-group]',
					'section'           => 'section-primary-menu',
				 ...
				 */
				array(
					'name'      => divino_THEME_SETTINGS . '[primary-header-button-text-typography]',
					'default'   => divino_get_option( 'primary-header-button-text-typography' ),
					'type'      => 'control',
					'control'   => 'ast-settings-group',
					'is_font'   => true,
				...
				array(
					...
					'type'      => 'sub-control',
					'parent'    => divino_THEME_SETTINGS . '[primary-header-button-text-typography]',
					'section'   => 'section-primary-menu',
					'control'   => 'ast-font',
					'font_type' => 'ast-font-family',
					'title'     => __( 'Font Family', 'divino' ),
					'default'   => divino_get_option( 'primary-header-button-font-family' ),
					'connect'   => divino_THEME_SETTINGS . '[primary-header-button-font-weight]',
					'priority'  => 1,
				),
				...
				array(
					...
					'parent'      => divino_THEME_SETTINGS . '[primary-header-button-text-typography]',
					'section'     => 'section-primary-menu',
					'default'     => divino_get_option( 'primary-header-button-font-size' ),
				...
				array(
					...
					'default'           => divino_get_option( 'primary-header-button-font-weight' ),
				...
				array(
					...
					'transport' => 'postMessage',
					'default'   => divino_get_option( 'primary-header-button-text-transform' ),
					'title'     => __( 'Text Transform', 'divino' ),
					'type'      => 'sub-control',
					'parent'    => divino_THEME_SETTINGS . '[primary-header-button-text-typography]',
					'section'   => 'section-primary-menu',
					'control'   => 'ast-select',
					...
					'choices'   => array(
						''           => __( 'Inherit', 'divino' ),
						'none'       => __( 'None', 'divino' ),
						'capitalize' => __( 'Capitalize', 'divino' ),
						'uppercase'  => __( 'Uppercase', 'divino' ),
						'lowercase'  => __( 'Lowercase', 'divino' ),
					),
				),
				...
				array(
					...
					'transport'         => 'postMessage',
					'type'              => 'sub-control',
					'default'           => divino_get_option( 'primary-header-button-line-height' ),
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-text-typography]',
					'section'           => 'section-primary-menu',
					'sanitize_callback' => array( 'divino_Customizer_Sanitizes', 'sanitize_number_n_blank' ),
					'title'             => __( 'Line Height', 'divino' ),
					'suffix'            => 'em',
					'priority'          => 4,
					'input_attrs'       => array(
						'min'  => 1,
				...
				array(
					...
					'transport'         => 'postMessage',
					'type'              => 'sub-control',
					'default'           => divino_get_option( 'primary-header-button-letter-spacing' ),
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-text-typography]',
					'section'           => 'section-primary-menu',
					'sanitize_callback' => array( 'divino_Customizer_Sanitizes', 'sanitize_number_n_blank' ),
					'title'             => __( 'Letter Spacing', 'divino' ),
					'suffix'            => 'px',
					'priority'          => 5,
					'input_attrs'       => array(
						'min'  => 1,
				...
				array(
					...
					'name'              => divino_THEME_SETTINGS . '[header-main-rt-section-button-padding]',
					'section'           => 'section-primary-menu',
					'transport'         => 'postMessage',
					'linked_choices'    => true,
					'priority'          => 21,
					...
					'default'           => divino_get_option( 'header-main-rt-section-button-padding' ),
				...
				array(
					'type'           => 'sub-control',
					'parent'         => divino_THEME_SETTINGS . '[primary-header-button-border-group]',
					'section'        => 'section-primary-menu',
					'control'        => 'ast-border',
					...
					'linked_choices' => true,
					'priority'       => 10,
					'default'        => divino_get_option( 'header-main-rt-section-button-border-size' ),
				...
				array(
					...
					'default'           => divino_get_option( 'header-main-rt-section-button-border-color' ),
					'transport'         => 'postMessage',
					'type'              => 'sub-control',
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-border-group]',
					'section'           => 'section-primary-menu',
				...
				array(
					...
					'default'           => divino_get_option( 'header-main-rt-section-button-border-h-color' ),
					'transport'         => 'postMessage',
					'type'              => 'sub-control',
					'parent'            => divino_THEME_SETTINGS . '[primary-header-button-border-group]',
					'section'           => 'section-primary-menu',
				...
				array(
					...
					'default'     => divino_get_option( 'header-main-rt-section-button-border-radius' ),
					'type'        => 'sub-control',
					'parent'      => divino_THEME_SETTINGS . '[primary-header-button-border-group]',
					'section'     => 'section-primary-menu',
					'control'     => 'ast-slider',
 ...
 */
new divino_Existing_Button_Configs();
