 ...
 * @since 1.4.3
 */
if ( ! class_exists( 'divino_Customizer_Button_Configs' ) ) {

	/**
	 * Register Button Customizer Configurations.
	 */
	class divino_Customizer_Button_Configs extends divino_Customizer_Config_Base {
		/**
		 * Register Button Customizer Configurations.
		 *
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			for ( $index = 0; $index < 2; $index++ ) {
				...
				$_tab_configs = array(
					array(
						'name'      => divino_THEME_SETTINGS . '[' . $id . 'button-preset-style]',
					 ...
					 */
					array(
						'name'      => divino_THEME_SETTINGS . '[' . $id . 'theme-button-color-group]',
					 ...
					 */
					array(
						'name'      => divino_THEME_SETTINGS . '[' . $id . 'theme-button-bg-color-group]',
					 ...
					 */
					array(
						'name'      => divino_THEME_SETTINGS . '[' . $id . 'theme-button-border-color-group]',
					...
					array(
						...
						'parent'            => divino_THEME_SETTINGS . '[' . $id . 'theme-button-border-color-group]',
						'default'           => divino_get_option( $id . 'theme-button-border-group-border-color' ),
						'transport'         => 'postMessage',
						'type'              => 'sub-control',
						'section'           => 'section-buttons',
						'control'           => 'ast-color',
					...
					array(
						...
						'default'           => divino_get_option( $id . 'theme-button-border-group-border-h-color' ),
						'parent'            => divino_THEME_SETTINGS . '[' . $id . 'theme-button-border-color-group]',
						'transport'         => 'postMessage',
						'type'              => 'sub-control',
						'section'           => 'section-buttons',
					...
					array(
						...
						'default' => divino_get_option( $id . 'button-color' ),
						'type'    => 'sub-control',
					...
					array(
						...
						'default'  => divino_get_option( $id . 'button-h-color' ),
						'type'     => 'sub-control',
						'parent'   => divino_THEME_SETTINGS . '[' . $id . 'theme-button-color-group]',
						'section'  => 'section-buttons',
						'control'  => 'ast-color',
					...
					array(
						...
						'default' => divino_get_option( $id . 'button-bg-color' ),
						'type'    => 'sub-control',
					...
					array(
						...
						'default'  => divino_get_option( $id . 'button-bg-h-color' ),
						'type'     => 'sub-control',
						'parent'   => divino_THEME_SETTINGS . '[' . $id . 'theme-button-bg-color-group]',
						'section'  => 'section-buttons',
						'control'  => 'ast-color',
					 ...
					 */
					array(
						'name'              => divino_THEME_SETTINGS . '[' . $id . 'theme-button-padding]',
						'default'           => divino_get_option( $id . 'theme-button-padding' ),
						'type'              => 'control',
					...
					array(
						...
						'section'        => 'section-buttons',
						'control'        => 'ast-border',
						'name'           => divino_THEME_SETTINGS . '[' . $id . 'theme-button-border-group-border-size]',
						'transport'      => 'postMessage',
						'linked_choices' => true,
						'suffix'         => 'px',
						'priority'       => 19,
					 ...
					 */
					array(
						'name'              => divino_THEME_SETTINGS . '[' . $id . 'button-radius-fields]',
						'default'           => divino_get_option( $id . 'button-radius-fields' ),
						'type'              => 'control',
						'control'           => 'ast-responsive-spacing',
						'sanitize_callback' => array( 'divino_Customizer_Sanitizes', 'sanitize_responsive_spacing' ),
						'section'           => 'section-buttons',
			...
			for ( $index = $secondary_btn_preset_index, $priority = 0; $index < $config_count - 1; $index++ ) {
				$_configs[ $index ]['context']  = divino_Builder_Helper::$design_tab;
			...
			if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
				...
				$_trans_config = array(
					 ...
					 */
					array(
						'name'     => divino_THEME_SETTINGS . '[transparent-header-button-color-divider]',
						'type'     => 'control',
						'control'  => 'ast-heading',
					 ...
					 */
					array(
						'name'      => divino_THEME_SETTINGS . '[transparent-header-button-color-group]',
					 ...
					 */
					array(
						'name'      => divino_THEME_SETTINGS . '[transparent-header-button-border-group]',
					...
					array(
						...
						'transport'         => 'postMessage',
						'default'           => divino_get_option( 'header-main-rt-trans-section-button-text-color' ),
						'type'              => 'sub-control',
					...
					array(
						...
						'default'           => divino_get_option( 'header-main-rt-trans-section-button-text-h-color' ),
						'transport'         => 'postMessage',
						'type'              => 'sub-control',
						'parent'            => divino_THEME_SETTINGS . '[transparent-header-button-color-group]',
						'section'           => 'section-transparent-header',
					...
					array(
						...
						'default'           => divino_get_option( 'header-main-rt-trans-section-button-back-color' ),
						'transport'         => 'postMessage',
						'type'              => 'sub-control',
						'parent'            => divino_THEME_SETTINGS . '[transparent-header-button-color-group]',
						'section'           => 'section-transparent-header',
					...
					array(
						...
						'default'           => divino_get_option( 'header-main-rt-trans-section-button-back-h-color' ),
						'transport'         => 'postMessage',
						'type'              => 'sub-control',
						'parent'            => divino_THEME_SETTINGS . '[transparent-header-button-color-group]',
						'section'           => 'section-transparent-header',
					...
					array(
						...
						'control'           => 'ast-responsive-spacing',
						'sanitize_callback' => array( 'divino_Customizer_Sanitizes', 'sanitize_responsive_spacing' ),
						'name'              => divino_THEME_SETTINGS . '[header-main-rt-trans-section-button-padding]',
						'section'           => 'section-transparent-header',
						'transport'         => 'postMessage',
						'linked_choices'    => true,
						'priority'          => 40,
					...
					array(
						'type'           => 'sub-control',
						'parent'         => divino_THEME_SETTINGS . '[transparent-header-button-border-group]',
						'section'        => 'section-transparent-header',
						'control'        => 'ast-border',
					...
					array(
						...
						'default'           => divino_get_option( 'header-main-rt-trans-section-button-border-color' ),
						'type'              => 'sub-control',
						'parent'            => divino_THEME_SETTINGS . '[transparent-header-button-border-group]',
						'section'           => 'section-transparent-header',
						'transport'         => 'postMessage',
					...
					array(
						...
						'default'           => divino_get_option( 'header-main-rt-trans-section-button-border-h-color' ),
						'transport'         => 'postMessage',
						'type'              => 'sub-control',
						'parent'            => divino_THEME_SETTINGS . '[transparent-header-button-border-group]',
						'control'           => 'ast-color',
					...
					array(
						...
						'default'     => divino_get_option( 'header-main-rt-trans-section-button-border-radius' ),
						'type'        => 'sub-control',
						'parent'      => divino_THEME_SETTINGS . '[transparent-header-button-border-group]',
						'section'     => 'section-transparent-header',
						'control'     => 'ast-slider',
 ...
 */
new divino_Customizer_Button_Configs();
