 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'divino_Customizer_Sanitizes' ) ) {

	/**
	 * Customizer Sanitizes Initial setup
	 */
	class divino_Customizer_Sanitizes {
		/**
		 * Instance
		 *
		 * @var object
 ...
 */
divino_Customizer_Sanitizes::get_instance();
