 ...
 * @since 1.0.0
 */
if ( ! class_exists( 'divino_Customizer_Partials' ) ) {

	/**
	 * Customizer Partials initial setup
	 */
	class divino_Customizer_Partials {
		/**
		 * Constructor
		 *
		 * @since 1.0.0
		...
		public static function render_header_main_rt_section_html() {
			...
			$right_section_html = divino_get_i18n_option( 'header-main-rt-section-html', _x( '%divino%', 'Primary Menu: Custom Menu Text / HTML for Last Item in Menu', 'divino' ) );
		...
		public static function render_header_main_rt_section_button_text() {
			$custom_button_text = divino_get_i18n_option( 'header-main-rt-section-button-text', _x( '%divino%', 'Primary Menu: Button Text for Last Item in Menu', 'divino' ) );
		...
		public static function render_header_site_title_tagline() {
			...
			$html = divino_get_site_title_tagline( $display_site_title, $display_site_tagline );
		...
		public static function render_footer_sml_section_1_credit() {
			...
			$output = divino_get_small_footer_custom_text( 'footer-sml-section-1-credit' );
		...
		public static function render_footer_sml_section_2_credit() {
			...
			$output = divino_get_small_footer_custom_text( 'footer-sml-section-2-credit' );
			return do_shortcode( wp_kses_post( $output ) );
		}
		...
		public static function mobile_toggle_menu() {
			...
			$output = divino_masthead_toggle_buttons_primary();
			return do_shortcode( wp_kses_post( $output ) );
		}
	}
}
