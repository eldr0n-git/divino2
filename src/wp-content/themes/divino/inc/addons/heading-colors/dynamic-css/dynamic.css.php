 ...
 * Heading Colors
 */
add_filter( 'divino_dynamic_theme_css', 'divino_heading_colors_section_dynamic_css' );
 ...
 * @since 2.1.4
 */
function divino_heading_colors_section_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
