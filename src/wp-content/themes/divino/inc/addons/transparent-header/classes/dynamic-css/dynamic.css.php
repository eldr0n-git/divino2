...
add_filter( 'divino_dynamic_theme_css', 'divino_ext_transparent_header_dynamic_css' );
 ...
 * @since 4.4.0
 */
function divino_has_submenu_transperent_styling() {
	$divino_settings = divino_get_options();
	return apply_filters( 'divino_submenu_anchor_transperent_style', isset( $divino_settings['v4-3-2-anchor_transperent_style'] ) ? false : true );
}
 ...
 * @return string
 */
function divino_get_transparent_header_last_active_row( $device ) {
	$selector    = '';
	...
	foreach ( $header_rows as $row ) {
		if ( ! divino_Builder_Helper::is_row_empty( $row, 'header', $device ) ) {
			continue;
		}
 ...
 */
function divino_ext_transparent_header_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( true != divino_Ext_Transparent_Header_Markup::is_transparent_header() ) {
		return $dynamic_css;
	}
	 ...
	 */
	$transparent_header_separator       = divino_get_option( 'transparent-header-main-sep' );
	$transparent_header_separator_color = divino_get_option( 'transparent-header-main-sep-color' );

	$transparent_header_logo_width = divino_get_option( 'transparent-header-logo-width' );

	$transparent_header_inherit = divino_get_option( 'different-transparent-logo' );
	$transparent_header_logo    = divino_get_option( 'transparent-header-logo' );

	$transparent_bg_color_desktop = divino_get_prop( divino_get_option( 'transparent-header-bg-color-responsive' ), 'desktop' );
	$transparent_bg_color_tablet  = divino_get_prop( divino_get_option( 'transparent-header-bg-color-responsive' ), 'tablet', $transparent_bg_color_desktop );
	$transparent_bg_color_mobile  = divino_get_prop( divino_get_option( 'transparent-header-bg-color-responsive' ), 'mobile', $transparent_bg_color_tablet ? $transparent_bg_color_tablet : $transparent_bg_color_desktop );

	// Above transparent header background color.
	$above_transparent_bg_color_desktop = divino_get_prop( divino_get_option( 'hba-transparent-header-bg-color-responsive' ), 'desktop' );
	$above_transparent_bg_color_tablet  = divino_get_prop( divino_get_option( 'hba-transparent-header-bg-color-responsive' ), 'tablet', $above_transparent_bg_color_desktop );
	$above_transparent_bg_color_mobile  = divino_get_prop( divino_get_option( 'hba-transparent-header-bg-color-responsive' ), 'mobile', $above_transparent_bg_color_tablet ? $above_transparent_bg_color_tablet : $above_transparent_bg_color_desktop );

	// Below transparent header background color.
	$below_transparent_bg_color_desktop = divino_get_prop( divino_get_option( 'hbb-transparent-header-bg-color-responsive' ), 'desktop' );
	$below_transparent_bg_color_tablet  = divino_get_prop( divino_get_option( 'hbb-transparent-header-bg-color-responsive' ), 'tablet', $below_transparent_bg_color_desktop );
	$below_transparent_bg_color_mobile  = divino_get_prop( divino_get_option( 'hbb-transparent-header-bg-color-responsive' ), 'mobile', $below_transparent_bg_color_tablet ? $below_transparent_bg_color_tablet : $below_transparent_bg_color_desktop );

	$transparent_color_site_title_desktop = divino_get_prop( divino_get_option( 'transparent-header-color-site-title-responsive' ), 'desktop' );
	$transparent_color_site_title_tablet  = divino_get_prop( divino_get_option( 'transparent-header-color-site-title-responsive' ), 'tablet' );
	$transparent_color_site_title_mobile  = divino_get_prop( divino_get_option( 'transparent-header-color-site-title-responsive' ), 'mobile' );

	$transparent_color_h_site_title_desktop = divino_get_prop( divino_get_option( 'transparent-header-color-h-site-title-responsive' ), 'desktop' );
	$transparent_color_h_site_title_tablet  = divino_get_prop( divino_get_option( 'transparent-header-color-h-site-title-responsive' ), 'tablet' );
	$transparent_color_h_site_title_mobile  = divino_get_prop( divino_get_option( 'transparent-header-color-h-site-title-responsive' ), 'mobile' );

	$transparent_menu_bg_color_desktop = divino_get_prop( divino_get_option( 'transparent-menu-bg-color-responsive' ), 'desktop' );
	$transparent_menu_color_desktop    = divino_get_prop( divino_get_option( 'transparent-menu-color-responsive' ), 'desktop' );
	$transparent_menu_h_color_desktop  = divino_get_prop( divino_get_option( 'transparent-menu-h-color-responsive' ), 'desktop' );

	$transparent_menu_bg_color_tablet = divino_get_prop( divino_get_option( 'transparent-menu-bg-color-responsive' ), 'tablet' );
	$transparent_menu_color_tablet    = divino_get_prop( divino_get_option( 'transparent-menu-color-responsive' ), 'tablet' );
	$transparent_menu_h_color_tablet  = divino_get_prop( divino_get_option( 'transparent-menu-h-color-responsive' ), 'tablet' );

	$transparent_menu_bg_color_mobile = divino_get_prop( divino_get_option( 'transparent-menu-bg-color-responsive' ), 'mobile' );
	$transparent_menu_color_mobile    = divino_get_prop( divino_get_option( 'transparent-menu-color-responsive' ), 'mobile' );
	$transparent_menu_h_color_mobile  = divino_get_prop( divino_get_option( 'transparent-menu-h-color-responsive' ), 'mobile' );

	$transparent_sub_menu_color_desktop    = divino_get_prop( divino_get_option( 'transparent-submenu-color-responsive' ), 'desktop' );
	$transparent_sub_menu_h_color_desktop  = divino_get_prop( divino_get_option( 'transparent-submenu-h-color-responsive' ), 'desktop' );
	$transparent_sub_menu_bg_color_desktop = divino_get_prop( divino_get_option( 'transparent-submenu-bg-color-responsive' ), 'desktop' );

	$transparent_sub_menu_color_tablet    = divino_get_prop( divino_get_option( 'transparent-submenu-color-responsive' ), 'tablet' );
	$transparent_sub_menu_h_color_tablet  = divino_get_prop( divino_get_option( 'transparent-submenu-h-color-responsive' ), 'tablet' );
	$transparent_sub_menu_bg_color_tablet = divino_get_prop( divino_get_option( 'transparent-submenu-bg-color-responsive' ), 'tablet' );

	$transparent_sub_menu_color_mobile    = divino_get_prop( divino_get_option( 'transparent-submenu-color-responsive' ), 'mobile' );
	$transparent_sub_menu_h_color_mobile  = divino_get_prop( divino_get_option( 'transparent-submenu-h-color-responsive' ), 'mobile' );
	$transparent_sub_menu_bg_color_mobile = divino_get_prop( divino_get_option( 'transparent-submenu-bg-color-responsive' ), 'mobile' );

	$transparent_content_section_text_color_desktop   = divino_get_prop( divino_get_option( 'transparent-content-section-text-color-responsive' ), 'desktop' );
	$transparent_content_section_link_color_desktop   = divino_get_prop( divino_get_option( 'transparent-content-section-link-color-responsive' ), 'desktop' );
	$transparent_content_section_link_h_color_desktop = divino_get_prop( divino_get_option( 'transparent-content-section-link-h-color-responsive' ), 'desktop' );

	$transparent_content_section_text_color_tablet   = divino_get_prop( divino_get_option( 'transparent-content-section-text-color-responsive' ), 'tablet' );
	$transparent_content_section_link_color_tablet   = divino_get_prop( divino_get_option( 'transparent-content-section-link-color-responsive' ), 'tablet' );
	$transparent_content_section_link_h_color_tablet = divino_get_prop( divino_get_option( 'transparent-content-section-link-h-color-responsive' ), 'tablet' );

	$transparent_content_section_text_color_mobile   = divino_get_prop( divino_get_option( 'transparent-content-section-text-color-responsive' ), 'mobile' );
	$transparent_content_section_link_color_mobile   = divino_get_prop( divino_get_option( 'transparent-content-section-link-color-responsive' ), 'mobile' );
	$transparent_content_section_link_h_color_mobile = divino_get_prop( divino_get_option( 'transparent-content-section-link-h-color-responsive' ), 'mobile' );
	...
	if ( '0' === $transparent_header_inherit && '' != $transparent_header_logo ) {
		...
		$css       .= divino_parse_css( $css_output );
	}
	...
	if ( is_customize_preview() ) {
		if ( divino_Ext_Transparent_Header_Markup::is_transparent_header() ) {
			...
			$header_items = divino_get_option( 'header-desktop-items', array() );
			...
			foreach ( $transparent_bg_colors as $section => $bg_color ) {
				if ( isset( $header_items[ $section ] ) && divino_is_logo_in_section( $header_items[ $section ] ) ) {
			...
			$css .= divino_parse_css( $transparent_header_desktop_bg );
		}
	}

	// Desktop Transparent Heder Logo Width.
	$css_output = array(
		'.ast-theme-transparent-header #masthead .site-logo-img .transparent-custom-logo .divino-logo-svg' => array(
			'width'  => divino_get_css_value( $transparent_header_logo_width['desktop'], 'px' ),
			'height' => divino_get_css_value( ! empty( $transparent_header_logo_width['desktop-svg-height'] ) && ! is_customize_preview() ? $transparent_header_logo_width['desktop-svg-height'] : '', 'px' ),
		),
		'.ast-theme-transparent-header #masthead .site-logo-img .transparent-custom-logo img' => array(
			' max-width' => divino_get_css_value( $transparent_header_logo_width['desktop'], 'px' ),
			' width'     => divino_get_css_value( $transparent_header_logo_width['desktop'], 'px' ),
		),
	);
	$css       .= divino_parse_css( $css_output );
	...
	$tablet_css_output = array(
		'.ast-theme-transparent-header #masthead .site-logo-img .transparent-custom-logo .divino-logo-svg' => array(
			'width'  => divino_get_css_value( $transparent_header_logo_width['tablet'], 'px' ),
			'height' => divino_get_css_value( ! empty( $transparent_header_logo_width['tablet-svg-height'] ) && ! is_customize_preview() ? $transparent_header_logo_width['tablet-svg-height'] : '', 'px' ),
		),
		'.ast-theme-transparent-header #masthead .site-logo-img .transparent-custom-logo img' => array(
			' max-width' => divino_get_css_value( $transparent_header_logo_width['tablet'], 'px' ),
			' width'     => divino_get_css_value( $transparent_header_logo_width['tablet'], 'px' ),
		),
	);
	$css              .= divino_parse_css( $tablet_css_output, '', divino_get_tablet_breakpoint() );

	// Mobile Transparent Heder Logo Width.
	$mobile_css_output = array(
		'.ast-theme-transparent-header #masthead .site-logo-img .transparent-custom-logo .divino-logo-svg' => array(
			'width'  => divino_get_css_value( $transparent_header_logo_width['mobile'], 'px' ),
			'height' => divino_get_css_value( ! empty( $transparent_header_logo_width['mobile-svg-height'] ) && ! is_customize_preview() ? $transparent_header_logo_width['mobile-svg-height'] : '', 'px' ),
		),
		'.ast-theme-transparent-header #masthead .site-logo-img .transparent-custom-logo img' => array(
			' max-width' => divino_get_css_value( $transparent_header_logo_width['mobile'], 'px' ),
			' width'     => divino_get_css_value( $transparent_header_logo_width['mobile'], 'px' ),
		),
	);
	$css              .= divino_parse_css( $mobile_css_output, '', divino_get_mobile_breakpoint( 1 ) );
	...
	if ( divino_has_submenu_transperent_styling() ) {
	...
	$transparent_header_tablet = array(
		...
		'.ast-theme-transparent-header .ast-builder-menu .main-header-menu .menu-item .sub-menu, .ast-header-break-point.ast-flyout-menu-enable.ast-header-break-point .ast-builder-menu .main-header-bar-navigation .main-header-menu .menu-item .sub-menu, .ast-theme-transparent-header.divino-hfb-header .ast-builder-menu [CLASS*="ast-builder-menu-"] .main-header-menu .menu-item .sub-menu, .ast-header-break-point.ast-flyout-menu-enable.divino-hfb-header .ast-builder-menu .main-header-bar-navigation [CLASS*="ast-builder-menu-"] .main-header-menu .menu-item .sub-menu, .ast-theme-transparent-header .ast-builder-menu .main-header-menu .menu-item .sub-menu .menu-link, .ast-header-break-point.ast-flyout-menu-enable.ast-header-break-point .ast-builder-menu .main-header-bar-navigation .main-header-menu .menu-item .sub-menu .menu-link, .ast-theme-transparent-header.divino-hfb-header .ast-builder-menu [CLASS*="ast-builder-menu-"] .main-header-menu .menu-item .sub-menu .menu-link, .ast-header-break-point.ast-flyout-menu-enable.divino-hfb-header .ast-builder-menu .main-header-bar-navigation [CLASS*="ast-builder-menu-"] .main-header-menu .menu-item .sub-menu .menu-link, .ast-theme-transparent-header .main-header-menu .menu-item .sub-menu .menu-link, .ast-header-break-point.ast-flyout-menu-enable.ast-header-break-point .main-header-bar-navigation .main-header-menu .menu-item .sub-menu .menu-link, .ast-theme-transparent-header .main-header-menu .menu-item .sub-menu, .ast-header-break-point.ast-flyout-menu-enable.ast-header-break-point .main-header-bar-navigation .main-header-menu .menu-item .sub-menu' => array(
	...
	if ( 'both' === $transparent_header_devices || 'desktop' === $transparent_header_devices ) {
		$css .= divino_parse_css( $transparent_header_base, strval( divino_get_tablet_breakpoint() ) );
		...
		if ( 'both' === $transparent_header_devices ) {
			$css .= divino_parse_css( $transparent_header_desktop );
		} else {
			$css .= divino_parse_css( $transparent_header_desktop, divino_get_tablet_breakpoint( '', 1 ) );
		}
	}
	...
	if ( 'both' === $transparent_header_devices || 'mobile' === $transparent_header_devices ) {
		$css .= divino_parse_css( $transparent_header_base, '', divino_get_tablet_breakpoint() );
		$css .= divino_parse_css( $transparent_header_tablet, '', divino_get_tablet_breakpoint() );
		$css .= divino_parse_css( $transparent_header_mobile, '', divino_get_mobile_breakpoint() );
	}

	if ( 'both' === $transparent_header_devices ) {

		if ( true === divino_Builder_Helper::$is_header_footer_builder_active ) {
			$desktop_selector    = divino_get_transparent_header_last_active_row( 'desktop' );
			$responsive_selector = divino_get_transparent_header_last_active_row( 'mobile' );
		...
		if ( '' !== $transparent_header_separator && 'inherit' !== $transparent_header_separator ) {
			$css .= divino_parse_css(
				array(
					$selector => array(
						'border-bottom-width' => divino_get_css_value( $transparent_header_separator, 'px' ),
	...
	if ( 'mobile' === $transparent_header_devices ) {
		...
		if ( true === divino_Builder_Helper::$is_header_footer_builder_active ) {
			$selector = divino_get_transparent_header_last_active_row( 'mobile' );
		} else {
	...
	if ( 'desktop' === $transparent_header_devices ) {
		...
		if ( true === divino_Builder_Helper::$is_header_footer_builder_active ) {
			$selector = divino_get_transparent_header_last_active_row( 'desktop' );
		} else {
