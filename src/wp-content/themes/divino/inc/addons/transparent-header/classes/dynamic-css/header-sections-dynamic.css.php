 ...
 */
add_filter( 'divino_dynamic_theme_css', 'divino_ext_transparent_above_header_sections_dynamic_css' );
...
function divino_ext_transparent_above_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$above_header_layout = divino_get_option( 'above-header-layout', 'disabled' );

	if ( 'disabled' === $above_header_layout ) {
		return $dynamic_css;
	}

	if ( false == divino_Ext_Transparent_Header_Markup::is_transparent_header() ) {
		return $dynamic_css;
	}
	...
	$transparent_bg_color_tablet  = divino_get_prop( divino_get_option( 'transparent-header-bg-color-responsive' ), 'tablet' );
	$transparent_bg_color_mobile  = divino_get_prop( divino_get_option( 'transparent-header-bg-color-responsive' ), 'mobile' );
 ...
 */
add_filter( 'divino_dynamic_theme_css', 'divino_ext_transparent_below_header_sections_dynamic_css' );
...
function divino_ext_transparent_below_header_sections_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {
	...
	$below_header_layout = divino_get_option( 'below-header-layout', 'disabled' );
