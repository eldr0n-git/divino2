...
define( 'divino_THEME_BREADCRUMBS_DIR', divino_THEME_DIR . 'inc/addons/breadcrumbs/' );
define( 'divino_THEME_BREADCRUMBS_URI', divino_THEME_URI . 'inc/addons/breadcrumbs/' );

if ( ! class_exists( 'divino_Breadcrumbs' ) ) {
	...
	class divino_Breadcrumbs {
		...
		public function __construct() {
			...
			add_filter( 'divino_breadcrumb_source_list', array( $this, 'divino_breadcrumb_source_list_items' ) );

			// Include front end files.
			if ( ! is_admin() ) {
				require_once divino_THEME_BREADCRUMBS_DIR . 'dynamic-css/dynamic.css.php';// phpcs:ignore: WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound
			}
		}
		 ...
		 * @since 1.0.0
		 */
		public function divino_breadcrumb_source_list_items( $options ) {
	 ...
	 */
	divino_Breadcrumbs::get_instance();
