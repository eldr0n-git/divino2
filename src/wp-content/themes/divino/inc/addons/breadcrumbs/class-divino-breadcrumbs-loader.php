...
if ( ! class_exists( 'divino_Breadcrumbs_Loader' ) ) {
	 ...
	 * @since 1.7.0
	 */
	class divino_Breadcrumbs_Loader {
		/**
		 * Member Variable
		 *
		 * @var object instance
		...
		public function add_fonts() {
			$breadcrumb_font_family = divino_get_option( 'breadcrumb-font-family' );
			$breadcrumb_font_weight = divino_get_option( 'breadcrumb-font-weight' );
			divino_Fonts::add_font( $breadcrumb_font_family, $breadcrumb_font_weight );
		}
		...
		public function theme_defaults( $defaults ) {
			...
			$defaults['breadcrumb-font-extras'] = array(
				'line-height'         => ! isset( $divino_options['breadcrumb-font-extras'] ) && isset( $divino_options['breadcrumb-line-height'] ) ? $divino_options['breadcrumb-line-height'] : '',
				'line-height-unit'    => 'em',
				'letter-spacing'      => '',
				'letter-spacing-unit' => 'px',
				'text-transform'      => ! isset( $divino_options['breadcrumb-font-extras'] ) && isset( $divino_options['breadcrumb-text-transform'] ) ? $divino_options['breadcrumb-text-transform'] : '',
				'text-decoration'     => '',
			);
 ...
 */
divino_Breadcrumbs_Loader::get_instance();
