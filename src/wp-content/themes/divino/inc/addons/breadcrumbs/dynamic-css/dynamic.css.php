 ...
 * Breadcrumbs
 */
add_filter( 'divino_dynamic_theme_css', 'divino_breadcrumb_section_dynamic_css' );
 ...
 * @since 1.7.0
 */
function divino_breadcrumb_section_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	$breadcrumb_position = divino_get_option( 'breadcrumb-position', 'none' );
	...
	$breadcrumb_text_color      = divino_get_option( 'breadcrumb-text-color-responsive', $default_color_array );
	$breadcrumb_active_color    = divino_get_option( 'breadcrumb-active-color-responsive', $default_color_array );
	$breadcrumb_hover_color     = divino_get_option( 'breadcrumb-hover-color-responsive', $default_color_array );
	$breadcrumb_separator_color = divino_get_option( 'breadcrumb-separator-color', $default_color_array );
	$breadcrumb_bg_color        = divino_get_option( 'breadcrumb-bg-color', $default_color_array );

	$breadcrumb_font_size          = divino_get_option( 'breadcrumb-font-size' );
	$breadcrumb_spacing            = divino_get_option( 'breadcrumb-spacing' );
	$breadcrumb_alignment          = divino_get_option( 'breadcrumb-alignment' );
	$breadcrumb_separator          = divino_get_option( 'breadcrumb-separator' );
	$breadcrumb_separator_selector = divino_get_option( 'breadcrumb-separator-selector' );

	/**
	 * Generate dynamic CSS based on the Breadcrumb Source option selected from the customizer.
	 */
	$breadcrumb_source = divino_get_option( 'select-breadcrumb-source' );
	...
	if ( function_exists( 'yoast_breadcrumb' ) && true === $wpseo_option['breadcrumbs-enable'] && $breadcrumb_source && 'yoast-seo-breadcrumbs' === $breadcrumb_source ) {
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumb_last, .ast-breadcrumbs-wrapper span' => divino_get_font_array_css( divino_get_option( 'breadcrumb-font-family' ), divino_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_tablet = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumb_last, .ast-breadcrumbs-wrapper span' => array(
				'font-size' => divino_responsive_font( $breadcrumb_font_size, 'tablet' ),
			),
		);
		...
		$breadcrumbs_mobile = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumb_last, .ast-breadcrumbs-wrapper span' => array(
				'font-size' => divino_responsive_font( $breadcrumb_font_size, 'mobile' ),
			),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .breadcrumbs, .ast-breadcrumbs-wrapper .current-item' => divino_get_font_array_css( divino_get_option( 'breadcrumb-font-family' ), divino_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper a, .ast-breadcrumbs-wrapper .last, .ast-breadcrumbs-wrapper .separator' => divino_get_font_array_css( divino_get_option( 'breadcrumb-font-family' ), divino_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-inner, .ast-breadcrumbs-inner .breadcrumb-item, .ast-breadcrumbs-inner .breadcrumb-item.active, .ast-breadcrumbs-inner .breadcrumb-item:after' => divino_get_font_array_css( divino_get_option( 'breadcrumb-font-family' ), divino_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
		...
		$breadcrumbs_desktop = array(
			...
			'.ast-breadcrumbs-wrapper, .ast-breadcrumbs-wrapper *' => divino_get_font_array_css( divino_get_option( 'breadcrumb-font-family' ), divino_get_option( 'breadcrumb-font-weight' ), $breadcrumb_font_size, 'breadcrumb-font-extras' ),
		);
	...
	if ( 'divino_header_markup_after' === $breadcrumb_position || 'divino_header_after' === $breadcrumb_position ) {
		// After Header.
		$breadcrumbs_desktop['.main-header-bar.ast-header-breadcrumb, .ast-header-break-point .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .header-main-layout-2 .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .ast-mobile-header-stack .main-header-bar.ast-header-breadcrumb, .ast-default-menu-enable.ast-main-header-nav-open.ast-header-break-point .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb, .ast-main-header-nav-open .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb'] = array(
			'padding-top'    => divino_responsive_spacing( $breadcrumb_spacing, 'top', 'desktop' ),
			'padding-right'  => divino_responsive_spacing( $breadcrumb_spacing, 'right', 'desktop' ),
			'padding-bottom' => divino_responsive_spacing( $breadcrumb_spacing, 'bottom', 'desktop' ),
			'padding-left'   => divino_responsive_spacing( $breadcrumb_spacing, 'left', 'desktop' ),
		);
		$breadcrumbs_tablet['.main-header-bar.ast-header-breadcrumb, .ast-header-break-point .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .header-main-layout-2 .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .ast-mobile-header-stack .main-header-bar.ast-header-breadcrumb, .ast-default-menu-enable.ast-main-header-nav-open.ast-header-break-point .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb, .ast-main-header-nav-open .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb']  = array(
			'padding-top'    => divino_responsive_spacing( $breadcrumb_spacing, 'top', 'tablet' ),
			'padding-right'  => divino_responsive_spacing( $breadcrumb_spacing, 'right', 'tablet' ),
			'padding-bottom' => divino_responsive_spacing( $breadcrumb_spacing, 'bottom', 'tablet' ),
			'padding-left'   => divino_responsive_spacing( $breadcrumb_spacing, 'left', 'tablet' ),
		);
		$breadcrumbs_mobile['.main-header-bar.ast-header-breadcrumb, .ast-header-break-point .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .header-main-layout-2 .main-header-bar.ast-header-breadcrumb, .ast-header-break-point .ast-mobile-header-stack .main-header-bar.ast-header-breadcrumb, .ast-default-menu-enable.ast-main-header-nav-open.ast-header-break-point .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb, .ast-main-header-nav-open .main-header-bar-wrap .main-header-bar.ast-header-breadcrumb']  = array(
			'padding-top'    => divino_responsive_spacing( $breadcrumb_spacing, 'top', 'mobile' ),
			'padding-right'  => divino_responsive_spacing( $breadcrumb_spacing, 'right', 'mobile' ),
			'padding-bottom' => divino_responsive_spacing( $breadcrumb_spacing, 'bottom', 'mobile' ),
			'padding-left'   => divino_responsive_spacing( $breadcrumb_spacing, 'left', 'mobile' ),
		);
	...
	} elseif ( 'divino_masthead_content' === $breadcrumb_position ) {
		// Inside Header.
	...
	$css .= divino_parse_css( $breadcrumbs_desktop );
	$css .= divino_parse_css( $breadcrumbs_tablet, '', divino_get_tablet_breakpoint() );
	$css .= divino_parse_css( $breadcrumbs_mobile, '', divino_get_mobile_breakpoint() );
	$css .= divino_parse_css( $breadcrumbs_default_css );
