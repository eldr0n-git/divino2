 ...
 * @since 4.0.0
 */
class divino_Scroll_To_Top_Loader {
	/**
	 * Member Variable
	 *
	 * @var null $instance
	...
	public function theme_defaults( $defaults ) {
		...
		$defaults['scroll-to-top-icon-radius-fields'] = array(
			'desktop'      => array(
				'top'    => ! isset( $divino_options['scroll-to-top-icon-radius'] ) ? '' : $divino_options['scroll-to-top-icon-radius'],
				'right'  => ! isset( $divino_options['scroll-to-top-icon-radius'] ) ? '' : $divino_options['scroll-to-top-icon-radius'],
				'bottom' => ! isset( $divino_options['scroll-to-top-icon-radius'] ) ? '' : $divino_options['scroll-to-top-icon-radius'],
				'left'   => ! isset( $divino_options['scroll-to-top-icon-radius'] ) ? '' : $divino_options['scroll-to-top-icon-radius'],
			),
			'tablet'       => array(
				'top'    => '',
				'right'  => '',
 ...
 */
divino_Scroll_To_Top_Loader::get_instance();
