 ...
 */
if ( ! function_exists( 'divino_widget_tag_cloud_args' ) ) {
	 ...
	 */
	function divino_widget_tag_cloud_args( $args = array() ) {
		...
		return apply_filters( 'divino_widget_tag_cloud_args', $args );
	}
	add_filter( 'widget_tag_cloud_args', 'divino_widget_tag_cloud_args', 90 );
 ...
 */
if ( ! function_exists( 'divino_filter_widget_tag_cloud' ) ) {
	 ...
	 */
	function divino_filter_widget_tag_cloud( $tags_data ) {
		...
		return apply_filters( 'divino_filter_widget_tag_cloud', $tags_data );
	}
	add_filter( 'wp_generate_tag_cloud_data', 'divino_filter_widget_tag_cloud' );
 ...
 */
if ( ! function_exists( 'divino_widgets_init' ) ) {
	...
	function divino_widgets_init() {
		 ...
		 */
		if ( class_exists( 'divino_Builder_Helper' ) && false === divino_Builder_Helper::$is_header_footer_builder_active ) {
			register_sidebar(
				apply_filters(
	...
	add_action( 'widgets_init', 'divino_widgets_init' );
