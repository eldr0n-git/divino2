...
if ( ! class_exists( 'Gutenberg_Editor_CSS' ) ) {
	...
	class Gutenberg_Editor_CSS {
		...
		public static function get_css() {
			...
			$site_content_width      = divino_get_option( 'site-content-width', 1200 ) + 56;
			...
			$body_line_height    = divino_get_option( 'body-line-height' );
			$body_text_transform = divino_get_option( 'body-text-transform' );
			...
			$single_post_title       = divino_get_option( 'ast-dynamic-single-post-structure', array( 'ast-dynamic-single-post-title', 'ast-dynamic-single-post-meta' ) );
			...
			$site_title_font_family    = divino_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-font-family' );
			$site_title_font_weight    = divino_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-font-weight' );
			$site_title_line_height    = divino_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-line-height' );
			$site_title_font_size      = divino_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-font-size' );
			$site_title_text_transform = divino_get_option( 'ast-dynamic-archive-' . esc_attr( $post_type ) . '-title-text-transform', $headings_text_transform );
			...
			$ast_content_width = apply_filters( 'divino_block_content_width', '910px' );
			...
			$divino_apply_content_background = divino_apply_content_background_fullwidth_layouts();
			...
			$desktop_css = array(
				...
				'.ast-separate-container .edit-post-visual-editor, .ast-page-builder-template .edit-post-visual-editor, .ast-plain-container .edit-post-visual-editor, .ast-separate-container #wpwrap #editor .edit-post-visual-editor' => divino_get_responsive_background_obj( $box_bg_obj, 'desktop' ),
				'.editor-post-title__block .editor-post-title__input,  .edit-post-visual-editor .block-editor-block-list__block h1, .edit-post-visual-editor .block-editor-block-list__block h2, .edit-post-visual-editor .block-editor-block-list__block h3, .edit-post-visual-editor .block-editor-block-list__block h4, .edit-post-visual-editor .block-editor-block-list__block h5, .edit-post-visual-editor .block-editor-block-list__block h6, .edit-post-visual-editor h1, .edit-post-visual-editor h2, .edit-post-visual-editor h3, .edit-post-visual-editor h4, .edit-post-visual-editor h5, .edit-post-visual-editor h6' => array(
					'font-family'    => divino_get_css_value( $headings_font_family, 'font' ),
					'font-weight'    => divino_get_css_value( $headings_font_weight, 'font' ),
				...
				'.editor-post-title__block .editor-post-title__input' => array(
					'font-family' => 'inherit' === $headings_font_family ? divino_get_font_family( $body_font_family ) : divino_get_font_family( $headings_font_family ),
					'font-weight' => 'normal',
				),
				...
				'blockquote .editor-rich-text__tinymce a' => array(
					'color' => divino_hex_to_rgba( $link_color, 1 ),
				),
				'blockquote'                              => array(
					'border-color' => divino_hex_to_rgba( $link_color, 0.05 ),
				),
			...
			if ( false === $improve_gb_ui ) {
				...
				$desktop_css['.block-editor-block-list__block[data-align=wide]'] = array(
					'max-width' => divino_get_css_value( $site_content_width + 200, 'px' ),
				);
			}

			$background_style_data = divino_get_responsive_background_obj( $box_bg_obj, 'desktop' );
			...
			if ( divino_wp_version_compare( '5.7', '>=' ) ) {
				...
				if ( true === $improve_gb_ui ) {
					...
					$desktop_css['.edit-post-visual-editor .editor-styles-wrapper'] = array(
						'max-width' => divino_get_css_value( $site_content_width - 56, 'px' ),
						'width'     => '100%',
						'margin'    => '0 auto',
						'padding'   => '0',
					);
			...
			if ( divino_wp_version_compare( '5.8', '>=' ) ) {
				...
				if ( false === $divino_apply_content_background ) {
			...
			if ( ( ( ! in_array( 'ast-dynamic-single-post-title', $single_post_title ) ) && ( 'post' === get_post_type() ) ) || ( 'disabled' === $title_enabled_from_meta ) ) {
				...
				$css             .= divino_parse_css( $destop_title_css );
			}
			...
			if ( divino_wp_version_compare( '5.7', '>=' ) ) {
				$css_prod_button_tablet['.ast-page-builder-template .editor-styles-wrapper .block-editor-writing-flow, .ast-plain-container .editor-styles-wrapper .block-editor-writing-flow'] = divino_get_responsive_background_obj( $box_bg_obj, 'tablet' );
			}

			$css .= divino_parse_css( $css_prod_button_tablet, '', divino_get_tablet_breakpoint() );
			...
			if ( divino_wp_version_compare( '5.7', '>=' ) ) {
				$css_prod_button_mobile['.ast-page-builder-template .editor-styles-wrapper .block-editor-writing-flow, .ast-plain-container .editor-styles-wrapper .block-editor-writing-flow'] = divino_get_responsive_background_obj( $box_bg_obj, 'mobile' );
			}

			$css .= divino_parse_css( $css_prod_button_mobile, '', divino_get_mobile_breakpoint() );

			$theme_btn_top_border    = isset( $global_custom_button_border_size['top'] ) && '' !== $global_custom_button_border_size['top'] ? divino_get_css_value( $global_custom_button_border_size['top'], 'px' ) : '1px';
			$theme_btn_right_border  = isset( $global_custom_button_border_size['right'] ) && '' !== $global_custom_button_border_size['right'] ? divino_get_css_value( $global_custom_button_border_size['right'], 'px' ) : '1px';
			$theme_btn_left_border   = isset( $global_custom_button_border_size['left'] ) && '' !== $global_custom_button_border_size['left'] ? divino_get_css_value( $global_custom_button_border_size['left'], 'px' ) : '1px';
			$theme_btn_bottom_border = isset( $global_custom_button_border_size['bottom'] ) && '' !== $global_custom_button_border_size['bottom'] ? divino_get_css_value( $global_custom_button_border_size['bottom'], 'px' ) : '1px';

			if ( divino_Dynamic_CSS::page_builder_button_style_css() ) {

				$is_support_wp_5_8            = divino_Dynamic_CSS::is_block_editor_support_enabled();
				...
				$css .= divino_parse_css( $button_desktop_css );
				...
				$css .= divino_parse_css( $css_global_button_tablet, '', divino_get_tablet_breakpoint() );
				...
				$css .= divino_parse_css( $css_global_button_mobile, '', divino_get_mobile_breakpoint() );
			}

			if ( divino_Dynamic_CSS::gutenberg_core_patterns_compat() ) {
				...
				$css .= divino_parse_css( $button_patterns_compat_css );
				...
				if ( ! divino_button_default_padding_updated() ) {
					...
					$css .= divino_parse_css( $button_patterns_tablet_compat_css, '', divino_get_tablet_breakpoint() );
					...
					$css .= divino_parse_css( $button_patterns_mobile_compat_css, '', divino_get_mobile_breakpoint() );
				}
				...
				$css .= divino_parse_css( $gb_patterns_min_mobile_css );
			}

			if ( divino_Dynamic_CSS::gutenberg_core_blocks_css_comp() ) {
				...
				$css .= divino_parse_css( $desktop_screen_gb_css );
				...
				if ( false === $improve_gb_ui ) {
					...
					$css .= divino_parse_css( $middle_screen_min_gb_css, '1200' );
				}
				...
				$css .= divino_parse_css( $middle_screen_max_gb_css, '', '1200' );
				...
				$css .= divino_parse_css( $tablet_screen_min_gb_css, divino_get_tablet_breakpoint() );
				...
				$css .= divino_parse_css( $mobile_screen_max_gb_css, '', divino_get_mobile_breakpoint() );
			}
			...
			if ( divino_Dynamic_CSS::gutenberg_core_patterns_compat() ) {
				...
				$css .= divino_parse_css( $gb_editor_block_pattern_css );
			}
			...
			if ( true === $improve_gb_ui ) {
				...
				$css .= divino_parse_css( $gb_editor_core_blocks_ui_css );
			} else {
				...
				$css .= divino_Enqueue_Scripts::trim_css( $block_editor_padding_css );
			}
			...
			$tablet_css = array(
				...
				'.ast-separate-container .edit-post-visual-editor, .ast-page-builder-template .edit-post-visual-editor, .ast-plain-container .edit-post-visual-editor, .ast-separate-container #wpwrap #editor .edit-post-visual-editor' => divino_get_responsive_background_obj( $box_bg_obj, 'tablet' ),
			);
			...
			$mobile_css = array(
				...
				'.ast-separate-container .edit-post-visual-editor, .ast-page-builder-template .edit-post-visual-editor, .ast-plain-container .edit-post-visual-editor, .ast-separate-container #wpwrap #editor .edit-post-visual-editor' => divino_get_responsive_background_obj( $box_bg_obj, 'mobile' ),
			);

			$css .= divino_parse_css( $mobile_css, '', divino_get_mobile_breakpoint() );

			if ( is_callable( 'divino_Woocommerce::divino_global_btn_woo_comp' ) && divino_Woocommerce::divino_global_btn_woo_comp() ) {
				...
				$css                  .= divino_parse_css( $woo_global_button_css );
			}
			...
			$css .= divino_parse_css( $page_builder_css );
			...
			$css .= divino_parse_css( $aligned_full_content_css );
			...
			$boxed_container = array(
				...
				'.ast-separate-container .editor-block-list__block, .ast-two-container .editor-block-list__block' => array(
					'max-width' => 'calc(' . divino_get_css_value( $site_content_width, 'px' ) . ' - 6.67em)',
				),
			...
			if ( divino_has_gcp_typo_preset_compatibility() ) {
				...
				$selector_for_content_background = true === $divino_apply_content_background ? '.edit-post-visual-editor .editor-styles-wrapper' : $boxed_editor_content_area;

				$boxed_container[ $selector_for_content_background ] = divino_get_responsive_background_obj( $content_bg_obj, 'desktop' );

				$boxed_container_tablet[ $selector_for_content_background ] = divino_get_responsive_background_obj( $content_bg_obj, 'tablet' );

				$boxed_container_mobile[ $selector_for_content_background ] = divino_get_responsive_background_obj( $content_bg_obj, 'mobile' );

				/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
				$css .= divino_parse_css( $boxed_container_tablet, '', divino_get_tablet_breakpoint() );
				/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
				$css .= divino_parse_css( $boxed_container_mobile, '', divino_get_mobile_breakpoint() );
			}

			$css .= divino_parse_css( $boxed_container );
			...
			$css .= divino_parse_css( $block_inserter_css );
			...
			if ( divino_wp_version_compare( '5.4.99', '>=' ) ) {
				...
				$css .= divino_parse_css( $block_pattern_css );
			} else {
				...
				$css .= divino_parse_css( $full_width_streched_css );
			}
			...
			/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$css .= divino_parse_css( $ast_gtn_mobile_css, '', divino_get_mobile_breakpoint() );
			...
			$css .= divino_parse_css( $gtn_full_wide_image_css );
			...
			$css .= divino_Enqueue_Scripts::trim_css( $compatibility_css );
			...
			return $css . divino_parse_css( $narrow_container );
		}
	}
