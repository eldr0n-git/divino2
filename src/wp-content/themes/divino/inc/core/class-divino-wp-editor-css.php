...
class divino_WP_Editor_CSS {
	 ...
	 * @since 3.8.3
	 */
	public static function divino_get_block_spacings() {
		$wp_block_spacing_type     = divino_get_option( 'wp-blocks-ui' );
		$container_blocks_spacings = divino_get_option( 'wp-blocks-global-padding' );
		switch ( $wp_block_spacing_type ) {
			...
			case 'comfort':
				...
				break;
			case 'custom':
				$desktop_top_block_space    = divino_responsive_spacing( $container_blocks_spacings, 'top', 'desktop' );
				$desktop_right_block_space  = divino_responsive_spacing( $container_blocks_spacings, 'right', 'desktop' );
				$desktop_bottom_block_space = divino_responsive_spacing( $container_blocks_spacings, 'bottom', 'desktop' );
				$desktop_left_block_space   = divino_responsive_spacing( $container_blocks_spacings, 'left', 'desktop' );
				$tablet_top_block_space     = divino_responsive_spacing( $container_blocks_spacings, 'top', 'tablet' );
				$tablet_right_block_space   = divino_responsive_spacing( $container_blocks_spacings, 'right', 'tablet' );
				$tablet_bottom_block_space  = divino_responsive_spacing( $container_blocks_spacings, 'bottom', 'tablet' );
				$tablet_left_block_space    = divino_responsive_spacing( $container_blocks_spacings, 'left', 'tablet' );
				$mobile_top_block_space     = divino_responsive_spacing( $container_blocks_spacings, 'top', 'mobile' );
				$mobile_right_block_space   = divino_responsive_spacing( $container_blocks_spacings, 'right', 'mobile' );
				$mobile_bottom_block_space  = divino_responsive_spacing( $container_blocks_spacings, 'bottom', 'mobile' );
				$mobile_left_block_space    = divino_responsive_spacing( $container_blocks_spacings, 'left', 'mobile' );
				break;
			default:
	...
	public static function get_css() {
		...
		$headings_text_transform = divino_get_font_extras( divino_get_option( 'headings-font-extras' ), 'text-transform' );
		...
		$para_margin_bottom      = divino_get_option( 'para-margin-bottom', '1.6' );
		 ...
		 */
		$btn_color                 = divino_get_option( 'button-color' );
		$btn_bg_color              = divino_get_option( 'button-bg-color', '', $theme_color );
		$btn_h_color               = divino_get_option( 'button-h-color' );
		...
		$btn_border_size           = divino_get_option( 'theme-button-border-group-border-size' );
		...
		$theme_btn_top_border      = isset( $btn_border_size['top'] ) && ( '' !== $btn_border_size['top'] && '0' !== $btn_border_size['top'] ) ? divino_get_css_value( $btn_border_size['top'], 'px' ) : '';
		$theme_btn_right_border    = isset( $btn_border_size['right'] ) && ( '' !== $btn_border_size['right'] && '0' !== $btn_border_size['right'] ) ? divino_get_css_value( $btn_border_size['right'], 'px' ) : '';
		$theme_btn_left_border     = isset( $btn_border_size['left'] ) && ( '' !== $btn_border_size['left'] && '0' !== $btn_border_size['left'] ) ? divino_get_css_value( $btn_border_size['left'], 'px' ) : '';
		$theme_btn_bottom_border   = isset( $btn_border_size['bottom'] ) && ( '' !== $btn_border_size['bottom'] && '0' !== $btn_border_size['bottom'] ) ? divino_get_css_value( $btn_border_size['bottom'], 'px' ) : '';
		...
		if ( empty( $btn_color ) ) {
			$btn_color = divino_get_foreground_color( $theme_color );
		}
		if ( empty( $btn_h_color ) ) {
			$btn_h_color = divino_get_foreground_color( $link_h_color );
		}
		...
		$site_background       = divino_get_option( 'site-layout-outside-bg-obj-responsive' );
		$content_background    = divino_get_option( 'content-bg-obj-responsive' );
		$background_style_data = divino_get_responsive_background_obj( $site_background, 'desktop' );
		if (
		...
		$site_title_font_family              = divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-family', divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-text-font-family' ) );
		$site_title_font_weight              = divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-weight', divino_Posts_Structure_Loader::get_customizer_default( 'title-font-weight' ) );
		$site_title_font_size                = divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-size', divino_Posts_Structure_Loader::get_customizer_default( 'title-font-size' ) );
		$site_title_font_extras              = divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-text-font-extras' );
		$site_title_text_transform           = divino_get_font_extras( divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-extras', $site_title_font_extras ), 'text-transform' );
		$site_title_spacing                  = divino_get_font_extras( divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-extras', $site_title_font_extras ), 'letter-spacing', 'letter-spacing-unit' );
		$site_title_decoration               = divino_get_font_extras( divino_get_option( 'ast-dynamic-single-' . esc_attr( $post_type ) . '-title-font-extras', $site_title_font_extras ), 'text-decoration' );
		$is_widget_title_support_font_weight = divino_Dynamic_CSS::support_font_css_to_widget_and_in_editor();
		...
		$border_color                        = divino_get_option( 'border-color' );
		...
		if ( '' == $site_title_text_transform ) {
			$site_title_text_transform = '' === $headings_text_transform ? divino_get_option( 'text-transform-h1' ) : $headings_text_transform;
		}
		if ( 'inherit' === $site_title_font_weight || '' == $site_title_font_weight ) {
			$site_title_font_weight = divino_Posts_Structure_Loader::get_customizer_default( 'title-font-weight' );
		}
		...
		$divino_is_block_editor_v2_ui = divino_get_option( 'wp-blocks-v2-ui', true );
		$divino_container_width       = $site_content_width . 'px';
		$block_appender_width        = $divino_is_block_editor_v2_ui ? 'var(--wp--custom--ast-content-width-size)' : 'var(--wp--custom--ast-wide-width-size)';

		$divino_wide_particular_selector = $divino_is_block_editor_v2_ui ? '.editor-styles-wrapper .block-editor-block-list__layout.is-root-container .block-list-appender' : '.editor-styles-wrapper .block-editor-block-list__layout.is-root-container > p, .editor-styles-wrapper .block-editor-block-list__layout.is-root-container .block-list-appender';

		$blocks_spacings          = self::divino_get_block_spacings();
		...
		$ast_content_width = apply_filters( 'divino_block_content_width', $divino_is_block_editor_v2_ui ? $divino_container_width : '910px' );
		$ast_wide_width    = apply_filters( 'divino_block_wide_width', $divino_is_block_editor_v2_ui ? 'calc(' . esc_attr( $divino_container_width ) . ' + var(--wp--custom--ast-default-block-left-padding) + var(--wp--custom--ast-default-block-right-padding))' : $divino_container_width );
		$ast_narrow_width  = divino_get_option( 'narrow-container-max-width', apply_filters( 'divino_narrow_container_width', 750 ) ) . 'px';
		...
		$html_font_size = divino_get_font_css_value( (int) $body_font_size_desktop * 6.25, '%' );
		/** @psalm-suppress InvalidScalarArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		...
		$desktop_css = array(
			':root'                            => divino_Global_Palette::generate_global_palette_style(),
			'html'                             => array(
				'font-size' => $html_font_size,
			),
			$divino_wide_particular_selector    => array(
			...
			'.editor-styles-wrapper'           => divino_get_responsive_background_obj( $content_background, 'desktop' ),
			...
			'.editor-styles-wrapper h1, .editor-styles-wrapper h2, .editor-styles-wrapper h3, .editor-styles-wrapper h4, .editor-styles-wrapper h5, .editor-styles-wrapper h6' => divino_get_font_array_css( divino_get_option( 'headings-font-family' ), divino_get_option( 'headings-font-weight' ), array(), 'headings-font-extras', $heading_base_color ),

			".wp-block-cover:not([class*='background-color']):not(.has-text-color.has-link-color):not(.wp-block-cover__inner-container .wp-block-cover ). block-editor-block-list__block" => divino_get_font_array_css( divino_get_option( 'headings-font-family' ), divino_get_option( 'headings-font-weight' ), array(), 'headings-font-extras', $heading_base_color ),
			...
			'.editor-styles-wrapper .wp-block-button:not(.is-style-outline) .wp-block-button__link, .block-editor-writing-flow .wp-block-search .wp-block-search__inside-wrapper .wp-block-search__button, .block-editor-writing-flow .wp-block-file .wp-block-file__button, .editor-styles-wrapper button.wc-block-components-button' => array(
				...
				'letter-spacing'             => divino_get_css_value( $theme_btn_letter_spacing, 'px' ),
		...
		if ( divino_Dynamic_CSS::divino_4_6_0_compatibility() && divino_get_option( 'single-content-images-shadow', false ) ) {
		...
		if ( defined( 'divino_EXT_VER' ) ) {
			...
			$h1_color = divino_get_option( 'h1-color' );
			$h2_color = divino_get_option( 'h2-color' );
			$h3_color = divino_get_option( 'h3-color' );
			$h4_color = divino_get_option( 'h4-color' );
			$h5_color = divino_get_option( 'h5-color' );
			$h6_color = divino_get_option( 'h6-color' );
		...
		if ( divino_Dynamic_CSS::divino_4_6_4_compatibility() ) {
		...
		$desktop_css['.editor-styles-wrapper .edit-post-visual-editor__post-title-wrapper > h1'] = array(
			...
			'font-weight'     => divino_get_css_value( $site_title_font_weight, 'font' ),
			'font-family'     => divino_get_css_value( $site_title_font_family, 'font', $body_font_family ),
		...
		$scndry_btn_border_radius_top            = divino_responsive_spacing( $scndry_btn_border_radius_fields, 'top', 'desktop' );
		$scndry_btn_border_radius_right          = divino_responsive_spacing( $scndry_btn_border_radius_fields, 'right', 'desktop' );
		$scndry_btn_border_radius_bottom         = divino_responsive_spacing( $scndry_btn_border_radius_fields, 'bottom', 'desktop' );
		$scndry_btn_border_radius_left           = divino_responsive_spacing( $scndry_btn_border_radius_fields, 'left', 'desktop' );
		...
		if ( empty( $scndry_btn_border_radius_top ) && empty( $scndry_btn_border_radius_right ) && empty( $scndry_btn_border_radius_bottom ) && empty( $scndry_btn_border_radius_left ) ) {
			$scndry_btn_border_radius_top    = divino_responsive_spacing( $btn_border_radius_fields, 'top', 'desktop' );
			$scndry_btn_border_radius_right  = divino_responsive_spacing( $btn_border_radius_fields, 'right', 'desktop' );
			$scndry_btn_border_radius_bottom = divino_responsive_spacing( $btn_border_radius_fields, 'bottom', 'desktop' );
			$scndry_btn_border_radius_left   = divino_responsive_spacing( $btn_border_radius_fields, 'left', 'desktop' );
		}
		...
		$secondary_btn_desktop_font_size = is_array( $scndry_theme_btn_font_size ) && isset( $scndry_theme_btn_font_size['desktop'] ) && isset( $scndry_theme_btn_font_size['desktop-unit'] ) ? divino_get_font_css_value( $scndry_theme_btn_font_size['desktop'], $scndry_theme_btn_font_size['desktop-unit'] ) : '';
		/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		...
		$outline_button_css_desktop = array(
			'.editor-styles-wrapper .wp-block-buttons .wp-block-button.is-style-outline .wp-block-button__link, .ast-outline-button' => array(
				...
				'padding-top'                => divino_responsive_spacing( $scndry_theme_btn_padding, 'top', 'desktop' ),
				'padding-right'              => divino_responsive_spacing( $scndry_theme_btn_padding, 'right', 'desktop' ),
				'padding-bottom'             => divino_responsive_spacing( $scndry_theme_btn_padding, 'bottom', 'desktop' ),
				'padding-left'               => divino_responsive_spacing( $scndry_theme_btn_padding, 'left', 'desktop' ),
		...
		if ( $divino_is_block_editor_v2_ui ) {
			$single_post_continer_spacing = divino_get_option( 'single-post-inside-spacing' );
			$divino_continer_left_spacing  = defined( 'divino_EXT_VER' ) && divino_responsive_spacing( $single_post_continer_spacing, 'left', 'desktop' ) ? divino_responsive_spacing( $single_post_continer_spacing, 'left', 'desktop' ) : '6.67em';
			$divino_continer_right_spacing = defined( 'divino_EXT_VER' ) && divino_responsive_spacing( $single_post_continer_spacing, 'right', 'desktop', '6.67' ) ? divino_responsive_spacing( $single_post_continer_spacing, 'right', 'desktop', '6.67' ) : '6.67em';

			$alignwide_left_negative_margin  = $divino_continer_left_spacing ? 'calc(-1 * min(' . $divino_continer_left_spacing . ', 40px))' : '-40px';
			$alignwide_right_negative_margin = $divino_continer_right_spacing ? 'calc(-1 * min(' . $divino_continer_right_spacing . ', 40px))' : '-40px';
			$heading_width_comp              = divino_Dynamic_CSS::divino_4_8_0_compatibility() ? 'none' : 'var(--wp--custom--ast-content-width-size)';
			$container_width_comp            = divino_Dynamic_CSS::divino_4_8_4_compatibility() ? 'var(--wp--custom--ast-content-width-size)' : '';
		...
		$tablet_css = array(
			...
			'.editor-styles-wrapper h1'                    => array(
				'font-size' => divino_responsive_font( $heading_h1_font_size, 'tablet', '30' ),
			),
			'.editor-styles-wrapper h2'                    => array(
				'font-size' => divino_responsive_font( $heading_h2_font_size, 'tablet', '25' ),
			),
			'.editor-styles-wrapper h3'                    => array(
				'font-size' => divino_responsive_font( $heading_h3_font_size, 'tablet', '20' ),
			),
			'.editor-styles-wrapper h4'                    => array(
			...
			'#editor .edit-post-visual-editor'             => divino_get_responsive_background_obj( $site_background, 'tablet' ),
			'.editor-styles-wrapper'                       => divino_get_responsive_background_obj( $content_background, 'tablet' ),
		);
		...
		$mobile_css = array(
			...
			// Heading H1 - H6 font size.
			'.editor-styles-wrapper h1'          => array(
				'font-size' => divino_responsive_font( $heading_h1_font_size, 'mobile', '30' ),
			),
			'.editor-styles-wrapper h2'          => array(
				'font-size' => divino_responsive_font( $heading_h2_font_size, 'mobile', '25' ),
			),
			'.editor-styles-wrapper h3'          => array(
				'font-size' => divino_responsive_font( $heading_h3_font_size, 'mobile', '20' ),
			),
			'.editor-styles-wrapper h4'          => array(
			...
			'#editor .edit-post-visual-editor'   => divino_get_responsive_background_obj( $site_background, 'mobile' ),
			'.editor-styles-wrapper'             => divino_get_responsive_background_obj( $content_background, 'mobile' ),
		);
		...
		$css .= divino_parse_css( $desktop_css );
		/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		$css .= divino_parse_css( $tablet_css, '', divino_get_tablet_breakpoint() );
		/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
		$css .= divino_parse_css( $mobile_css, '', divino_get_mobile_breakpoint() );
		/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
