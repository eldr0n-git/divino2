...
add_filter( 'divino_theme_defaults', 'divino_hf_builder_customizer_defaults' );
 ...
 * @return array
 */
function divino_hf_builder_customizer_defaults( $defaults ) {

	$divino_options                              = divino_Theme_Options::get_divino_options();
	$divino_update_footer_row_vertical_alignment = divino_Dynamic_CSS::divino_4_5_0_compatibility();
	$divino_dark_mode                            = divino_Dynamic_CSS::divino_4_9_0_compatibility();
	$blog_update                                = divino_Dynamic_CSS::divino_4_6_0_compatibility();
	...
	$defaults['hb-header-height']            = array(
		'desktop' => false === divino_check_is_structural_setup() ? 70 : 80,
		'tablet'  => '',
		'mobile'  => '',
	);
	...
	foreach ( $margin_defaults as $margin_default ) {
		$defaults[ $margin_default ] = divino_Builder_Helper::$default_responsive_spacing;
	}

	for ( $index = 1; $index <= divino_Builder_Helper::$component_limit; $index++ ) {

		$defaults = divino_prepare_button_defaults( $defaults, absint( $index ) );
		$defaults = divino_prepare_html_defaults( $defaults, absint( $index ) );
		$defaults = divino_prepare_social_icon_defaults( $defaults, absint( $index ) );
		$defaults = divino_prepare_widget_defaults( $defaults, absint( $index ) );
		$defaults = divino_prepare_menu_defaults( $defaults, absint( $index ) );
		$defaults = divino_prepare_divider_defaults( $defaults, absint( $index ) );
	}

	/**
	 * Header Types - Defaults
	 */
	$defaults['transparent-header-main-sep']       = false === divino_get_transparent_header_default_value() ? '' : 0;
	...
	$defaults['hbb-footer-bg-obj-responsive'] = array(
		'desktop' => array(
			'background-color'      => $apply_new_default_color_typo_values ? ( $reorder_color_seq ? 'var(--ast-global-color-4 )' : 'var(--ast-global-color-5)' ) : ( $divino_dark_mode ? '#eeeeee' : 'var( --ast-global-color-primary, --ast-global-color-4 )' ),
			'background-image'      => '',
			'background-repeat'     => 'repeat',
			'background-position'   => 'center center',
			'background-size'       => 'auto',
	 ...
	 */
	$defaults['hbb-footer-height'] = $divino_update_footer_row_vertical_alignment ? 60 : 80;
	...
	$defaults['hbb-footer-vertical-alignment'] = $divino_update_footer_row_vertical_alignment ? 'center' : 'flex-start';
	...
	$defaults['font-extras-section-footer-copyright'] = array(
		'line-height'         => ! isset( $divino_options['font-extras-section-footer-copyright'] ) && isset( $divino_options['line-height-section-footer-copyright'] ) ? $divino_options['line-height-section-footer-copyright'] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options['font-extras-section-footer-copyright'] ) && isset( $divino_options['text-transform-section-footer-copyright'] ) ? $divino_options['text-transform-section-footer-copyright'] : '',
		'text-decoration'     => '',
	);
	...
	$defaults['footer-menu-font-extras'] = array(
		'line-height'         => ! isset( $divino_options['footer-menu-font-extras'] ) && isset( $divino_options['footer-menu-line-height'] ) ? $divino_options['footer-menu-line-height'] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options['footer-menu-font-extras'] ) && isset( $divino_options['footer-menu-text-transform'] ) ? $divino_options['footer-menu-text-transform'] : '',
		'text-decoration'     => '',
	);
	...
	$mobile_header_toggle_border_radius_fields             = ! isset( $divino_options['mobile-header-toggle-border-radius-fields'] ) && isset( $divino_options['mobile-header-toggle-border-radius'] ) ? $divino_options['mobile-header-toggle-border-radius'] : '';
	 ...
	 */
	$update_colors_for_starter_library = divino_Dynamic_CSS::divino_4_4_0_compatibility();
	$update_color_for_forms_ui         = divino_Dynamic_CSS::divino_4_6_0_compatibility();
	...
	$defaults['font-extras-header-mobile-menu'] = array(
		'line-height'         => ! isset( $divino_options['font-extras-header-mobile-menu'] ) && isset( $divino_options['header-mobile-menu-line-height'] ) ? $divino_options['header-mobile-menu-line-height'] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options['font-extras-header-mobile-menu'] ) && isset( $divino_options['header-mobile-menu-text-transform'] ) ? $divino_options['header-mobile-menu-text-transform'] : '',
		'text-decoration'     => '',
	);
	...
	$woo_header_cart_border_radius                         = ! isset( $divino_options['woo-header-cart-icon-radius-fields'] ) && isset( $divino_options['woo-header-cart-icon-radius'] ) ? $divino_options['woo-header-cart-icon-radius'] : '';
	...
	$defaults['cloned-component-track'] = divino_Builder_Helper::$component_count_array;
 ...
 */
function divino_prepare_divider_defaults( $defaults, $index ) {

	$defaults[ 'section-hb-divider-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
	$defaults[ 'section-fb-divider-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
...
function divino_prepare_button_defaults( $defaults, $index ) {
	...
	$defaults[ 'header-' . $_prefix . '-font-extras' ]          = array(
		'line-height'         => ! isset( $divino_options[ 'header-' . $_prefix . '-font-extras' ] ) && isset( $divino_options[ 'header-' . $_prefix . '-line-height' ] ) ? $divino_options[ 'header-' . $_prefix . '-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options[ 'header-' . $_prefix . '-font-extras' ] ) && isset( $divino_options[ 'header-' . $_prefix . '-text-transform' ] ) ? $divino_options[ 'header-' . $_prefix . '-text-transform' ] : '',
		'text-decoration'     => '',
	);
	...
	$header_button_border_radius_fields                         = ! isset( $divino_options[ 'header-' . $_prefix . '-border-radius-fields' ] ) && isset( $divino_options[ 'header-' . $_prefix . '-border-radius' ] ) ? $divino_options[ 'header-' . $_prefix . '-border-radius' ] : '';
	...
	$divino_4_6_4_compatibility = divino_Dynamic_CSS::divino_4_6_4_compatibility();
	$legacy_hb_button_padding  = $apply_new_default_color_typo_values ? divino_Builder_Helper::$default_button_responsive_spacing : divino_Builder_Helper::$default_responsive_spacing;

	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_top_padding = isset( $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['top'] ) ? $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['top'] : $legacy_hb_button_padding['desktop']['top'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_right_padding = isset( $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['right'] ) ? $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['right'] : $legacy_hb_button_padding['desktop']['right'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_bottom_padding = isset( $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['bottom'] ) ? $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['bottom'] : $legacy_hb_button_padding['desktop']['bottom'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_left_padding = isset( $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['left'] ) ? $divino_options[ 'section-hb-button-' . $index . '-padding' ]['desktop']['left'] : $legacy_hb_button_padding['desktop']['left'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort

	$defaults[ 'section-hb-button-' . $index . '-padding' ]         = array(
		'desktop'      => array(
			'top'    => $divino_4_6_4_compatibility ? 15 : $builder_button_top_padding,
			'right'  => $divino_4_6_4_compatibility ? 30 : $builder_button_right_padding,
			'bottom' => $divino_4_6_4_compatibility ? 15 : $builder_button_bottom_padding,
			'left'   => $divino_4_6_4_compatibility ? 30 : $builder_button_left_padding,
		),
		'tablet'       => array(
			'top'    => '',
			'right'  => '',
	...
	$defaults[ 'header-button' . $index . '-border-radius-fields' ] = array(
		'desktop'      => array(
			'top'    => $divino_4_6_4_compatibility ? 40 : '',
			'right'  => $divino_4_6_4_compatibility ? 40 : '',
			'bottom' => $divino_4_6_4_compatibility ? 40 : '',
			'left'   => $divino_4_6_4_compatibility ? 40 : '',
		),
		'tablet'       => array(
			'top'    => '',
			'right'  => '',
	...
	$defaults[ 'section-hb-button-' . $index . '-margin' ]          = divino_Builder_Helper::$default_responsive_spacing;
	$defaults[ 'sticky-header-button' . $index . '-padding' ]       = divino_Builder_Helper::$default_responsive_spacing;
	...
	$footer_button_border_radius_fields                         = ! isset( $divino_options[ 'footer-' . $_prefix . '-border-radius-fields' ] ) && isset( $divino_options[ 'footer-' . $_prefix . '-border-radius' ] ) ? $divino_options[ 'footer-' . $_prefix . '-border-radius' ] : '';
	...
	$legacy_fb_button_padding = divino_Builder_Helper::$default_responsive_spacing;
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_top_padding = isset( $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['top'] ) ? $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['top'] : $legacy_fb_button_padding['desktop']['top'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_right_padding = isset( $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['right'] ) ? $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['right'] : $legacy_fb_button_padding['desktop']['right'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_bottom_padding = isset( $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['bottom'] ) ? $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['bottom'] : $legacy_fb_button_padding['desktop']['bottom'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	$builder_button_left_padding = isset( $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['left'] ) ? $divino_options[ 'section-fb-button-' . $index . '-padding' ]['desktop']['left'] : $legacy_fb_button_padding['desktop']['left'];
	/** @psalm-suppress PossiblyUndefinedStringArrayOffset */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
	...
	$defaults[ 'section-fb-button-' . $index . '-margin' ]          = divino_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function divino_prepare_html_defaults( $defaults, $index ) {
	...
	$defaults[ 'font-extras-' . $_section ]               = array(
		'line-height'         => ! isset( $divino_options[ 'font-extras-' . $_section ] ) && isset( $divino_options[ 'line-height-' . $_section ] ) ? $divino_options[ 'line-height-' . $_section ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options[ 'font-extras-' . $_section ] ) && isset( $divino_options[ 'text-transform-' . $_section ] ) ? $divino_options[ 'text-transform-' . $_section ] : '',
		'text-decoration'     => '',
	);

	$defaults[ 'section-hb-html-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
	...
	$defaults[ 'section-fb-html-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function divino_prepare_social_icon_defaults( $defaults, $index ) {
	...
	$defaults[ 'header-social-' . $index . '-radius-fields' ]      = array(
		'desktop'      => array(
			'top'    => ! isset( $divino_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $divino_options[ 'header-social-' . $index . '-radius' ],
			'right'  => ! isset( $divino_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $divino_options[ 'header-social-' . $index . '-radius' ],
			'bottom' => ! isset( $divino_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $divino_options[ 'header-social-' . $index . '-radius' ],
			'left'   => ! isset( $divino_options[ 'header-social-' . $index . '-radius' ] ) ? '' : $divino_options[ 'header-social-' . $index . '-radius' ],
		),
		'tablet'       => array(
			'top'    => '',
			'right'  => '',
	...
	$defaults[ 'section-hb-social-icons-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
	...
	$defaults[ 'section-fb-social-icons-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
 ...
 * @param int   $index index.
 */
function divino_prepare_widget_defaults( $defaults, $index ) {
	...
	$defaults[ 'header-widget-' . $index . '-font-extras' ] = array(
		'line-height'         => ! isset( $divino_options[ 'header-widget-' . $index . '-font-extras' ] ) && isset( $divino_options[ 'header-widget-' . $index . '-line-height' ] ) ? $divino_options[ 'header-widget-' . $index . '-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => ! isset( $divino_options[ 'header-widget-' . $index . '-font-extras' ] ) && isset( $divino_options[ 'header-widget-' . $index . '-letter-spacing' ] ) ? $divino_options[ 'header-widget-' . $index . '-letter-spacing' ] : '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options[ 'header-widget-' . $index . '-font-extras' ] ) && isset( $divino_options[ 'header-widget-' . $index . '-text-transform' ] ) ? $divino_options[ 'header-widget-' . $index . '-text-transform' ] : '',
		'text-decoration'     => '',
	);
	...
	$defaults[ 'header-widget-' . $index . '-content-font-extras' ] = array(
		'line-height'         => ! isset( $divino_options[ 'header-widget-' . $index . '-content-font-extras' ] ) && isset( $divino_options[ 'header-widget-' . $index . '-content-line-height' ] ) ? $divino_options[ 'header-widget-' . $index . '-content-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => ! isset( $divino_options[ 'header-widget-' . $index . '-content-font-extras' ] ) && isset( $divino_options[ 'header-widget-' . $index . '-content-letter-spacing' ] ) ? $divino_options[ 'header-widget-' . $index . '-content-letter-spacing' ] : '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options[ 'header-widget-' . $index . '-content-font-extras' ] ) && isset( $divino_options[ 'header-widget-' . $index . '-content-transform' ] ) ? $divino_options[ 'header-widget-' . $index . '-content-transform' ] : '',
		'text-decoration'     => '',
	);

	$defaults[ 'sidebar-widgets-header-widget-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
	...
	$defaults[ 'footer-widget-' . $index . '-content-font-extras' ] = array(
		'line-height'         => ! isset( $divino_options[ 'footer-widget-' . $index . '-content-font-extras' ] ) && isset( $divino_options[ 'footer-widget-' . $index . '-content-line-height' ] ) ? $divino_options[ 'footer-widget-' . $index . '-content-line-height' ] : '',
		'line-height-unit'    => 'em',
		'letter-spacing'      => ! isset( $divino_options[ 'footer-widget-' . $index . '-content-font-extras' ] ) && isset( $divino_options[ 'footer-widget-' . $index . '-content-letter-spacing' ] ) ? $divino_options[ 'footer-widget-' . $index . '-content-letter-spacing' ] : '',
		'letter-spacing-unit' => 'px',
		'text-transform'      => ! isset( $divino_options[ 'footer-widget-' . $index . '-content-font-extras' ] ) && isset( $divino_options[ 'footer-widget-' . $index . '-content-transform' ] ) ? $divino_options[ 'footer-widget-' . $index . '-content-transform' ] : '',
		'text-decoration'     => '',
	);
	...
	$defaults[ 'sidebar-widgets-footer-widget-' . $index . '-margin' ] = divino_Builder_Helper::$default_responsive_spacing;
...
function divino_prepare_menu_defaults( $defaults, $index ) {
	...
	$defaults[ 'section-hb-menu-' . $index . '-margin' ]  = divino_Builder_Helper::$default_responsive_spacing;
	$defaults[ 'header-menu' . $index . '-menu-spacing' ] = divino_Builder_Helper::$default_responsive_spacing;
	...
	$header_button_submenu_border_radius_fields                         = ! isset( $divino_options[ 'header-' . $_prefix . '-submenu-border-radius-fields' ] ) && isset( $divino_options[ 'header-' . $_prefix . '-submenu-border-radius' ] ) ? $divino_options[ 'header-' . $_prefix . '-submenu-border-radius' ] : '';
