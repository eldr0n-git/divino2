...
define( 'divino_BUILDER_FOOTER_MENU_DIR', divino_THEME_DIR . 'inc/builder/type/footer/menu' );
define( 'divino_BUILDER_FOOTER_MENU_URI', divino_THEME_URI . 'inc/builder/type/footer/menu' );
 ...
 * @since 3.0.0
 */
class divino_Footer_Menu_Component {
	/**
	...
	public function __construct() {
		...
		if ( ! is_admin() || divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
			require_once divino_BUILDER_FOOTER_MENU_DIR . '/dynamic-css/dynamic.css.php';
		}
	...
	public static function menu_markup() {
		...
		$menu_layout               = divino_get_option( 'footer-menu-layout' );
		 ...
		 * @var Array
		 */
		$menu_classes = apply_filters( 'divino_menu_classes', array( 'ast-nav-menu', 'ast-flex', $desktop_menu_layout_class, $tablet_menu_layout_class, $mobile_menu_layout_class ) );
 ...
 */
new divino_Footer_Menu_Component();
