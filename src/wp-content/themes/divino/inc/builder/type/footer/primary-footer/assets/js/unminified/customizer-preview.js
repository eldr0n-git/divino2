...
( function( $ ) {
	...
	wp.customize( 'astra-settings[hb-footer-layout-width]', function( setting ) {
		setting.bind( function( layout ) {
			...
			divino_add_dynamic_css( 'hb-footer-layout-width', dynamicStyle );
	...
	wp.customize( 'astra-settings[hb-inner-spacing]', function( value ) {
		value.bind( function( spacing ) {
			...
			divino_add_dynamic_css( 'hb-inner-spacing-toggle-button', dynamicStyle );
		} );
	} );
	...
	divino_builder_advanced_css( 'section-footer-builder-layout', '.ast-hfb-header .site-footer' );
