 ...
 * Below Footer CSS
 */
add_filter( 'divino_dynamic_theme_css', 'divino_fb_below_footer_dynamic_css' );
 ...
 * @since 3.0.0
 */
function divino_fb_below_footer_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! ( divino_Builder_Helper::is_footer_row_empty( 'below' ) || is_customize_preview() ) ) {
		return $dynamic_css;
	}
	...
	$footer_bg               = divino_get_option( 'hbb-footer-bg-obj-responsive' );
	$footer_height           = divino_get_option( 'hbb-footer-height' );
	$footer_top_border_size  = divino_get_option( 'hbb-footer-separator' );
	$footer_top_border_color = divino_get_option( 'hbb-footer-top-border-color' );
	$footer_width            = divino_get_option( 'hbb-footer-layout-width' );
	$content_width           = divino_get_option( 'site-content-width' );
	$inner_spacing           = divino_get_option( 'hbb-inner-spacing' );
	...
	$css_output_desktop = array(
		...
		$selector . ' .ast-builder-grid-row, ' . $selector . ' .site-footer-section' => array(
			'align-items' => divino_get_option( 'hbb-footer-vertical-alignment' ),
		),
