 ...
 * Footer Menu Colors
 */
add_filter( 'divino_dynamic_theme_css', 'divino_hb_footer_menu_dynamic_css', 11 );
 ...
 * @since 3.0.0
 */
function divino_hb_footer_menu_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! divino_Builder_Helper::is_component_loaded( 'menu', 'footer' ) ) {
		return $dynamic_css;
	}
	...
	// Menu.
	$menu_resp_color           = divino_get_option( 'footer-menu-color-responsive' );
	$menu_resp_bg_color        = divino_get_option( 'footer-menu-bg-obj-responsive' );
	$menu_resp_color_hover     = divino_get_option( 'footer-menu-h-color-responsive' );
	$menu_resp_bg_color_hover  = divino_get_option( 'footer-menu-h-bg-color-responsive' );
	$menu_resp_color_active    = divino_get_option( 'footer-menu-a-color-responsive' );
	$menu_resp_bg_color_active = divino_get_option( 'footer-menu-a-bg-color-responsive' );

	$alignment = divino_get_option( 'footer-menu-alignment' );
	...
	// Typography.
	$menu_font_size = divino_get_option( 'footer-menu-font-size' );
	...
	// Menu Spacing.
	$menu_spacing = divino_get_option( 'footer-main-menu-spacing' );
	...
	$css_output_desktop = array(
		...
		$selector . ' .menu-item > a'                   => array(
			...
			'padding-top'    => divino_get_css_value( $menu_desktop_spacing_top, $menu_desktop_spacing_unit ),
			'padding-bottom' => divino_get_css_value( $menu_desktop_spacing_bottom, $menu_desktop_spacing_unit ),
			'padding-left'   => divino_get_css_value( $menu_desktop_spacing_left, $menu_desktop_spacing_unit ),
			'padding-right'  => divino_get_css_value( $menu_desktop_spacing_right, $menu_desktop_spacing_unit ),
		),
	...
	$css_output_tablet = array(
		...
		$selector . ' .menu-item > a'                   => array(
			...
			'padding-top'    => divino_get_css_value( $menu_tablet_spacing_top, $menu_tablet_spacing_unit ),
			'padding-bottom' => divino_get_css_value( $menu_tablet_spacing_bottom, $menu_tablet_spacing_unit ),
			'padding-left'   => divino_get_css_value( $menu_tablet_spacing_left, $menu_tablet_spacing_unit ),
			'padding-right'  => divino_get_css_value( $menu_tablet_spacing_right, $menu_tablet_spacing_unit ),
		),
		$selector . ' .menu-item:hover > a'             => array(
	...
	$arr_footer_ul_mobile = array_merge( $arr_footer_ul_mobile, divino_get_responsive_background_obj( $menu_resp_bg_color, 'mobile' ) );
	...
	$css_output_mobile = array(
		...
		$selector . ' .menu-item > a'                   => array(
			...
			'padding-top'    => divino_get_css_value( $menu_mobile_spacing_top, $menu_mobile_spacing_unit ),
			'padding-bottom' => divino_get_css_value( $menu_mobile_spacing_bottom, $menu_mobile_spacing_unit ),
			'padding-left'   => divino_get_css_value( $menu_mobile_spacing_left, $menu_mobile_spacing_unit ),
			'padding-right'  => divino_get_css_value( $menu_mobile_spacing_right, $menu_mobile_spacing_unit ),
		),
		$selector . ' .menu-item:hover > a'             => array(
	...
	$css_output  = divino_footer_menu_static_css();
	...
	$dynamic_css .= divino_Builder_Base_Dynamic_CSS::prepare_visibility_css( $_section, $visibility_selector, 'block' );
...
function divino_footer_menu_static_css() {
	...
	return divino_Enqueue_Scripts::trim_css( $footer_menu_css );
}
