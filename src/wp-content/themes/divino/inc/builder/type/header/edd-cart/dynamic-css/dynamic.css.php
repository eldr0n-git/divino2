 ...
 * Search
 */
add_filter( 'divino_dynamic_theme_css', 'divino_hb_edd_cart_dynamic_css' );
 ...
 * @since 3.0.0
 */
function divino_hb_edd_cart_dynamic_css( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! divino_Builder_Helper::is_component_loaded( 'edd-cart', 'header' ) ) {
		return $dynamic_css;
	}
	...
	$header_cart_icon_color     = divino_get_option( 'edd-header-cart-icon-color', $theme_color );
	$header_cart_icon_radius    = divino_get_option( 'edd-header-cart-icon-radius' );
	$cart_h_color               = divino_get_foreground_color( $header_cart_icon_color );

	$trans_header_cart_icon_color = divino_get_option( 'transparent-header-edd-cart-icon-color', $theme_color );
	$trans_header_cart_h_color    = divino_get_foreground_color( $trans_header_cart_icon_color );
	 ...
	 * - EDD cart styles.
	 */
	$cart_text_color      = divino_get_option( 'header-edd-cart-text-color' );
	$cart_link_color      = divino_get_option( 'header-edd-cart-link-color', $link_color );
	$cart_bg_color        = divino_get_option( 'header-edd-cart-background-color' );
	$cart_separator_color = divino_get_option( 'header-edd-cart-separator-color' );

	$checkout_button_text_color   = divino_get_option( 'header-edd-checkout-btn-text-color', $btn_color );
	$checkout_button_bg_color     = divino_get_option( 'header-edd-checkout-btn-background-color', $btn_bg_color );
	$checkout_button_text_h_color = divino_get_option( 'header-edd-checkout-btn-text-hover-color', $btn_color );
	$checkout_button_bg_h_color   = divino_get_option( 'header-edd-checkout-btn-bg-hover-color', $btn_bg_color );
	...
	if ( 'none' !== $header_cart_icon_style ) {
		...
		$header_cart_icon = array(
			...
			$selector . ' .ast-edd-cart-menu-wrap .count' => array(
				'color'        => esc_attr( divino_get_option( 'edd-header-cart-icon-color' ) ),
				'border-color' => esc_attr( divino_get_option( 'edd-header-cart-icon-color' ) ),
			),
			...
			$trans_header_cart_selector . ' .ast-edd-cart-menu-wrap .count' => array(
				'color'        => esc_attr( divino_get_option( 'transparent-header-edd-cart-icon-color' ) ),
				'border-color' => esc_attr( divino_get_option( 'transparent-header-edd-cart-icon-color' ) ),
			),
			...
			'.ast-edd-site-header-cart.ast-edd-menu-cart-outline .ast-addon-cart-wrap, .ast-edd-site-header-cart.ast-edd-menu-cart-fill .ast-addon-cart-wrap, .ast-edd-site-header-cart.ast-edd-menu-cart-outline .count, .ast-edd-site-header-cart.ast-edd-menu-cart-fill .count, .ast-edd-site-header-cart.ast-edd-menu-cart-outline .ast-addon-cart-wrap .ast-edd-header-cart-info-wrap, .ast-edd-site-header-cart.ast-edd-menu-cart-fill .ast-addon-cart-wrap .ast-edd-header-cart-info-wrap' => array(
				'border-radius' => divino_get_css_value( $header_cart_icon_radius, 'px' ),
			),
		);
		...
		$header_cart_icon = divino_parse_css( $header_cart_icon );
	}

	/* Parse CSS from array() */
	$css_output .= $header_cart_icon;

	$css_output .= divino_Builder_Base_Dynamic_CSS::prepare_visibility_css( 'section-header-edd-cart', '.ast-header-edd-cart' );
