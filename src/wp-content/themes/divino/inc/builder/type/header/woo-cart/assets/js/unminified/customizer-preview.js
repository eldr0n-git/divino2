...
(function ($) {
	...
	var responsive_selector = '.divino-cart-drawer';
	const appendSelector = '.woocommerce-js ';
	var tablet_break_point = divinoBuilderCartPreview.tablet_break_point || 768,
		mobile_break_point = divinoBuilderCartPreview.mobile_break_point || 544;

	// Icon Color.
	divino_css(
		'divino-settings[header-woo-cart-icon-color]',
		'color',
	...
	divino_color_responsive_css(
		'woo-cart-link-color',
		'divino-settings[header-woo-cart-link-color]',
		'color',
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-background-color]',
		'background-color',
		'.ast-site-header-cart .widget_shopping_cart, .divino-cart-drawer'
	);
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-background-color]',
		'border-bottom-color',
		'.ast-site-header-cart .widget_shopping_cart:before, .ast-site-header-cart .widget_shopping_cart:after, .open-preview-woocommerce-cart .ast-site-header-cart .widget_shopping_cart:before, #divino-mobile-cart-drawer, .divino-cart-drawer'
	);

	// Added Background Color Hover
	divino_color_responsive_css(
		'woo-cart-background-hover-color',
		'divino-settings[header-woo-cart-background-hover-color]',
		'background-color',
		'.ast-site-header-cart .widget_shopping_cart:hover, #divino-mobile-cart-drawer:hover'
	);
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-background-hover-color]',
		'border-bottom-color',
		'.ast-site-header-cart .widget_shopping_cart:hover,site-header-cart .widget_shopping_cart:hover:after, #divino-mobile-cart-drawer:hover,.ast-site-header-cart:hover .widget_shopping_cart:hover:before, .ast-site-header-cart:hover .widget_shopping_cart:hover:after, .open-preview-woocommerce-cart .ast-site-header-cart .widget_shopping_cart:hover:before'
	);
	divino_color_responsive_css(
		'woo-cart-separator-colors',
		'divino-settings[header-woo-cart-separator-color]',
		'border-top-color',
		'.ast-site-header-cart .widget_shopping_cart .woocommerce-mini-cart__total, #divino-mobile-cart-drawer .widget_shopping_cart .woocommerce-mini-cart__total, .divino-cart-drawer .divino-cart-drawer-header'
	);
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-separator-color]',
		'border-bottom-color',
		'.ast-site-header-cart .widget_shopping_cart .woocommerce-mini-cart__total, #divino-mobile-cart-drawer .widget_shopping_cart .woocommerce-mini-cart__total, .divino-cart-drawer .divino-cart-drawer-header, .ast-site-header-cart .widget_shopping_cart .mini_cart_item, #divino-mobile-cart-drawer .widget_shopping_cart .mini_cart_item'
	);

	divino_color_responsive_css(
		'woo-cart-link-hover-colors',
		'divino-settings[header-woo-cart-link-hover-color]',
		'color',
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-btn-text-color]',
		'color',
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-btn-background-color]',
		'background-color',
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-btn-text-hover-color]',
		'color',
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-cart-btn-bg-hover-color]',
		'background-color',
		selector + ' .ast-site-header-cart-data .widget_shopping_cart_content .woocommerce-mini-cart__buttons a.button.wc-forward:not(.checkout):hover,' + appendSelector + responsive_selector + ' .widget_shopping_cart_content .woocommerce-mini-cart__buttons a.button.wc-forward:not(.checkout):hover'
	);
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-checkout-btn-text-color]',
		'color',
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-checkout-btn-background-color]',
		'border-color',
		selector + ' .ast-site-header-cart-data .widget_shopping_cart_content .woocommerce-mini-cart__buttons a.button.checkout.wc-forward,' + responsive_selector + ' .widget_shopping_cart_content .woocommerce-mini-cart__buttons a.button.checkout.wc-forward'
	);
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-checkout-btn-text-hover-color]',
		'color',
	...
	divino_color_responsive_css(
		...
		'divino-settings[header-woo-checkout-btn-bg-hover-color]',
		'background-color',
		selector + ' .ast-site-header-cart-data .widget_shopping_cart_content .woocommerce-mini-cart__buttons a.button.checkout.wc-forward:hover,' + responsive_selector + ' .widget_shopping_cart_content .woocommerce-mini-cart__buttons a.button.checkout.wc-forward:hover'
	);
	 ...
	 * Cart icon style
	 */
	wp.customize('divino-settings[woo-header-cart-icon-style]', function (setting) {
		setting.bind(function (icon_style) {
			...
			divino_add_dynamic_css('woo-header-cart-icon-style', dynamicStyle);
	 ...
	 */
	 wp.customize( 'divino-settings[woo-slide-in-cart-width]', function( setting ) {
		setting.bind( function( wooSlideInConfig ) {
			...
			const offcanvasPosition = wp.customize( 'divino-settings[woo-desktop-cart-flyout-direction]' ).get();

			if( 'left' == offcanvasPosition ) {
				var dynamicStyle = '.ast-desktop .divino-cart-drawer { width: ' + desktop + desktopUnit + '; left: -' + desktop + desktopUnit + '; } ';
					dynamicStyle += '.ast-desktop .divino-cart-drawer.active { left: ' + desktop + desktopUnit + '; } ';
			} else {
				var dynamicStyle = '.ast-desktop .divino-cart-drawer { width: ' + desktop + desktopUnit + '; left: 100%; } ';
			}

			//Tablets.
			dynamicStyle += '@media (max-width: ' + tablet_break_point + 'px ) and ( min-width: ' + mobile_break_point + 'px) {';
			dynamicStyle += '#divino-mobile-cart-drawer {';
			...
			if( desktop > 500 ) {
				$( '#divino-mobile-cart-drawer .divino-cart-drawer-content' ).addClass('ast-large-view');
			} else {
				$( '#divino-mobile-cart-drawer .divino-cart-drawer-content' ).removeClass('ast-large-view');
			}
			divino_add_dynamic_css( 'woo-slide-in-cart-width', dynamicStyle );
		} );
	} );
	 ...
	 * Cart icon type
	 */
	wp.customize( 'divino-settings[woo-header-cart-icon]', function( setting ) {
	 ...
	 */
	wp.customize('divino-settings[header-woo-cart-icon-hover-color]', function (setting) {
	 ...
	 * Cart icon style
	 */
	wp.customize('divino-settings[header-woo-cart-icon-color]', function (setting) {
		setting.bind(function (color) {
			...
			divino_add_dynamic_css('header-woo-cart-icon-color', dynamicStyle);
			wp.customize.preview.send('refresh');
		});
	});
	 ...
	 * Cart Border Width.
	 */
	divino_css( 'divino-settings[woo-header-cart-border-width]', 'border-width', '.ast-menu-cart-outline .ast-addon-cart-wrap, .ast-theme-transparent-header .ast-menu-cart-outline .ast-addon-cart-wrap', 'px' );

	/**
	 * Cart Border Radius Fields
	 */
	wp.customize('divino-settings[woo-header-cart-icon-radius-fields]', function (setting) {
		setting.bind(function (border) {
			...
			divino_add_dynamic_css('woo-header-cart-icon-radius-fields', dynamicStyle);
		});
	});
	 ...
	 */
	wp.customize('divino-settings[transparent-header-woo-cart-icon-color]', function (setting) {
     ...
     */
	 wp.customize('divino-settings[woo-header-cart-icon-total-label-position]', function (setting) {
		setting.bind(function (position) {
			...
			var dynamicStyle = '.cart-container, .ast-addon-cart-wrap {display : flex; align-items : center; padding-top: 7px; padding-bottom: 5px;} ';
				dynamicStyle += '.divino-icon {line-height : 0.1;} ';
				var tablet_break_point = divinoBuilderCartPreview.tablet_break_point || 768,
				mobile_break_point = divinoBuilderCartPreview.mobile_break_point || 544;
				if( position.desktop ){
			...
			divino_add_dynamic_css( 'woo-header-cart-icon-total-label-position', dynamicStyle );
		});
	});

	// Advanced CSS Generation for cart padding and margin.
	divino_builder_advanced_css( 'section-header-woo-cart', '.woocommerce .ast-header-woo-cart .ast-site-header-cart .ast-addon-cart-wrap, .ast-header-woo-cart .ast-site-header-cart .ast-addon-cart-wrap' );

	// Advanced Visibility CSS Generation.
	divino_builder_visibility_css('section-header-woo-cart', '.ast-header-woo-cart');

	// Icon Size.
	wp.customize('divino-settings[header-woo-cart-icon-size]', function (value) {
		value.bind(function (size) {
			if (size.desktop != '' || size.tablet != '' || size.mobile != '') {
				...
				dynamicStyle += '.ast-cart-menu-wrap, .ast-site-header-cart i.divino-icon {';
				dynamicStyle += 'font-size: ' + size.desktop + 'px' + ';';
				dynamicStyle += '} ';
				dynamicStyle += '@media (max-width: ' + tablet_break_point + 'px) {';
				dynamicStyle += '.ast-header-break-point.ast-hfb-header .ast-cart-menu-wrap, .ast-site-header-cart i.divino-icon {';
	 ...
	 * Cart Badge
	 */
	 wp.customize('divino-settings[woo-header-cart-badge-display]', function (setting) {
		setting.bind(function (badge) {
			if (!badge) {
				var dynamicStyle = '.divino-icon.divino-icon::after {  display:none; } ';
				dynamicStyle += '.ast-count-text {  display:none; } ';
			} else {
				var dynamicStyle = '.divino-icon.divino-icon::after {  display:block; } ';
				dynamicStyle += '.ast-count-text {  display:block; } ';
			}
			divino_add_dynamic_css('woo-header-cart-badge-display', dynamicStyle);
		});
	});
	 ...
	 */
	wp.customize( 'divino-settings[woo-header-cart-total-label]', function( setting ) {
