...
( function( $ ) {
     ...
     */
		...
		divino_font_extras_css( 'font-extras-header-mobile-menu', '.ast-builder-menu-mobile .main-navigation .menu-item > .menu-link' );
        ...
        (function () {
            ...
            wp.customize( 'astra-settings[header-mobile-menu-submenu-item-b-size]', function( value ) {
                value.bind( function( borderSize ) {
                    ...
                    dynamicStyle += '} ';
                    divino_add_dynamic_css( 'header-mobile-menu-submenu-item-b-size', dynamicStyle );
                } );
            } );
            ...
            wp.customize( 'astra-settings[header-mobile-menu-submenu-border]', function( setting ) {
                setting.bind( function( border ) {
                    ...
                    dynamicStyle += '}';
                    divino_add_dynamic_css( 'header-mobile-menu-submenu-border', dynamicStyle );
            ...
            wp.customize( 'astra-settings[header-mobile-menu-menu-spacing]', function( value ) {
                value.bind( function( padding ) {
                    ...
                    divino_add_dynamic_css( 'header-mobile-menu-menu-spacing-toggle-button', dynamicStyle );
                } );
            } );
            ...
            wp.customize( 'astra-settings[section-header-mobile-menu-margin]', function( value ) {
                value.bind( function( margin ) {
                    ...
                    dynamicStyle += '} ';
                    dynamicStyle += '} ';
                    divino_add_dynamic_css( 'section-header-mobile-menu-margin', dynamicStyle );
                } );
            } );
                ...
                value.bind(function (color) {
                    ...
                    if ('' != color) {
                        if ( true == insideBorder ) {
                            ...
                            divino_add_dynamic_css('header-mobile-menu-submenu-item-b-color', dynamicStyle);
                        } else {
            ...
            wp.customize( 'astra-settings[header-mobile-menu-submenu-item-border]', function( value ) {
                value.bind( function( border ) {
                    ...
                    if( true === border  ) {
                        ...
                        divino_add_dynamic_css( 'header-mobile-menu-submenu-item-border', dynamicStyle );
                    } else {
                        wp.customize.preview.send( 'refresh' );
                    }
