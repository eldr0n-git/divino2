...
( function( $ ) {
	...
	wp.customize( 'astra-settings[hbb-header-height]', function( value ) {
		value.bind( function( size ) {
			...
			if( size.desktop != '' || size.tablet != '' || size.mobile != '' ) {
				...
				divino_add_dynamic_css( 'hbb-header-height', dynamicStyle );
			}
		} );
	} );
	...
	wp.customize( 'astra-settings[hbb-header-separator]', function( value ) {
		value.bind( function( border ) {
			...
			divino_add_dynamic_css( 'hbb-header-separator', dynamicStyle );
	...
	divino_builder_advanced_css( 'section-below-header-builder', '.ast-below-header.ast-below-header-bar' );

    // Advanced Visibility CSS Generation.
	divino_builder_visibility_css( 'section-below-header-builder', '.ast-below-header-bar', 'grid' );
