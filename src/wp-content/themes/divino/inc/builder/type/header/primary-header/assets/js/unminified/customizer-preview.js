...
( function( $ ) {
	...
	wp.customize( 'divino-settings[hb-header-height]', function( value ) {
		value.bind( function( size ) {
			...
			if( size.desktop != '' || size.tablet != '' || size.mobile != '' ) {
				...
				divino_add_dynamic_css( 'hb-header-height', dynamicStyle );
			}
		} );
	} );
	...
	wp.customize( 'divino-settings[hb-header-main-layout-width]', function( setting ) {
		setting.bind( function( layout ) {
			...
			divino_add_dynamic_css( 'hb-header-main-layout-width', dynamicStyle );
		} );
	} );
	...
	wp.customize( 'divino-settings[hb-header-main-sep]', function( value ) {
		value.bind( function( border ) {
			...
			divino_add_dynamic_css( 'hb-header-main-sep', dynamicStyle );
	...
	divino_builder_advanced_css( 'section-primary-header-builder', '.ast-desktop .ast-primary-header-bar, .ast-header-break-point .ast-primary-header-bar' );
	...
	wp.customize( 'divino-settings[section-header-builder-layout-margin]', function( value ) {
        value.bind( function( margin ) {
            if(
                ...
                dynamicStyle += '} ';
                dynamicStyle += '} ';
                divino_add_dynamic_css( 'section-header-builder-layout-margin-toggle-button', dynamicStyle );
            }
        } );
    } );
