 ...
 * Below Header Row.
 */
add_filter( 'divino_dynamic_theme_css', 'divino_below_header_row_setting', 11 );
 ...
 * @since 3.0.0
 */
function divino_below_header_row_setting( $dynamic_css, $dynamic_css_filtered = '' ) {

	if ( ! is_customize_preview() && ( ! divino_Builder_Helper::is_row_empty( 'below', 'header', 'desktop' ) && ! divino_Builder_Helper::is_row_empty( 'below', 'header', 'mobile' ) ) ) {
		return $dynamic_css;
	}
	...
	// Common CSS options.
	$hbb_header_height  = divino_get_option( 'hbb-header-height' );
	$hbb_header_divider = divino_get_option( 'hbb-header-separator' );
	$hbb_border_color   = divino_get_option( 'hbb-header-bottom-border-color' );
	...
	$common_css_output = array(
		...
		'.ast-mobile-header-wrap .ast-below-header-bar , .ast-below-header-bar .site-below-header-wrap' => array(
			'min-height' => divino_get_css_value( $hbb_header_height_desktop, 'px' ),
		),
		'.ast-desktop .ast-below-header-bar .main-header-menu > .menu-item' => array(
			'line-height' => divino_get_css_value( $hbb_header_height_desktop, 'px' ),
		),
	...
	if ( '' !== $hbb_header_divider && 'inherit' !== $hbb_header_divider ) {
		$common_css_output['.ast-below-header-bar'] = array(
			'border-bottom-width' => divino_get_css_value( $hbb_header_divider, 'px' ),
	...
	$desktop_bg = array(
		'.ast-below-header-bar'                         => divino_get_responsive_background_obj( $hbb_header_bg_obj, 'desktop' ),
	...
	$tablet_bg  = array(
		'.ast-below-header-bar'                         => divino_get_responsive_background_obj( $hbb_header_bg_obj, 'tablet' ),
		'.ast-header-break-point .ast-below-header-bar' => array(
			'background-color' => esc_attr( $tablet_background ),
		),
		'.ast-mobile-header-wrap .ast-below-header-bar , .ast-below-header-bar .site-below-header-wrap' => array(
			'min-height' => divino_get_css_value( $hbb_header_height_tablet, 'px' ),
		),
	);
	...
	$mobile_bg  = array(
		'.ast-below-header-bar'                         => divino_get_responsive_background_obj( $hbb_header_bg_obj, 'mobile' ),
		'.ast-header-break-point .ast-below-header-bar' => array(
			'background-color' => esc_attr( $mobile_background ),
		),
		'.ast-mobile-header-wrap .ast-below-header-bar , .ast-below-header-bar .site-below-header-wrap' => array(
			'min-height' => divino_get_css_value( $hbb_header_height_mobile, 'px' ),
		),
	);
	...
	$dynamic_css .= divino_Builder_Base_Dynamic_CSS::prepare_visibility_css( $_section, '.ast-below-header-bar', 'block', 'grid' );
