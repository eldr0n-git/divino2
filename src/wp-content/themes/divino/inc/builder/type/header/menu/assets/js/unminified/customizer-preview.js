...
( function( $ ) {
	...
	for ( var index = 1; index <= AstraBuilderMenuData.component_limit; index++ ) {
		...
		divino_builder_visibility_css( section, selector );
			...
			(function (index) {
				...
				wp.customize( 'astra-settings[header-menu'+ index +'-submenu-border]', function( setting ) {
					setting.bind( function( border ) {
						...
						divino_add_dynamic_css( 'header-menu'+ index +'-submenu-border', dynamicStyle );
				...
				wp.customize( 'astra-settings[header-menu'+ index +'-menu-spacing]', function( value ) {
					value.bind( function( padding ) {
						...
						divino_add_dynamic_css( 'header-menu'+ index +'-menu-spacing-toggle-button', dynamicStyle );
					} );
				} );
				...
				wp.customize( 'astra-settings[section-hb-menu-'+ index +'-margin]', function( value ) {
					value.bind( function( margin ) {
						...
						dynamicStyle += '} ';
						dynamicStyle += '} ';
						divino_add_dynamic_css( 'section-hb-menu-'+ index +'-margin', dynamicStyle );
					} );
				} );
					...
					value.bind(function (color) {
						...
						if ('' != color) {
							if ( true == insideBorder ) {
								...
								divino_add_dynamic_css('header-menu'+ index +'-submenu-item-b-color', dynamicStyle);
							}
						} else {
				...
				wp.customize( 'astra-settings[header-menu'+ index +'-submenu-item-b-size]', function( value ) {
					value.bind( function( borderSize ) {
						...
						dynamicStyle += '} ';
						divino_add_dynamic_css( 'header-menu'+ index +'-submenu-item-b-size', dynamicStyle );
					} );
				} );
				...
				wp.customize( 'astra-settings[header-menu'+ index +'-submenu-item-border]', function( value ) {
					value.bind( function( border ) {
						...
						divino_add_dynamic_css( 'header-menu'+ index +'-submenu-item-border', dynamicStyle );
				...
				wp.customize( 'astra-settings[header-menu'+ index +'-submenu-border-radius-fields]', function( value ) {
					value.bind( function( border ) {
						...
						divino_add_dynamic_css( 'header-menu'+ index +'-submenu-border-radius-fields', dynamicStyle );
				...
				wp.customize( 'astra-settings[header-menu'+ index +'-submenu-top-offset]', function( value ) {
					value.bind( function( offset ) {
						...
						divino_add_dynamic_css( 'header-menu'+ index +'-submenu-top-offset', dynamicStyle );
				...
				wp.customize( 'astra-settings[header-menu'+ index +'-submenu-width]', function( value ) {
					value.bind( function( width ) {
						...
						divino_add_dynamic_css( 'header-menu'+ index +'-submenu-width', dynamicStyle );

					} );
				} );

				// Sub menu
				divino_font_extras_css( 'header-menu' + index + '-font-extras', '.ast-builder-menu-' + index + ' .menu-item > .menu-link' );
