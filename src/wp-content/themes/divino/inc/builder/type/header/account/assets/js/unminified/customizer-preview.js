...
( function( $ ) {
	...
	wp.customize( 'astra-settings[header-account-icon-color]', function( value ) {
		value.bind( function( color ) {
			...
			dynamicStyle += '} ';
			divino_add_dynamic_css( 'header-account-icon-color', dynamicStyle );
		} );
	} );
	...
	wp.customize( 'astra-settings[header-account-icon-size]', function( value ) {
		value.bind( function( size ) {
			if( size.desktop != '' || size.tablet != '' || size.mobile != '' ) {
				...
				dynamicStyle += '} ';
				dynamicStyle += '} ';
				divino_add_dynamic_css( 'header-account-icon-size', dynamicStyle );
			}
		} );
	} );
	...
	wp.customize( 'astra-settings[header-account-image-width]', function( value ) {
		value.bind( function( size ) {
			if( size.desktop != '' || size.tablet != '' || size.mobile != '' ) {
				...
				dynamicStyle += '} ';
				dynamicStyle += '} ';
				divino_add_dynamic_css( 'header-account-image-width', dynamicStyle );
			}
		} );
	} );
    ...
    wp.customize( 'astra-settings[header-account-margin]', function( value ) {
        value.bind( function( margin ) {
            if(
                ...
                dynamicStyle += '} ';
                dynamicStyle += '} ';
                divino_add_dynamic_css( 'header-account-margin', dynamicStyle );
            }
        } );
	} );

	// Advanced Visibility CSS Generation.
	divino_builder_visibility_css( section, visibility_selector );
