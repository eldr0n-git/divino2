...
class divino_Header_Search_Component_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-header-builder-search-customizer-preview-js', divino_HEADER_SEARCH_URI . '/assets/js/' . $dir_name . '/customizer-preview' . $file_prefix . '.js', array( 'customize-preview', 'astra-customizer-preview-js' ), divino_THEME_VERSION, true );
	}
