...
class divino_Header_Widget_Component_Loader {
	...
	public function preview_scripts() {
		...
		wp_enqueue_script( 'astra-header-widget-customizer-preview-js', divino_BUILDER_HEADER_WIDGET_URI . '/assets/js/' . $dir_name . '/customizer-preview' . $file_prefix . '.js', array( 'customize-preview', 'astra-customizer-preview-js' ), divino_THEME_VERSION, true );
