...
define( 'divino_BUILDER_MOBILE_MENU_DIR', divino_THEME_DIR . 'inc/builder/type/header/mobile-menu' );
define( 'divino_BUILDER_MOBILE_MENU_URI', divino_THEME_URI . 'inc/builder/type/header/mobile-menu' );
 ...
 * @since 3.0.0
 */
class divino_Mobile_Menu_Component {
	/**
	...
	public function __construct() {
		...
		if ( ! is_admin() || divino_Builder_Customizer::divino_collect_customizer_builder_data() ) {
			require_once divino_BUILDER_MOBILE_MENU_DIR . '/dynamic-css/dynamic.css.php';
		}
	...
	public static function menu_markup( $device = 'mobile' ) {
		 ...
		 * @var Array
		 */
		$menu_classes = apply_filters( 'divino_primary_menu_classes', array( 'main-header-menu', 'ast-nav-menu', 'ast-flex', $submenu_class, $stack_on_mobile_class ) );
		...
		if ( has_nav_menu( $theme_location ) ) {
			...
			$mobile_menu_markup = $divino_builder->nofollow_markup( $theme_location, $mobile_menu_markup );
 ...
 */
new divino_Mobile_Menu_Component();
