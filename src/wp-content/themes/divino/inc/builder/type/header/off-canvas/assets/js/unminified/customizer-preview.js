...
( function( $ ) {
	...
	wp.customize( 'divino-settings[off-canvas-inner-spacing]', function ( value ) {
        value.bind( function ( spacing ) {
			...
			divino_add_dynamic_css( 'off-canvas-inner-spacing', dynamicStyle );
        } );
	} );
    ...
    wp.customize( 'divino-settings[off-canvas-padding]', function( value ) {
        value.bind( function( padding ) {
            if(
                ...
                dynamicStyle += '} ';
                dynamicStyle += '} ';
                divino_add_dynamic_css( 'off-canvas-padding', dynamicStyle );
            } else {
                divino_add_dynamic_css( 'off-canvas-padding', '' );
            }
		} );
	} );
	...
	wp.customize( 'divino-settings[header-offcanvas-content-alignment]', function ( value ) {
        value.bind( function ( newval ) {
			...
			divino_add_dynamic_css( 'header-offcanvas-content-alignment', dynamicStyle );
        } );
	} );
