 ...
 *
 */
function divino_builder_html_css( builder_type = 'header', html_count ) {
...
function divino_builder_button_css( builder_type = 'header', button_count ) {
	...
	for ( var index = 1; index <= button_count; index++ ) {
		...
		divino_css( 'flex', 'display', '.ast-' + builder_type + '-button-' + index + '[data-section="' + section + '"]' );
		...
		divino_font_extras_css( builder_type + '-' + prefix + '-font-extras', button_selector + ' .ast-custom-button' );
		...
		divino_builder_advanced_css( section, button_selector + ' .ast-custom-button' );
				...
				wp.customize( 'astra-settings[footer-button-'+ index +'-alignment]', function( value ) {
					value.bind( function( alignment ) {
						...
						if( alignment.desktop != '' || alignment.tablet != '' || alignment.mobile != '' ) {
							...
							divino_add_dynamic_css( 'footer-button-'+ index +'-alignment', dynamicStyle );
						}
					} );
				} );
			}
	...
	for ( var index = 1; index <= social_count; index++ ) {
		...
		wp.customize('astra-settings[' + builder_type + '-social-' + index + '-radius-fields]', function (setting) {
			setting.bind(function (border) {
				...
				divino_add_dynamic_css( builder_type + '-social-' + index + '-radius-fields', dynamicStyle);
			});
		});
		...
		// Advanced Visibility CSS Generation.
		divino_builder_visibility_css( section, visibility_selector, 'block' );
		...
		(function( index ) {
			...
			wp.customize( 'astra-settings[' + builder_type + '-social-' + index + '-size]', function( value ) {
				value.bind( function( size ) {
					...
					if( size.desktop != '' || size.tablet != '' || size.mobile != '' ) {
						...
						divino_add_dynamic_css( builder_type + '-social-' + index + '-size', dynamicStyle );
					}
				} );
			} );
			...
			wp.customize( 'astra-settings[' + builder_type + '-social-' + index + '-space]', function( value ) {
				value.bind( function( spacing ) {
					...
					divino_add_dynamic_css( builder_type + '-social-icons-icon-space', dynamicStyle );
				} );
			} );
			...
			wp.customize( 'astra-settings[' + section + '-margin]', function( value ) {
				value.bind( function( margin ) {
					if(
						...
						dynamicStyle += '} ';
						dynamicStyle += '} ';
						divino_add_dynamic_css( section + '-margin', dynamicStyle );
					}
				} );
			} );
				...
				wp.customize( 'astra-settings[footer-social-' + index + '-alignment]', function( value ) {
					value.bind( function( alignment ) {
						if( alignment.desktop != '' || alignment.tablet != '' || alignment.mobile != '' ) {
							...
							divino_add_dynamic_css( 'footer-social-' + index + '-alignment', dynamicStyle );
						}
					} );
				} );
			...
			wp.customize( 'astra-settings[' + marginControl + ']', function( value ) {
				value.bind( function( margin ) {
					...
					if(
						...
						dynamicStyle += '} ';
						dynamicStyle += '} ';
						divino_add_dynamic_css( 'sidebar-widgets-' + builder_type + '-widget-' + index + '-margin', dynamicStyle );
					}
				} );
			} );
				...
				wp.customize( 'astra-settings[footer-widget-alignment-' + index + ']', function( value ) {
					value.bind( function( alignment ) {
						if( alignment.desktop != '' || alignment.tablet != '' || alignment.mobile != '' ) {
							...
							divino_add_dynamic_css( 'footer-widget-alignment-' + index, dynamicStyle );
						}
					} );
				} );
...
function divino_builder_visibility_css( section, selector, default_property = 'flex' ) {
	...
	wp.customize( 'astra-settings[' + section + '-visibility-responsive]', function( setting ) {
		setting.bind( function( visibility ) {
			...
			divino_add_dynamic_css( section + '-visibility-responsive', dynamicStyle );
		} );
