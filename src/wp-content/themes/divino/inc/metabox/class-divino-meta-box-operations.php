 ...
 * Meta Box
 */
if ( ! class_exists( 'divino_Meta_Box_Operations' ) ) {

	/**
	 * Meta Box
	 */
	class divino_Meta_Box_Operations {
		/**
		 * Instance
		 *
		 * @var $instance
		...
		public function meta_hooks() {
			...
			if ( is_singular() ) {
				...
				add_filter( 'divino_the_title_enabled', array( $this, 'post_title' ) );
		...
		public function primary_header() {
			...
			$display_header = apply_filters( 'divino_main_header_display', $display_header );
 ...
 */
divino_Meta_Box_Operations::get_instance();
