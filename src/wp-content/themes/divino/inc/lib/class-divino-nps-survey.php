...
if ( ! class_exists( 'divino_Nps_Survey' ) ) {

	/**
	 * Admin
	 */
	class divino_Nps_Survey {
		/**
		 * Instance
		 *
		 * @since 1.0.0
		 * @var (Object) divino_Nps_Survey
		 */
		...
		private function __construct() {
			...
			if ( apply_filters( 'divino_nps_survey_disable', false ) ) {
				return;
			}
	 ...
	 */
	divino_Nps_Survey::get_instance();
