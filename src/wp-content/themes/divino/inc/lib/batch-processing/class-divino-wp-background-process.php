...
if ( ! class_exists( 'divino_WP_Background_Process' ) ) {
	...
	/**
	 * Abstract divino_WP_Background_Process class.
	 *
	 * @abstract
	 * @extends divino_WP_Async_Request
	 */
	abstract class divino_WP_Background_Process extends divino_WP_Async_Request {
		...
		public function schedule_cron_healthcheck( $schedules ) {
			...
			$schedules[ $this->identifier . '_cron_interval' ] = array(
				...
				'display'  => sprintf( /* translators: %d: Minutes interval */ __( 'Every %d Minutes', 'divino' ), $interval ),
			);
