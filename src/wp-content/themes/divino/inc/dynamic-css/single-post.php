...
if ( apply_filters( 'divino_improvise_single_post_design', divino_Dynamic_CSS::divino_4_6_0_compatibility() && is_single() ) ) {
	add_filter( 'divino_dynamic_theme_css', 'divino_single_post_css', 11 );
}
 ...
 * @since 4.6.0
 */
function divino_single_post_css( $dynamic_css ) {
	...
	if ( $post_with_unboxed_layout ) {
		...
		$nav_padding = divino_check_current_post_comment_enabled() || 0 < get_comments_number() ? '3em 0 1em' : '3em 0 0';
		$static_css .= '
			:root {
