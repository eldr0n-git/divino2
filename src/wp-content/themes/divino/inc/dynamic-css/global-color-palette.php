...
add_filter( 'divino_dynamic_theme_css', 'divino_generate_global_palette_style' );
 ...
 * @return string
 */
function divino_generate_global_palette_style( $dynamic_css ) {

	$global_palette   = divino_get_option( 'global-color-palette' );
	$palette_style    = array();
	$variable_prefix  = divino_Global_Palette::get_css_variable_prefix();
	 ...
	 * @since 4.10.0
	 */
	$global_palette = apply_filters( 'divino_global_current_palette', $global_palette );
