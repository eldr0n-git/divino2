...
add_filter( 'divino_dynamic_theme_css', 'divino_old_header_custom_menu_css' );
 ...
 * @since 3.5.0
 */
function divino_old_header_custom_menu_css( $dynamic_css ) {
	...
	if ( false === divino_Builder_Helper::$is_header_footer_builder_active ) {
		...
		$search_box_type = divino_get_option( 'header-main-rt-section-search-box-type' );
