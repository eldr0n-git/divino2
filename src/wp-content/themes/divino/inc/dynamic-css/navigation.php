...
add_filter( 'divino_dynamic_theme_css', 'divino_navigation_css', 11 );
 ...
 * @since 4.6.0
 */
function divino_navigation_css( $dynamic_css ) {
	$mobile_breakpoint = strval( divino_get_mobile_breakpoint() );
	$link_hover_color  = divino_get_option( 'link-h-color' );

	/** Backward compatibility support for left-right paddings @since 4.6.13 */
	$remove_mobile_device_paddings = apply_filters( 'divino_remove_single_posts_navigation_mobile_device_padding', ! empty( divino_get_option( 'remove_single_posts_navigation_mobile_device_padding' ) ) );
	...
	$dynamic_css .= divino_Enqueue_Scripts::trim_css( $navigation_css );
