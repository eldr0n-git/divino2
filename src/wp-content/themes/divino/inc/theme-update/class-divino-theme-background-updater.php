...
if ( ! class_exists( 'divino_Theme_Background_Updater' ) ) {

	/**
	 * divino_Theme_Background_Updater Class.
	 */
	class divino_Theme_Background_Updater {
		/**
		...
		private static $db_updates = array(
			'4.0.0'  => array(
				'divino_theme_background_updater_4_0_0',
			),
			'4.0.2'  => array(
				'divino_theme_background_updater_4_0_2',
			),
			'4.1.0'  => array(
				'divino_theme_background_updater_4_1_0',
			),
			'4.1.4'  => array(
				'divino_theme_background_updater_4_1_4',
			),
			'4.1.6'  => array(
				'divino_theme_background_updater_4_1_6',
			),
			'4.1.7'  => array(
				'divino_theme_background_updater_4_1_7',
			),
			'4.2.0'  => array(
				'divino_theme_background_updater_4_2_0',
			),
			'4.2.2'  => array(
				'divino_theme_background_updater_4_2_2',
			),
			'4.4.0'  => array(
				'divino_theme_background_updater_4_4_0',
			),
			'4.5.0'  => array(
				'divino_theme_background_updater_4_5_0',
			),
			'4.5.2'  => array(
				'divino_theme_background_updater_4_5_2',
			),
			'4.6.0'  => array(
				'divino_theme_background_updater_4_6_0',
			),
			'4.6.2'  => array(
				'divino_theme_background_updater_4_6_2',
			),
			'4.6.4'  => array(
				'divino_theme_background_updater_4_6_4',
			),
			'4.6.5'  => array(
				'divino_theme_background_updater_4_6_5',
			),
			'4.6.6'  => array(
				'divino_theme_background_updater_4_6_6',
			),
			'4.6.11' => array(
				'divino_theme_background_updater_4_6_11',
			),
			'4.6.12' => array(
				'divino_theme_background_updater_4_6_12',
			),
			'4.6.14' => array(
				'divino_theme_background_updater_4_6_14',
			),
			'4.7.0'  => array(
				'divino_theme_background_updater_4_7_0',
			),
			'4.7.1'  => array(
				'divino_theme_background_updater_4_7_1',
			),
			'4.8.0'  => array(
				'divino_theme_background_updater_4_8_0',
			),
			'4.8.2'  => array(
				'divino_theme_background_updater_4_8_2',
			),
			'4.8.4'  => array(
				'divino_theme_background_updater_4_8_4',
			),
			'4.8.7'  => array(
				'divino_theme_background_updater_4_8_7',
			),
			'4.8.9'  => array(
				'divino_theme_background_updater_4_8_9',
			),
			'4.8.10' => array(
				'divino_theme_background_updater_4_8_10',
			),
			'4.9.0'  => array(
				'divino_theme_background_updater_4_9_0',
			),
			'4.10.0' => array(
				'divino_theme_background_updater_4_10_0',
			),
		);
		...
		public function install_actions() {
			...
			do_action( 'divino_update_initiated', self::$background_updater );
			...
			$is_queue_running = divino_get_option( 'is_theme_queue_running', false );
		...
		public function is_new_install() {
			...
			/** @psalm-suppress InvalidArgument */ // phpcs:ignore Generic.Commenting.DocComment.MissingShort
			$saved_version = divino_get_option( 'theme-auto-version', false );
		...
		private function needs_db_update() {
			$current_theme_version = divino_get_option( 'theme-auto-version', null );
		...
		public function check_if_data_migrated() {
			...
			if ( ! $is_db_version_updated ) {
				...
				if ( $db_migrate_count >= 5 ) {
					divino_delete_option( 'is_theme_queue_running' );
					$fallback = true;
				}
			}
			return $fallback;
		...
		public function is_db_version_updated() {
			...
			return version_compare( $saved_version, divino_THEME_VERSION, '=' );
		}
		...
		private function update( $fallback ) {
			$current_db_version = divino_get_option( 'theme-auto-version' );
			...
			if ( count( $this->get_db_update_callbacks() ) > 0 ) {
				...
				if ( $fallback ) {
					...
					divino_update_option( 'is_theme_queue_running', true );
		...
		public static function update_db_version( $version = null ) {
			...
			do_action( 'divino_theme_update_before' );
			...
			if ( false === $saved_version ) {
				...
				$saved_version = divino_THEME_VERSION;

				// Update auto saved version number.
				divino_update_option( 'theme-auto-version', divino_THEME_VERSION );
			}

			// If equals then return.
			if ( version_compare( $saved_version, divino_THEME_VERSION, '=' ) ) {
				divino_update_option( 'is_theme_queue_running', false );
				return;
			}
			...
			if ( empty( $saved_version ) ) {
				...
				// Get old version.
				$theme_version = get_option( '_divino_auto_version', divino_THEME_VERSION );

				// Remove option.
				delete_option( '_divino_auto_version' );

			} else {

				// Get latest version.
				$theme_version = divino_THEME_VERSION;
			}

			// Update auto saved version number.
			divino_update_option( 'theme-auto-version', $theme_version );
 ...
 */
new divino_Theme_Background_Updater();
