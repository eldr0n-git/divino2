 ...
 * @since 3.6.1
 */
$divino_search_input_placeholder = isset( $args['input_placeholder'] ) ? $args['input_placeholder'] : divino_default_strings( 'string-search-input-placeholder', false );
$divino_search_show_input_submit = isset( $args['show_input_submit'] ) ? $args['show_input_submit'] : true;
$divino_search_data_attrs        = isset( $args['data_attributes'] ) ? $args['data_attributes'] : '';
$divino_search_input_value       = isset( $args['input_value'] ) ? $args['input_value'] : '';
