...
(function () {
	...
	function cartInit() {
		...
		if (undefined !== mobileHeader && '' !== mobileHeader && null !== mobileHeader) {
			...
			if( 'flyout' == divino_cart.desktop_layout ) {
	...
	// Slide in cart 'divino_woo_slide_in_cart' PRO shortcode compatibility.
	...
	jQuery(document).ready(function ($) {
		// Listening for WooCommerce's default 'added_to_cart' and 'divino_refresh_cart_fragments' both events.
		$(document.body).on('added_to_cart divino_refresh_cart_fragments', function (event, fragments, cart_hash) {
		...
		// Triggering the 'divino_refresh_cart_fragments' event to refresh the cart fragments on page load.
		$(document.body).trigger('divino_refresh_cart_fragments');
	});
