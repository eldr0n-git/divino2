/**
 * divino Theme Customizer Style Guide
 *
 * @package divino
 * @since  x.x.x
 */
     ...
     */
	 jQuery(document).ready(function($) {
		...
		button.on('click', function(event) {
			...
			api.state.create('divino-style-guide-status');
			api.state('divino-style-guide-status').set('loaded');
		});
